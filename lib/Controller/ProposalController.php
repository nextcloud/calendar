...
class ProposalController extends ApiController {
	 ...
	 *
	 * @param string $token The token of the proposal to fetch
	 * @return JSONResponse The proposal data or an error message
	 */
	...
	public function create(array $proposal, ?string $user = null): JSONResponse {
		...
		$this->proposalService->createProposal($userObject, $proposalObject);

		return new JSONResponse($proposalObject->toJson(), Http::STATUS_CREATED);
	}
