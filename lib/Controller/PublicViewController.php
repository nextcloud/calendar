...
class PublicViewController extends Controller {
	...
	private function publicIndex(string $token):PublicTemplateResponse {
		...
		$defaultReminderPartDay = $this->config->getAppValue($this->appName, 'defaultReminderPartDay', 'none');
		$defaultReminderFullDay = $this->config->getAppValue($this->appName, 'defaultReminderFullDay', 'none');
		...
		$this->initialStateService->provideInitialState($this->appName, 'default_reminder_part_day', $defaultReminderPartDay);
		$this->initialStateService->provideInitialState($this->appName, 'default_reminder_full_day', $defaultReminderFullDay);
