...
"Dec." => "Dets.",
"All day" => "Kogu päev",
"New CalendarManager" => "Uus kalender",
...
"Share CalendarManager" => "Jaga kalendrit",
"Download" => "Lae alla",
"Edit" => "Muuda",
"Delete" => "Kustuta",
...
"Active" => "Aktiivne",
"CalendarManager color" => "Kalendri värv",
"Save" => "Salvesta",
"Submit" => "OK",
"Cancel" => "Loobu",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Selle nimega kalender on juba olemas. Kui sa siiski jätkad, siis need kalendrid liidetakse.",
...
"URLs" => "URL-id",
"CalendarManager CalDAV syncing addresses" => "Kalendri CalDAV sünkroniseerimise aadressid",
"more info" => "lisainfo",
