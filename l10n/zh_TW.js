OC.L10N.register(
    ...
    "Attendees" : "參與者",
    "Resources" : "資源",
    "_User requires access to your file_::_Users requires access to your file_" : ["使用者要求存取您的檔案"],
    "_Attachment requiring shared access_::_Attachments requiring shared access_" : ["需要分享存取權限的附件"],
    "Close" : " 關閉",
