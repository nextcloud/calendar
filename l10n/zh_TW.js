OC.L10N.register(
    ...
    "Audio alarm {time} after the event ends" : "在活動開始後 {time} 音效提醒",
    "Pop-up {time} after the event ends" : "在活動開始後 {time} 彈出提醒",
    "Email {time} after the event ends" : "在活動開始後 {time} 以電子郵件提醒",
    "None {time} after the event ends" : "在活動結束後 {time} 不提醒",
    "{type} {time} after the event ends" : "{type} 活動開始前 {time}",
    "Audio alarm at the event's start" : "在活動開始時音效提醒",
    "Pop-up at the event's start" : "在活動開始時彈出提醒",
    "Email at the event's start" : "在活動開始時以電子郵件提醒",
    "None at the event's start" : "在活動開始時不提醒",
    "{type} at the event's start" : "{type} 活動開始時",
    "Audio alarm at the event's end" : "在活動結束時音效提醒",
    "Pop-up at the event's end" : "在活動結束時彈出提醒",
    "Email at the event's end" : "在活動結束時以電子郵件提醒",
    "None at the event's end" : "在活動結束時不提醒",
    "{type} at the event's end" : "{type} 活動結束時",
    "Audio alarm at {time}" : "聲音提醒於 {time}",
    "Pop-up at {time}" : "彈出提醒於 {time}",
    "Email at {time}" : "電子郵件提醒於 {time}",
    "None at {time}" : "無提示於 {time}",
    ...
    "iCal link" : "iCal 連結",
    "Download" : "下載",
    "Share with users, groups or circles" : "與用戶、群組或小圈圈分享",
    "can edit" : "可編輯",
    "Share link" : "分享連結",
    "Public access" : "公開存取",
    ...
    "Repeat" : "重覆",
    "times every" : "次每",
    "Email reminders have not been implemented in the CalDAV server yet, so none will be sent." : "CalDAV 伺服器尚未提供電子郵件提示功能，因此電子郵件提示將不會被寄出",
    "Add" : "加入",
    ...
    "%s shared the calendar <strong>%s</strong> with you" : "%s分享的日曆：<strong>%s</strong>",
    "Embed" : "嵌入",
