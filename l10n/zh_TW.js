OC.L10N.register(
    ...
    "Open »%s«" : "開啟 »%s«",
    "Recipient" : "接收者",
    "Too many redirects. Aborting ..." : "太多重新導向。終止中 ...",
    "The remote server did not give us access to the calendar (HTTP {%s} error)" : "遠端伺服器未給予日曆存取權限 (HTTP {%s} error)",
    ...
    "Error saving WebCal-calendar" : "儲存WebCal-calendar發生錯誤",
    "WebDAV address for subscriptions" : "訂閱者 CalDAV 位址",
    "Email has been sent." : "Email 已經寄出",
    "There was an issue while sending your email." : "寄出email時發生問題。",
    "group" : "群組",
    "Details" : "詳細資料",
    "Attendees" : "出席者",
    "Reminders" : "提醒",
    ...
    "never" : "永不",
    "after" : "之後",
    "How about getting started by importing some calendars?" : "是否要先載入一些日曆作為開始?",
    ...
    "Please enter a valid WebCal-URL" : "請輸入一個有效的WebCal-URL",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "連結可能錯誤或日曆未分享",
    "Edit event" : "編輯活動",
    "Delete Event" : "刪除活動",
    "Save Event" : "儲存活動",
    "Time" : "時間",
