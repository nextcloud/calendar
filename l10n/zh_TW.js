OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "您的預約「%s」需要確認",
    "Dear %s, please confirm your booking" : "親愛的 %s，請確認您的預約",
    "Confirm" : "確認",
    "This confirmation link expires in %s hours." : "此確認連結將於 %s 小時後過期。",
    "If you wish to cancel the appointment after all, please contact your organizer." : "如果您想要取消預約，請與您的舉辦者聯絡。",
    "Appointment:" : "預約：",
    "Date:" : "日期：",
    "Where:" : "地點：",
    "Description:" : "描述：",
    ...
    "Save" : "儲存",
    "Update" : "更新",
    "Your appointment is booked" : "您的預約已登記",
