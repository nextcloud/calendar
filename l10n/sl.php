...
"Dec." => "dec.",
"All day" => "Cel dan",
"New CalendarManager" => "Nov koledar",
...
"Share CalendarManager" => "Daj koledar v souporabo",
"Download" => "Prejmi",
"Edit" => "Uredi",
"Delete" => "Izbriši",
...
"Active" => "Dejavno",
"CalendarManager color" => "Barva koledarja",
"Save" => "Shrani",
"Submit" => "Potrdi",
"Cancel" => "Prekliči",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Koledar s tem imenom že obstaja. Če nadaljujete, bosta koledarja združena.",
...
"URLs" => "URLji",
"CalendarManager CalDAV syncing addresses" => "CalDAV naslov za usklajevanje koledarjev",
