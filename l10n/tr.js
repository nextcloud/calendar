OC.L10N.register(
    ...
    "No reminders yet" : "Henüz bir hatırlatıcı yok",
    ...
    "To send out invitations and handle responses,  [linkopen]add your email address in personal settings[linkclose]." : "Davetiye göndermek ve cevapları yönetmek için,  [linkopen]email adresinizi kişisel ayarlara ekleyiniz[linkclose].",
    ...
    "[from] {dateFormat}" : "[kimden] {dateFormat}",
    "[to] {dateFormat}" : "[kime] {dateFormat}",
    "[on] {dateFormat}" : "[tarihinde] {dateFormat}",
    "[from] {dateFormat} [at] {timeFormat}" : "[kimden] {dateFormat} [saat] {timeFormat}",
    "[to] {dateFormat} [at] {timeFormat}" : "[kime] {dateFormat} [saat] {timeFormat}",
    "[on] {dateFormat} [at] {timeFormat}" : "[tarihinde] {dateFormat] [saat] {timeFormat}",
    "{dateFormat} [at] {timeFormat}" : "{dateFormat} [saat] {timeFormat}",
    ...
    "_%n day before the event at {formattedHourMinute}_::_%n days before the event at {formattedHourMinute}_" : ["saat {formattedHourMinute} etkinlikten %n gün önce","saat {formattedHourMinute} etkinlikten %ngün önce"],
    "_%n week before the event at {formattedHourMinute}_::_%n weeks before the event at {formattedHourMinute}_" : ["saat {formattedHourMinute} etkinlikten %nhafta önce","saat {formattedHourMinute} etkinlikten %n hafta önce"],
    "on the day of the event at {formattedHourMinute}" : "etkinlik gününde saat  {formattedHourMinute}",
    "at the event's start" : "etkinlik başlangıcında",
    "at the event's end" : "etkinlik sonunda",
    "{time} before the event starts" : "etkinlik başlamadan {time} önce",
    "{time} before the event ends" : "etkinlik bitmeden {time} önce",
    "{time} after the event starts" : "etkinlik başladıktan {time} sonra",
    "{time} after the event ends" : "etkinlik bittikten {time} sonra",
    "on {time}" : "saat {time}",
    "on {time} {timezoneId}" : "saat {time} {timezoneId}",
    ...
    "Imported {filename}" : "{filename} aktarıldı",
    ...
    "Lecture" : "Ders",
    "Seminar" : "Seminer",
    "Photograph" : "Fotoğrafçılık",
    "Celebrate" : "Kutlama",
    "Shopping" : "Alışveriş",
    "Skate" : "Kayma",
    "Skateboard" : "Kayma",
    "Wine tasting" : "Şarap Tatma",
    "Golf" : "Golf",
    "Dinner" : "Akşam Yemeği",
    "Global" : "Küresel"
},
