OC.L10N.register(
    ...
    "Add holiday calendar" : "Tatil takvimi ekle",
    ...
    "Global" : "Genel",
    "Holiday calendars" : "Tatil takvimleri",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Tatil takvimleri Thunderbird tarafından sağlanır. Takvim verileri {website} üzerinden indirilir",
    "By {authors}" : "{authors} tarafından",
    "Subscribed" : "Abone olundu",
    "Subscribe" : "Abone ol",
    "Holidays in {region}" : "{region} tatilleri",
    "An error occurred, unable to create the holiday calendar." : "Bir sorun çıktı. Tatil takvimi eklenemedi.",
