OC.L10N.register(
    ...
    "Error fetching Talk conversations." : "Talk görüşmeleri alınırken sorun çıktı.",
    "Conversation does not have a valid URL." : "Görüşmenin geçerli bir adresi yok.",
    "Successfully added Talk conversation link to location." : "Talk görüşme bağlantısı konuma eklendi.",
    "Successfully added Talk conversation link to description." : "Talk görüşme bağlantısı açıklamaya eklendi.",
    "Failed to apply Talk room." : "Talk odası uygulanamadı.",
    "Error creating Talk conversation" : "Talk görüşmesi oluşturulurken sorun çıktı",
    "Select a Talk Room" : "Bir Talk odası seçin",
    "Add Talk conversation" : "Talk görüşmesi ekle",
    "Fetching Talk rooms…" : "Talk odaları alınıyor…",
    "No Talk room available" : "Kullanılabilecek bir Talk odası yok",
    ...
    "Successfully appended link to talk room to location." : "Bağlantı konumu Talk odasına eklendi.",
    ...
    "Please ask your administrator to enable the Tasks App." : "Lütfen Görevler uygulamasını etkinleştirmesi için BT yöneticiniz ile görüşün.",
