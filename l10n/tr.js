OC.L10N.register(
    ...
    "{filename} is an unsupported file-type" : "{filename} desteklenmeyen dosya tipinde",
    "{filename} could not be parsed" : "{filename} işlenemez",
    "No valid files found, aborting import" : "Geçerli dosya bulunamadı, aktarım iptal ediliyor",
    ...
    "Limit visible events per view" : "Görünüm başına etkinlik adetini sınırla",
