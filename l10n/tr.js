OC.L10N.register(
    ...
    "Limit how far in the future appointments can be booked" : "Gelecekteki randevuların ne kadar uzağa ayırtılabileceğini sınırlayın",
    ...
    "Decline" : "Reddet",
    "Tentative" : "Belirsiz",
    "The invitation has been accepted successfully." : "Çağrı kabul edildi.",
    "Failed to accept the invitation." : "Çağrı kabul edilemedi.",
    "The invitation has been declined successfully." : "Çağrı reddedildi.",
    "Failed to decline the invitation." : "Çağrı reddedilemedi.",
    ...
    "Resources" : "Kaynaklar",
    "_User requires access to your file_::_Users requires access to your file_" : ["Kullanıcı dosyanıza erişme izni istiyor","Kullanıcılar dosyanıza erişme izni istiyor"],
    "_Attachment requiring shared access_::_Attachments requiring shared access_" : ["Ek dosya paylaşılmış erişim istiyor","Ek dosyalar paylaşılmış erişim istiyor"],
    "Close" : "Kapat",
    ...
    "Relax" : "Rahat",
    "Break" : "Kırık",
    "Commute" : "İşe gidiş/geliş",
    "Commuting" : "İşe gidip/gelme",
    "Shuttle" : "Mekik",
    "Invoice" : "Fatura",
    "Finance" : "Finans",
    "Bank" : "Banka",
