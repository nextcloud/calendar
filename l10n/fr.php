...
"New CalendarManager" => "Nouveau Calendrier",
...
"Share CalendarManager" => "Partager le calendrier",
...
"Active" => "Actif",
"CalendarManager color" => "Couleur du calendrier",
"Save" => "Sauvegarder",
"Submit" => "Soumettre",
"Cancel" => "Annuler",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Un calendrier de ce nom existe déjà. Si vous choisissez de continuer les calendriers seront fusionnés.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "Adresses de synchronisation des calendriers CalDAV",
