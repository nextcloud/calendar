OC.L10N.register(
    ...
    "An error occurred during sending email" : "Villa kom upp við að senda tölvupóst",
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "%1$s svaraði tillögu þinni um fund \"%2$s\"",
    "{participant} responded to your meeting proposal {proposal}" : "{participant} svaraði tillögu þinni um fund {proposal}",
    ...
    "Requestor Comments:" : "Athugasemdir beiðanda:",
    "Appointment Description:" : "Lýsing á stefnumóti:",
    ...
    "%s has proposed a meeting" : "%s hefur gert tillögu um fund",
    "%s has updated a proposed meeting" : "%s hefur uppfært tillögu um fund",
    "%s has canceled a proposed meeting" : "%s hefur hætt við tillögu um fund",
    "Dear %s, a new meeting has been proposed" : "Kæri/Kæra %s, gerð hefur verið tillaga um nýjan fund",
    "Dear %s, a proposed meeting has been updated" : "Kæri/Kæra %s, tillaga um fund hefur verið uppfærð",
    "Dear %s, a proposed meeting has been cancelled" : "Kæri/Kæra %s, hætt hefur verið við tillögu um fund",
    "Respond" : "Bregðast við",
    "Location:" : "Staðsetning:",
    "%1$s minutes" : "%1$s mínútur",
    "Duration:" : "Tímalengd:",
    "%1$s from %2$s to %3$s" : "%1$s frá %2$s til %3$s",
    "Dates:" : "Dagsetningar:",
    "[Proposed] %1$s" : "[Tillaga] %1$s",
    "Calendar App" : "Dagatalsforrit",
    "A Calendar app for Nextcloud" : "Dagatalsforrit fyrir Nextcloud",
    "A Calendar app for Nextcloud. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Like Contacts, Talk, Tasks, Deck and Circles\n* 🌐 **WebCal Support!** Want to see your favorite team's matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events\n* ⌚ **Free/Busy!** See when your attendees are available to meet\n* ⏰ **Reminders!** Get alarms for events inside your browser and via email\n* 🔍 **Search!** Find your events at ease\n* ☑️ **Tasks!** See tasks or Deck cards with a due date directly in the calendar\n* 🔈 **Talk rooms!** Create an associated Talk room when booking a meeting with just one click\n* 📆 **Appointment booking** Send people a link so they can book an appointment with you [using this app](https://apps.nextcloud.com/apps/appointments)\n* 📎 **Attachments!** Add, upload and view event attachments\n* 🙈 **We’re not reinventing the wheel!** Based on the great [c-dav library](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "Dagatalsforrit fyrir Nextcloud. Samstilltu á einfaldan máta atburði af ýmsum tækjum við Nextcloud-tölvuskýið og breyttu þeim á netinu.\n\n* 🚀 **Samþætting við önnur Nextcloud-forrit!** Til dæmis Contacts-tengiliði, Talk-spjall, Tasks-verkefni, Deck-spjöld and Circles-teymi.\n* 🌐 **Stuðningur við WebCal!** Viltu sjá leikdegi í boltanum í dagatalinu þínu? Ekki vandamál!\n* 🙋 **Þátttakendur!** Bjóddu fólki á atburði.\n* ⌚️ **Laus/Upptekinn!** Sjáðu hvenær þátttakendurnir geta mætt.\n* ⏰ **Áminningar!** Fáðu áminningar fyrir atburði inni í vafra og í tölvupósti.\n* 🔍 Leita! Finndu atburðina þina á einfaldan hátt.\n* ☑️ Verkefni! Sjáðu verkefni eða Deck-spjöld og skiladag þeirra beint í dagatalinu.\n* 🔈 **Talk-spjallrásir!** Búðu til með einum smelli sérstaka Talk-spjallrás þegar fundir eru bókaðir\n* 📆 **Bókun funda/stefnumóta** Sendu fólki tengil svo þau geti bókað tíma með þér með því að nota [þetta forrit](https://apps.nextcloud.com/apps/appointments)\n* 📎 **Viðhengi!** Bættu við, sendu inn og skoðaðu viðhengi með atburðum\n* 🙈 **Við erum ekki að finna upp hjólið!** Byggist á hinum frábæru [c-dav](https://github.com/nextcloud/cdav-library),  [ical.js](https://github.com/mozilla-comm/ical.js) og [fullcalendar](https://github.com/fullcalendar/fullcalendar) aðgerðasöfnum.",
    ...
    "Notifications muted" : "Tilkynningar þaggaðar",
    "Delegated to you by" : "Framvísað til þín af",
    ...
    "Calendar name can not be blank" : "Heiti dagatals má ekki vera tómt",
    ...
    "Tasks" : "Verkefni",
    "Delegated by {name} (read-only)" : "Framvísað af {name} (skrifvarið)",
    "Delegated by {name}" : "Framvísað af {name}",
    ...
    "can edit and see confidential events" : "getur skoðað og breytt atburðum sem eru trúnaðarmál",
    "Unshare with {displayName}" : "Hætta deilingu með {displayName}",
    "Share with users or groups" : "Deila með notendum eða hópum",
    "No users or groups" : "Engir notendur eða hópar",
    "events" : "atburðir",
    "tasks" : "verkefni",
    "journal entries" : "dagbókarfærslur",
    "This calendar supports neither events, tasks nor journal entries." : "Þetta dagatal styður hvorki atburði, verk né dagbókarfærslur.",
    "_This calendar supports only {types}._::_This calendar supports {types}._" : ["Þetta dagatal styður aðeins {types}.","Þetta dagatal styður {types}."],
    "None" : "Ekkert",
    ...
    "Disable alarm notifications for this calendar" : "Gera tilkynningar um áminningar óvirkar fyrir þetta dagatal",
    "Default reminder for part-day events" : "Sjálfgefin áminning fyrir hlutadags-atburði",
    "Select default reminder" : "Stilla sjálfgefna áminningu",
    "Default reminder for full-day events" : "Sjálfgefin áminning fyrir heilsdags-atburði",
    "These reminders will be automatically added to new events created in this calendar" : "Þessum áminningum verður sjálfkrafa bætt við nýja atburði sem gerðir eru í þessu dagatali",
    ...
    "Cancel" : "Hætta við",
    "Deleting proposal \"{title}\"" : "Eyði tillögunni \"{title}\"",
    "Successfully deleted proposal" : "Tókst að eyða tillögunni",
    "Failed to delete proposal" : "Mistókst að eyða tillögunni",
    "Failed to retrieve proposals" : "Mistókst að sækja tillögur",
    "Meeting proposals" : "Tillögur að fundi",
    "A configured email address is required to use meeting proposals" : "Uppsett tölvupóstfang er nauðsynlegt til að geta notað tillögur að fundum",
    "No active meeting proposals" : "Engar virkar tillögur að fundi",
    "View" : "Skoða",
    "Delete proposal" : "Eyða tillögu",
    "Event legend" : "Skýring atburðar",
    "Calendar events are styled to convey additional information at a glance." : "Dagatalsatburðir eru myndgerðir til að gefa sem bestar upplýsingar við snöggt yfirlit.",
    "Free / Busy" : "Laus / Upptekinn",
    "Busy" : "Upptekinn",
    "Busy: your time is marked as occupied" : "Upptekinn: tíminn þinn er merktur sem upptekinn",
    "Free" : "Laus",
    "Free: your time is still available" : "Laus: tíminn þinn er enn tiltækur",
    "Participation status" : "Staða þátttöku",
    "Accepted" : "Samþykkt",
    "Accepted: you confirmed your attendance" : "Samþykkt: þú staðfestir þátttöku þína",
    "Tentative" : "Með fyrirvara",
    "Tentative: your participation is uncertain" : "Með fyrirvara: þátttaka þín er óviss",
    "Invited" : "Boðinn",
    "Invited: you have not yet responded to this invitation" : "Boðinn: þú hefur ekki enn svarað þessu boði",
    "Declined" : "Hafnað",
    "Declined: you declined this event" : "Hafnað: þú hafnaði þessum atburði",
    "All declined" : "Allir höfnuðu",
    "All declined: all participants declined" : "Allir höfnuðu: Allir þátttakendur höfnuðu",
    "Icons" : "Táknmyndir",
    "Attendees" : "Þátttakendur",
    "This event has one or more attendees" : "Þessi atburður er með einn eða fleiri þátttakendur",
    "Past events" : "Liðnir atburðir",
    "Past event" : "Liðinn atburður",
    "Events that have already ended are shown with a more faded background" : "Atburðir sem þegar er lokið birtast með daufari bakgrunn",
    "Import destination selection" : "Val á stað til að flytja inn í",
    ...
    "Some calendars are disabled because this file contains {types}." : "Sum dagatöl eru óvirk vegna þess að þessi skrá inniheldur {types}.",
    ...
    "{email} will no longer be able to act on your behalf." : "{email} mun ekki lengur geta komið fram fyrir þína hönd.",
    "Revoke" : "Afturkalla",
    "Viewer" : "Skoðandi",
    "Editor" : "Ritstjóri",
    "Could not revoke access." : "Tókst ekki að afturkalla aðgang.",
    "Access revoked successfully." : "Tókst að afturkalla aðgang.",
    "{name} can now view your calendars." : "{name} getur núna skoðað dagatölin þín.",
    "{name} can now act on your behalf." : "{name} getur núna framkvæmt fyrir þína hönd.",
    "Could not add delegate." : "Gat ekki bætt við framvísun.",
    "Could not load delegates." : "Tókst ekki að hlaða inn framvísunum.",
    "Delegates" : "Framvísanir",
    "Allow users to manage your calendar events and invitations on your behalf." : "Leyfa notendum að stjórna atburðum dagatals og boðum fyrir þína hönd.",
    "Loading delegates…" : "Hleð inn framvísunum…",
    "Revoke access" : "Afturkalla aðgang",
    "No delegates yet." : "Engar framvísanir enn.",
    "Add delegate" : "Bæta við framvísun",
    "Revoke access?" : "Afturkalla aðgang?",
    "Search for a user…" : "Leita að notanda…",
    "No users found" : "Engir notendur fundust",
    "Choose whether they can view and edit events, or only view them." : "Veldu hvort viðkomandi geti skoðað og breytt atburðum, eða aðeins skoðað þá.",
    "Add as viewer" : "Bæta við sem skoðanda",
    "Add as editor" : "Bæta við sem ritstjóra",
    ...
    "Import calendar file" : "Flytja inn dagatalsskrá",
    ...
    "Availability settings" : "Stillingar varðandi hvenær til taks",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Fáðu aðgang að Nextcloud-dagatölum úr öðrum forritum og tækjum",
    "CalDAV URL" : "CalDAV-slóð",
    "Server Address for iOS and macOS" : "Vistfang þjóns fyrir iOS og macOS",
    "Appearance" : "Útlit",
    "Birthday calendar" : "Afmælisdagatal",
    "Tasks in calendar" : "Verkefni í dagatali",
    "Weekends" : "Helgar",
    "Week numbers" : "Vikunúmer",
    "Limit number of events shown in Month view" : "Takmarka fjölda atburða sem birtast í mánaðaryfirliti",
    "Density in Day and Week View" : "Þéttleiki í dags- og vikuyfirliti",
    "Editing" : "Breytingar",
    "Simple event editor" : "Einfaldur atburðaritill",
    "\"More details\" opens the detailed editor" : "\"Nánari upplýsingar\" opnar nákvæma ritilinn",
    "Files" : "Skráaforrit",
    ...
    "Public – shown on profile page" : "Opinbert - birt á notandasíðu",
    "Private – only accessible via link" : "Einka - eingöngu aðgengilegt í gegnum tengil",
    ...
    "Description" : "Lýsing",
    "Duration (minutes)" : "Tímalengd (mínútur)",
    "Increments" : "Þrep",
    "Booking calendar" : "Bókunardagatal",
    "Calendars to check for conflicts" : "Dagatöl sem á að athuga með árekstra",
    "Visibility" : "Sýnileiki",
    "Booking availability" : "Lausir tímar bókunar",
    "to" : "til",
    ...
    "Buffer before the event" : "Hafa bil fyrir atburðinn",
    "Buffer after the event" : "Hafa bil eftir atburðinn",
    "Minimum time before next slot" : "Lágmarkstími á undan næsta tímahólfi",
    ...
    "Select existing conversation" : "Veldu fyrirliggjandi samtal",
    "Select conversation" : "Veldu samtal",
    "Or create a new conversation" : "Eða útbúðu nýtt samtal",
    "Create public conversation" : "Útbúa opinbert samtal",
    "Create private conversation" : "Útbúa einkasamtal",
    "on" : "þann",
    "at" : "klukkan",
    "Default reminder of calendar" : "Sjálfgefin áminning dagatals",
    "Amount" : "Magn",
    "before at" : "á undan klukkan",
    "Alarm date and time" : "Dagur og tími áminningar",
    ...
    "You are about to navigate to {link}. Are you sure to proceed?" : "Þú ert í þann mund að fara á {link}. Ertu viss um að þú viljir halda áfram?",
    ...
    "Proceed" : "Halda áfram",
    "Upload files as attachments" : "Senda skrár inn sem viðhengi",
    ...
    "Still available" : "Enn tiltækur",
    "Already booked" : "Þegar bókað",
    "Checking availability" : "Athuga framboð",
    "Will be booked after saving, if available" : "Verður bókað eftir vistun, ef tiltækt",
    "Invitation will be sent" : "Boð verður sent",
    "Failed to check availability" : "Mistókst að skoða framboð",
    ...
    "{name} (delegated by {delegator})" : "{name} (framvísað af {delegator})",
    "Duration" : "Duration",
    "15 minutes" : "15 mínútur",
    "30 minutes" : "30 mínútur",
    "45 minutes" : "45 mínútur",
    "1 hour" : "1 klukkustund",
    "1 hour 30 minutes" : "1 klukkustund, 30 mínútur",
    "2 hours" : "2 klukkustundir",
    "Custom" : "Sérsniðið",
    "_{i} day_::_{i} days_" : ["{i} dagur","{i} dagar"],
    "_{i} hour_::_{i} hours_" : ["{i} klukkustund","{i} klukkustundir"],
    "_{i} minute_::_{i} minutes_" : ["{i} mínúta","{i} mínútur"],
    "Days" : "Dagar",
    "Hours" : "klukkustundir",
    "Minutes" : "mínútur",
    "Suggested times" : "Tímasetningar sem stungið er upp á",
    ...
    "Accept this occurrence" : "Samþykkja þetta tilvik",
    "Accept entire series" : "Samþykkja alla röðina",
    "Accept" : "Samþykkja",
    "Decline this occurrence" : "Eyða þessu tilviki",
    "Decline entire series" : "Eyða allri röðinni",
    "Decline" : "Hafna",
    "Tentative for this occurrence" : "Mögulega fyrir þetta tilvik",
    "Tentative for entire series" : "Mögulega fyrir alla röðina",
    ...
    "Copy name and email address" : "Afrita nafn og tölvupóstfang",
    "Send email to {email}" : "Senda tölvupóst til {email}",
    "No attendees yet" : "Engir þátttakendur ennþá",
    "{confirmedCount} confirmed, {waitingCount} awaiting response" : "{confirmedCount} staðfestir, {waitingCount} bíða svars",
    "Please add at least one attendee to use the \"Find a time\" feature." : "Bættu við a.m.k. einum þátttakanda til að nota \"Finna tíma\" eiginleikann.",
    "Status" : "Staða",
    "Role" : "Hlutverk",
    "Delegated" : "Framvísað",
    "Chairperson" : "Fundarstjóri",
    ...
    "Optional participant" : "Aukaþátttakandi",
    "Non-participant" : "Ekki þátttakandi",
    "Attendees copied to clipboard" : "Þátttakendur afritaðir á klippispjald",
    "Failed to copy attendees to clipboard" : "Mistókst að afrita þátttakendur á klippispjald",
    "Copy attendees to clipboard" : "Afrita þátttakendur á klippispjald",
    "_%n more attendee_::_%n more attendees_" : ["%n þátttakandi í viðbót","%n þátttakendur í viðbót"],
    ...
    "Search for emails, users, contacts, contact groups or teams" : "Leita að tölvupóstföngum, notendum, tengiliðum, teymum eða tengiliðahópum",
    ...
    "Search for attendees" : "Leita að þátttakendum",
    ...
    "Title" : "Titill",
    "Cannot modify all-day setting for events that are part of a recurrence-set." : "Get ekki breytt heils-dags-stillingu atburða sem eru hluti af endurtekningasetti.",
    "From" : "Frá",
    ...
    "End time" : "Lokatími",
    "Your Time" : "Tíminn þinn",
    "Repeat" : "Endurtaka",
    "Repeat event" : "Endurtaka atburð",
    "Set repetition" : "Stilla endurtekningu",
    "never" : "aldrei",
    "on date" : "þann",
    "after" : "eftir",
    "End repeat" : "Hætta endurtekningu",
    "End repeat date" : "Lokadagsetning endurtekninga",
    "Occurrences" : "Tilvik",
    "This event is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it." : "Þessi atburður er endurtekninga-frávik í endurtekningasetti. Þú getur ekki bætt endurtekninga-reglu við hann.",
    "first" : "fyrsta",
    "Week occurrence" : "Tilvik í viku",
    ...
    "Repeat frequency" : "Tíðni endurtekninga",
    "On specific day" : "Á tilteknum degi",
    "weekday" : "vinnudagur",
    "weekend day" : "helgardagur",
    "Day of week" : "Dagur viku",
    "Does not repeat" : "Endurtekst ekki",
    "The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost." : "Endurtekninga-skilgreining þessa atburðar er ekki að fullu studd í Nextcloud. Ef þú breytir endurtekninga-valkostunum, gætu sumar endurtekningar tapast.",
    "No rooms or resources yet" : "Ennþá ekki neinir salir eða tilföng",
    "Resources" : "Tilföng",
    "Show rooms" : "Sýna fundarsali",
    ...
    "Search for resources" : "Leita að tilföngum",
    "Projector" : "Skjávarpi",
    "Whiteboard" : "Teiknitafla",
    "_%n seat_::_%n seats_" : ["%n sæti","%n sæti"],
    "Unavailable" : "Ekki tiltækt",
    "Room type" : "Tegund salar",
    "Any" : "Hvað sem er",
    "Minimum seating capacity" : "Lágmarks-sætafjöldi",
    "_{available} of %n room available_::_{available} of %n rooms available_" : ["{available} af %n fundarherbergi tiltækt","{available} af %n fundarherbergjum tiltækt"],
    "Rooms" : "Fundarherbergi",
    "Search rooms" : "Leita að fundarsölum",
    "Name, building or room number" : "Nafn, bygging eða stofunúmer",
    "Building" : "Bygging",
    "Floor" : "Hæð",
    "Minimum capacity" : "Lágmarks-sætafjöldi",
    "Features" : "Eiginleikar",
    "Checking availability…" : "Athuga hvað sé á lausu…",
    "No rooms match the filters" : "Engin fundarherbergi samsvöruðu síum",
    "No rooms found" : "Engin fundarherbergi fundust",
    "Clear filters" : "Hreinsa síur",
    "More details" : "Nánari upplýsingar",
    "Update entire series" : "Uppfæra alla röðina",
    "Update this and future occurrences" : "Uppfæra þetta og öll síðari tilvik",
    "Update this occurrence" : "Uppfæra þetta tilvik",
    ...
    "Remove date" : "Fjarlægja dagsetningu",
    "Attendance required" : "Þátttaka nauðsynleg",
    "Attendance optional" : "Þátttaka valfrjáls",
    "Remove participant" : "Fjarlægja þátttakanda",
    "Yes" : "Já",
    "No" : "Nei",
    "Maybe" : "Kannski",
    "Select your meeting availability" : "Veldu hvort þú getir tekið þátt í fundi",
    "Create a meeting for this date and time" : "Útbúðu fund á þessari dagsetningu og tíma",
    "Create" : "Búa til",
    "No participants or dates available" : "Engir þátttakendur eða dagsetningar til taks",
    "(delegated by {name})" : "(framvísað af {name})",
    ...
    "Public calendar subscriptions selection" : "Áskriftir að opinberum dagatölum",
    ...
    "Contact your server administrator to resolve this issue." : "Hafðu samband við kerfisstjóra netþjónsins til að leysa þetta.",
    ...
    "These public calendars are suggested by the server administrator. Calendar data will be downloaded from the respective website." : "Þessar tillögur að opinberum dagatölum koma frá stjórnanda netþjónsins. Gögn dagatalanna verða sótt inn á viðkomandi vefsvæði.",
    ...
    "This booking link is no longer valid" : "Þessi bókunartengill er ekki lengur gildur",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Staðfestingartengillinn er útrunninn eða hefur þegar verið notaður. Hafðu samband við skipuleggjendurna til að bóka aftur.",
    "Confirm your appointment" : "Staðfestu stefnumótið þitt",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Gat ekki staðfest stefnumótið. Reyndu aftur seinna eða hafðu samband við skipuleggjendurna.",
    ...
    "Show unscheduled tasks" : "Sýna verk sem ekki eru á áætlun",
    "Unscheduled tasks" : "Verk sem ekki eru á áætlun",
    "Availability of {displayName}" : "Lausir tímar hjá {displayName}",
    "Discard" : "Fleygja",
    "Allow forwarding" : "Leyfa áframsendingar",
    "Anyone with the invitation can respond" : "Hver sá sem er boðið getur svarað",
    "Only invited attendees can respond" : "Aðeins fólk sem er boðið getur svarað",
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Veldu \"Aðeins fólk sem er boðið getur svarað\" til að koma í veg fyrir að þátttakendur geti áframsent boðið til annarra.",
    "Detailed event editor" : "Nákvæmur atburðaritill",
    "Event does not exist" : "Atburður er ekki til",
    "Delete this occurrence" : "Eyða þessu tilviki",
    "Delete this and future occurrences" : "Eyða þessu og öllum síðari tilvikum",
    "Delete entire series" : "Eyða allri röðinni",
    "All day" : "Heilsdagsatburður",
    "Modifications wont get propagated to the organizer and other attendees" : "Breytingar munu ekki dreifast út til skipuleggjanda eða annarra þátttakenda",
    ...
    "Are you sure you want to discard the changes made to this event?" : "Ertu viss um að þú viljir henda breytingunum sem gerðar hafa verið á þessum atburði?",
    ...
    "Close" : "Loka",
    "Modifications will not get propagated to the organizer and other attendees" : "Breytingar munu ekki dreifast út til skipuleggjanda eða annarra þátttakenda",
    "This event was cancelled" : "Hætt hefur verið við þennan atburð",
    "Meeting proposals overview" : "Yfirlit yfir tillögur að fundum",
    "Edit meeting proposal" : "Breyta tillögu um fund",
    "Create meeting proposal" : "Útbúa tillögu um fund",
    "Update meeting proposal" : "Uppfæra tillögu um fund",
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Á að búa til fund fyrir \"{date}\"?. Þetta mun útbúa atburð í dagatalinu hjá öllum þátttakendum.",
    "Create meeting" : "Útbúa fund",
    "Saving proposal \"{title}\"" : "Vista tillöguna \"{title}\"",
    "Successfully saved proposal" : "Tókst að vista tillögu",
    "Failed to save proposal" : "Mistókst að vista tillögu",
    "Please enter a valid duration in minutes." : "Settu inn gilda tímalengd í mínútum.",
    "Creating meeting for {date}" : "Útbý fund fyrir {date}",
    "Successfully created meeting for {date}" : "Tókst að búa til fund fyrir {date}",
    "Failed to create a meeting for {date}" : "Mistókst að búa til fund fyrir {date}",
    "Failed to fetch free/busy data" : "Ekki tókst að sækja gögn varðandi laus/upptekinn",
    "Selected" : "Valið",
    "No Description" : "Engin lýsing",
    "No Location" : "Engin staðsetning",
    "Edit this meeting proposal" : "Breyta þessari tillögu um fund",
    "Delete this meeting proposal" : "Eyða þessari tillögu um fund",
    "Notify me when participants respond" : "Láta mig vita þegar þátttakendur svara",
    "Participants" : "Þátttakendur",
    "Selected times" : "Valdar tímasetningar",
    "Previous span" : "Fyrri spönn",
    "Next span" : "Næsta spönn",
    "Less days" : "Færri dagar",
    "More days" : "Fleiri dagar",
    "Loading meeting proposal" : "Hleð inn tillögu um fund",
    "No meeting proposal found" : "Engin tillaga um fund fannst",
    "Please wait while we load the meeting proposal." : "Vinsamlega bíðið meðan tillöguni um fund er hlaðið inn.",
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "Tengillinn sem þú fylgdir gæti verið bilaður, eða að tillagan að fundi sé ekki lengur til staðar.",
    "Thank you for your response!" : "Takk fyrir svarið!",
    "Your vote has been recorded. Thank you for participating!" : "Atkvæði þitt hefur verið skráð. Takk fyrir að taka þátt!",
    "Unknown User" : "Óþekktur notandi",
    "No Title" : "Enginn titill",
    "No Duration" : "Engin tímalengd",
    "Select a different time zone" : "Veldu annað tímabelti",
    "Submit" : "Senda inn",
    ...
    "Please ask your administrator to enable the Tasks App." : "Biddu kerfisstjórann þinn um að virkja verkefnaforritið (Tasks).",
    "You are not allowed to edit this event as an attendee." : "Þú hefur ekki heimild til að breyta þessum atburði sem þátttakandi.",
    "W" : "V",
    "%n more" : "%n til viðbótar",
    "No events to display" : "Engir atburðir til að birta",
    "{startDate} to {endDate}" : "{startDate} til {endDate}",
    "{startDateTime} to {endTime}" : "{startDateTime} til {endTime}",
    "{startDateTime} to {endDateTime}" : "{startDateTime} til {endDateTime}",
    "{title}, All day: {timeDescription}" : "{title}, Allan daginn: {timeDescription}",
    "{title}, All day" : "{title}, Allan daginn",
    "{title}, {timeDescription}" : "{title}, {timeDescription}",
    "All participants declined" : "Allir þátttakendur höfnuðu",
    "Please confirm your participation" : "Staðfestu þátttöku þína",
    "You declined this event" : "Þú hafnaði þessum atburði",
    "Your participation is tentative" : "Þátttaka þín er með fyrirvara",
    ...
    "Event link copied to clipboard" : "Tengill á atburð afritaður á klippispjald",
    "Failed to copy event link" : "Mistókst að afrita tengil á atburð",
    ...
    "Other" : "Annað",
    "Audio-visual equipment" : "Sýningabúnaður",
    "Phone" : "Sími",
    "Video conferencing" : "Myndfundir",
    "TV" : "Sjónvarp",
    ...
    "The visibility of this event in read-only shared calendars." : "Sýnileiki þessa atburðar í sameiginlegum skrifvörðum dagatölum.",
    ...
    "This meeting proposal no longer exists" : "Þessi tillaga um fund er ekki lengur til",
    "Failed to open meeting proposal" : "Mistókst að opna tillögu um fund",
    ...
    "Error creating a folder {folder}" : "Villa við að búa til möppuna {folder}",
    "Attachment {fileName} already exists!" : "Viðhengið {fileName} er þegar til staðar!",
    "Attachment {fileName} added!" : "Viðhenginu {fileName} bætt við!",
    "An error occurred during uploading file {fileName}" : "Villa kom upp við að senda inn skrána {fileName}",
    "An error occurred during getting file information" : "Villa kom upp við að sækja upplýsingar um skrá",
    "Talk conversation for proposal" : "Talk-spjall fyrir tillögu",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Tókst ekki að hlaða inn framvísuðum dagatölum. Gakktu úr skugga um að þjónninn styðji framvísun dagatala.",
