OC.L10N.register(
    ...
    "Some events in this calendar are broken. Please check the JS console for more info." : "日历中的某些事件已损坏。更多信息请在 JS 控制台中查看。",
    "Share Calendar" : "共享日历",
    "Shared" : "已共享",
    "Could not save WebCal-calendar" : "无法保存 WebCal 日历",
    "WebDAV address for subscriptions" : "订阅的 WebDAV 地址",
    "Email sent." : "邮件已发送。",
    ...
    "Please enter a valid WebCal-URL" : "请输入有效的 WebCal 地址",
    "Severe error in webcal proxy. Please contact administrator for more information." : "webcal 代理中出现严重错误。要获取更详细信息，请与管理员联系。",
    ...
    "iCal link" : "iCal 链接",
    "Download" : "下载",
    "Share with users, groups or circles" : "共享给用户、群组或圈子",
    "can edit" : "可编辑",
    "Share link" : "共享链接",
    "Public access" : "公开访问",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "也许您访问了错误的链接或者此日历未被共享？",
    "Edit event" : "编辑事件",
    "Delete Event" : "删除事件",
    "Save Event" : "保存事件",
    "Time" : "时间",
    ...
    "%s shared the calendar <strong>%s</strong> with you" : "%s 给您共享了日历 <strong>%s</strong>",
    "Embed" : "嵌入",
    "Iframe to integrate" : "整合 iframe",
    "Publish URL" : "发布 URL",
