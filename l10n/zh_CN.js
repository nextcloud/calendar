OC.L10N.register(
    ...
    "can edit and see confidential events" : "可以编辑和查看机密事件",
    ...
    "This calendar supports neither events, tasks nor journal entries." : "此日历不支持事件、任务或日志记录。",
    ...
    "after" : "之后",
    "End repeat" : "结束重复",
    "This event is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it." : "此事件是重复事件的例外项，无法为其添加重复规则。",
    "first" : "第一个",
    ...
    "Invite" : "邀请",
    "Discard changes?" : "舍弃更改？",
    "Are you sure you want to discard the changes made to this event?" : "是否确定要舍弃对此事件所做的更改？",
    ...
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "是否创建“{date}”的会议？这将创建一个包含所有参与者的日历事件。",
    ...
    "You are not allowed to edit this event as an attendee." : "不允许您以参加者身份编辑此事件。",
    "W" : "周",
    "%n more" : "%n更多",
    ...
    "The visibility of this event in read-only shared calendars." : "此事件在只读共享日历中的可见性。",
    "Add a location" : "添加地点",
