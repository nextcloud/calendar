OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "你的预约 \"%s\" 需要确认",
    "Dear %s, please confirm your booking" : "亲爱的 %s，请确认你的登记",
    "Confirm" : "确认",
    "This confirmation link expires in %s hours." : "确认链接将在 %s 小时内过期",
    "If you wish to cancel the appointment after all, please contact your organizer." : "如果您还是想取消预约，请与组织者联系",
    "Appointment:" : "预约：",
    "Date:" : "日期：",
    "Where:" : "地点：",
    "Description:" : "描述：",
    ...
    "Save" : "保存",
    "Update" : "更新",
    "Your appointment is booked" : "你的预约已登记",
