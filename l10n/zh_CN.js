OC.L10N.register(
    ...
    "Cheers!" : "干杯！",
    "Recipient" : "容器",
    "The remote server did not give us access to the calendar (HTTP 404 error)" : "远程服务器并没有告诉我们日历的数据库在哪里（HTTP 404错误）",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "也许你访问了错误的连接或者此日历未被共享？",
    "Edit event" : "编辑事件",
    "Delete Event" : "删除事件",
    "Save Event" : "保存事件",
    "Time" : "时间",
    ...
    "%s shared the calendar <strong>%s</strong> with you" : "%s给你共享了日历 <strong>%s</strong>",
    "Embed" : "嵌入",
