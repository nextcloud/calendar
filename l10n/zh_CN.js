OC.L10N.register(
    ...
    "Select Date" : "选择日期",
    "[from] {dateFormat}" : "[从] {dateFormat}",
    "[to] {dateFormat}" : "[到] {dateFormat}",
    "[on] {dateFormat}" : "[在] {dateFormat}",
    "[from] {dateFormat} [at] {timeFormat}" : "[从] {dateFormat} [的] {timeFormat}",
    "[to] {dateFormat} [at] {timeFormat}" : "[到] {dateFormat} [的] {timeFormat}",
    "[on] {dateFormat} [at] {timeFormat}" : "[在] {dateFormat} [的] {timeFormat}",
    "{dateFormat} [at] {timeFormat}" : "{dateFormat} [的] {timeFormat}",
