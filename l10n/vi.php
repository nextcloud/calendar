...
"Share CalendarManager" => "Chia sẻ lịch",
"Download" => "Tải về",
"Edit" => "Chỉnh sửa",
"Delete" => "Xóa",
...
"Active" => "Kích hoạt",
"CalendarManager color" => "Màu lịch",
"Save" => "Lưu",
"Submit" => "Xác nhận",
"Cancel" => "Hủy",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Đã tồn tại một lịch với tên này. Nếu bạn tiếp tục, những lịch này sẽ trộn với nhau.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "Đồng bộ địa chỉ lịch CalDAV",
