OC.L10N.register(
    ...
    "Automatic" : "자동",
    "Automatic ({timezone})" : "자동({timezone})",
    ...
    "Appointment schedule saved" : "약속 일정이 저장되었습니다",
    "Create appointment schedule" : "약속 일정 생성",
    "Edit appointment schedule" : "약속 일정 수정",
    "Update" : "업데이트",
    ...
    "Minimum time before next available slot" : "다음 약속까지 최소 여유 시간",
    "Max slots per day" : "일일 최대 약속 수",
    "Limit how far in the future appointments can be booked" : "약속을 잡을 수 있는 날짜 범위를 제한합니다",
    ...
    "An error occurred, unable to read public calendars." : "오류가 발생하여 공개 달력을 읽을 수 없습니다.",
