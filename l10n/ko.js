OC.L10N.register(
    ...
    "Cheers!" : "감사합니다!",
    "Recipient" : "받는 사람",
    "URL violates local access rules" : "URL이 로컬 접근 규칙을 위반함",
    "The remote server did not give us access to the calendar (HTTP 404 error)" : "원격 서버에서 달력 접근을 허용하지 않음(HTTP 404 오류)",
    ...
    "iCal link" : "iCal 링크",
    "Download" : "다운로드",
    "Share with users, groups or circles" : "사용자, 그룹, 서클과 공유",
    "can edit" : "편집 가능",
    "Share link" : "링크 공유",
    "Public access" : "공개 접근",
    ...
    "File could not be parsed" : "파일을 처리할 수 없음",
    ...
    "iOS/macOS CalDAV address" : "iOS/macOS CalDAV 주소",
    "Subscribe" : "구독"
},
"nplurals=1; plural=0;");
