...
"Dec." => "דצמ׳",
"All day" => "היום",
"New CalendarManager" => "לוח שנה חדש",
...
"Share CalendarManager" => "שיתוף לוח שנה",
"Download" => "הורדה",
"Edit" => "עריכה",
"Delete" => "מחיקה",
...
"Active" => "פעיל",
"CalendarManager color" => "צבע לוח שנה",
"Save" => "שמירה",
"Submit" => "שליחה",
"Cancel" => "ביטול",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "לוח שנה בשם הזה כבר קיים. אם תמשיך בכל זאת, לוחות השנה ימוזגו.",
...
"URLs" => "כתובות",
"CalendarManager CalDAV syncing addresses" => "כתובות סנכרון ללוח שנה CalDAV",
"more info" => "מידע נוסף",
