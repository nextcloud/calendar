OC.L10N.register(
    ...
    "Add holiday calendar" : "Přidat kalendář svátků",
    ...
    "Global" : "Globální",
    "Holiday calendars" : "Kalendáře svátků",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Kalendáře svátků jsou poskytovány projektem Thunderbird. Data kalendáře budou stažena z {website}",
    "By {authors}" : "Od {authors}",
    "Subscribed" : "Přihlášeno se k odběru",
    "Subscribe" : "Přihlásit se k odběru",
    "Holidays in {region}" : "Svátky v {region}",
    "An error occurred, unable to create the holiday calendar." : "Došlo k chybě – nepodařilo se vytvořit kalendář svátků.",
