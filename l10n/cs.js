OC.L10N.register(
    ...
    "Cheers!" : "Mějte se!",
    "Recipient" : "Adresát",
    "URL violates local access rules" : "URL porušuje místní pravidla pro přístup",
    "The remote server did not give us access to the calendar (HTTP 404 error)" : "Vzdálený server nepovolil přístup ke kalendáři (HTTP chyba 404)",
    ...
    "Could not send your email." : "Váš email se nedaří odeslat",
    "group" : "skupina",
    "circle" : "okruh",
    "Details" : "Podrobnosti",
    "Attendees" : "Účastníci",
    ...
    "Email {time} before the event starts" : "{time} před začátkem události poslat email",
    ...
    "Email {time} before the event ends" : "Email {time} před koncem události",
    ...
    "Email {time} after the event starts" : "Email {time} po začátku události",
    ...
    "Email {time} after the event ends" : "Email {time} po konci události",
    ...
    "Email at the event's start" : "Email při začátku události",
    ...
    "Email at the event's end" : "Email při konci události",
    ...
    "Download" : "Stáhnout",
    "Share with users, groups or circles" : "Sdílejte s uživateli, skupinami nebo okruhy",
    "can edit" : "lze upravovat",
    "Share link" : "Sdílet odkaz",
    "Public access" : "Veřejný přístup",
    "Email link to person" : "Odeslat odkaz emailem",
    "Send" : "Odeslat",
    ...
    "Email reminders have not been implemented in the CalDAV server yet, so none will be sent." : "Upozornění emailem zatím nebyla v Caldav serveru implementována, takže nebudou zaslána.",
    "Add" : "Přidat",
    "Email address of attendee" : "Emailová adresa účastníka",
    "Please add your email address in the personal settings in order to add attendees." : "Zadejte svou emailovou adresu v osobním nastavení, abyste mohli přidávat účastníky.",
    "from" : "od",
    "to" : "do",
