OC.L10N.register(
    ...
    "Provided email-address is not valid" : "Zadaná adresa nevypadá jako platný e-mail",
    ...
    "_Unsharing the calendar in {countdown} second_::_Unsharing the calendar in {countdown} seconds_" : ["Kalendář přestanu sdílet za {countdown} sekundu","Kalendář přestanu sdílet za {countdown} sekundy","Kalendář přestanu sdílet za {countdown} sekund","Kalendář přestanu sdílet za {countdown} sekundy"],
    "_Deleting the calendar in {countdown} second_::_Deleting the calendar in {countdown} seconds_" : ["Smazání kalendářee za {countdown} sekundu","Smazání kalendářee za {countdown} sekundy","Smazání kalendářee za {countdown} sekund","Smazání kalendářee za {countdown} sekundy"],
    ...
    "before at" : "před v",
    "Edit reminder" : "Upravit připomínku",
    ...
    "_, %n time_::_, %n times_" : [", %n krát",", %n krát",", %n krát",", %n krát"],
    "The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost." : "Opakovací pravidlo této události není zcela podporováno Nextcloudem. Pokud ho budete editovat, mohou něktrá opakování události zmizet.",
    "More" : "Více",
    "Save" : "Uložit",
    "Update" : "Aktualizovat",
    ...
    "Personal" : "Osobní",
    "The automatic timezone detection determined your timezone to be UTC.\nThis is most likely the result of security measures of your web browser.\nPlease set your timezone manually in the calendar settings." : "Automatická detekce časové zóny určila vaši zónu jako UTS.\nTo je nejspíš kvůli bezprečnostním nastavením prohlížeče.\nNastavte prosám časovou zónu ručně.",
    ...
    "Travel" : "Cestovat",
    "Vacation" : "Dovolená",
    "Midnight on the day the event starts" : "Nejbližší půlnoc přede začátkem události",
    "_%n day before the event at {formattedHourMinute}_::_%n days before the event at {formattedHourMinute}_" : ["%n den před událostí v {formattedHourMinute}","%n dni před událostí v {formattedHourMinute}","%n dní před událostí v {formattedHourMinute}","%n dni před událostí v {formattedHourMinute}"],
    ...
    "The visibility of this event in shared calendars." : "Viditelnost ve sdílených kalendářích",
    "Location" : "Umístění",
    ...
    "Take this event into account when calculating free-busy information." : "Zohledni tuto událost při určování zaneprázdněných/volných hodin.",
    "Free" : "Volné",
    "Busy" : "Zaneprázdněno",
