OC.L10N.register(
    ...
    "Calendar name can not be blank" : "Název kalendáře nemůže zůstat nevyplněný",
    ...
    "Select default reminder" : "Nastavit výchozí připomínku",
    ...
    "View" : "Zobrazit",
    "Delete proposal" : "Smazat návrh",
    "Event legend" : "Vysvětlivka k události",
    "Busy" : "Zaneprázdněno",
    "Free" : "Volné",
    ...
    "Invited" : "Pozvaný",
    "Declined" : "Odmítnuto",
    "All declined" : "Všichni odmítli",
    "Icons" : "Ikony",
    "Attendees" : "Účastníci",
    "Past events" : "Minulé události",
    "Past event" : "Minulá událost",
    ...
    "Editor" : "Editor",
    "Delegates" : "Deleguje",
    "Loading delegates…" : "Načítání delegátů…",
    ...
    "Booking calendar" : "Kalendář rezervací",
    "Visibility" : "Viditelnost",
    "Booking availability" : "Dostupnost rezervování",
    "to" : "do",
    ...
    "_{i} day_::_{i} days_" : ["{i} den","{i} dny","{i} dnů","{i} dny"],
    "_{i} hour_::_{i} hours_" : ["{i} hodina","{i} hodiny","{i} hodin","{i} hodiny"],
    "_{i} minute_::_{i} minutes_" : ["{i} minuta","{i} minuty","{i} minut","{i} minuty"],
    "Days" : "Dny",
    "Hours" : "Hodiny",
    "Minutes" : "Minut",
    ...
    "Send email to {email}" : "Odeslat e-mail na {email}",
    ...
    "Set repetition" : "Nastavit opakování",
    "never" : "nikdy",
    "on date" : "dne",
    "after" : "po",
    ...
    "first" : "první",
    "Week occurrence" : "Výskyt v týdnu",
    ...
    "Repeat frequency" : "Četnost opakování",
