OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Je afspraak \"%s\" moet bevestigd worden",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Als je de afspraak wil afzeggen, neem contact op met de organisator.",
    ...
    "Save" : "Opslaan",
    "Update" : "Bijwerken",
    "Your appointment is booked" : "Je afspraak is geboekt",
    ...
    "Checking availability." : "Controleren beschikbaarheid",
    "Invitation accepted." : "Uitnodiging geaccepteerd.",
    "Accepted {organizerName}'s invitation." : "Accepteerde {organizerName}'s uitnodiging.",
    "Invitation declined." : "Uitnodiging afgewezen.",
    "Declined {organizerName}'s invitation." : "Wees {organizerName}'s uitnodiging af.",
    ...
    "Has not responded to {organizerName}'s invitation yet." : "Heeft nog niet op {organizerName}'s uitnodiging gereageerd.",
