OC.L10N.register(
    ...
    "%s has proposed a meeting" : "%s heeft een bijeenkomst voorgesteld ",
    "%s has updated a proposed meeting" : "%s heeft een voorgestelde bijeenkomst gewijzigd",
    "%s has canceled a proposed meeting" : "%s heeft een voorgestelde bijeenkomst afgelast ",
    "Dear %s, a new meeting has been proposed" : "Beste %s, er is een voorstel voor een nieuwe bijeenkomst ",
    "Dear %s, a proposed meeting has been updated" : "Beste %s, een voorgestelde bijeenkomst is gewijzigd",
    "Dear %s, a proposed meeting has been cancelled" : "Beste %s, een voorgestelde bijeenkomst is afgelast",
    "Location:" : "Locatie:",
    ...
    "Meeting proposals" : "Voorstellen voor bijeenkomst",
    "A configured email address is required to use meeting proposals" : "Een geconfigureerd e-mail adres is vereist om bijeenkomsten voor te stellen",
    "No active meeting proposals" : "Geen actieve bijeenkomst voorstellen",
    "View" : "Bekijken",
    ...
    "Error fetching Talk conversations." : "Fout bij ophalen Talk conversaties",
    "Conversation does not have a valid URL." : "Conversatie heeft geen geldige URL",
