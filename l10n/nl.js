OC.L10N.register(
    ...
    "An error occured during sending email" : "Er is een fout opgetreden tijdens het verzenden van een e-mail",
    ...
    "All day" : "Hele dag",
    "Modifications wont get propagated to the organizer and other attendees" : "Wijzigingen worden niet doorgestuurd naar de organisator en andere deelnemers.",
    ...
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Creëer aan vergadering op \"{date}\"? Dit zal een agendagebeurtenis creëren voor alle deelnemers.",
    ...
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "De link die je volgende kan stuk zijn, of het vergaderverzoek bestaat niet langer",
    ...
    "All participants declined" : "Alle deelnemers afgewezen",
    "Please confirm your participation" : "Bevestig je deelname",
    "You declined this event" : "Je hebt dit evenement afgewezen",
    "Your participation is tentative" : "Voorlopige deelname",
    ...
    "Create a new public conversation" : "Creëer een nieuw publiek gesprek",
    "Availability will be checked" : "Beschikbaarheid wordt gecontroleerd",
    ...
    "_%n more guest_::_%n more guests_" : ["%n meer gast","%n meer gasten"],
