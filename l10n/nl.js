OC.L10N.register(
    ...
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Creëer aan vergadering op \"{date}\"? Dit zal een agendagebeurtenis creëeren voor alle deelnemers.",
    ...
    "Creating meeting for {date}" : "Bezig met het creëeren van een vergadering op {date}",
    "Successfully created meeting for {date}" : "Vergadering succesvol gecreëerd op {date}",
    "Failed to create a meeting for {date}" : "Mislukt om een vergadering te creëeren voor{date}",
