...
"Share CalendarManager" => "Compartilhar Calendário",
"Download" => "Baixar",
"Edit" => "Editar",
"Delete" => "Excluir",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Um calendário com este nome já existe. Se de qualquer forma você continuar, estes calendários serão fundidos.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "Sincronização de endereços do calendário CalDAV",
