OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Avtalen din \"%s\" trenger bekreftelse",
    "Dear %s, please confirm your booking" : "Kjære %s, vennligst bekreft bookingen din",
    "Confirm" : "Bekreft",
    "This confirmation link expires in %s hours." : "Denne bekreftelseslinken utgår om %stimer.",
    "If you wish to cancel the appointment after all, please contact your organizer." : "Hvis du ønsker å avlyse avtalen likevel, vennligst kontakt arrangøren din.",
    "Appointment:" : "Avtale:",
    "Date:" : "Dato:",
    "Where:" : "Hvor:",
    ...
    "No attendees yet" : "Ingen deltagere enda",
    ...
    "from {formattedDate} at {formattedTime}" : "fra {formattedDate} på {formattedTime}",
    "to {formattedDate} at {formattedTime}" : "til {formattedDate} på {formattedTime}",
    "on {formattedDate} at {formattedTime}" : "på {formattedDate} på {formattedTime}",
    "{formattedDate} at {formattedTime}" : "{formattedDate} på {formattedTime}",
    ...
    "Event does not exist" : "Avtalen finnes ikke",
