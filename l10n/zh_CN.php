...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "已有日历使用此名称。如果您执意继续，这些日历将会合并。",
...
"URLs" => "网址",
"CalendarManager CalDAV syncing addresses" => "日历 CalDAV 同步地址",
"more info" => "更多信息",
