OC.L10N.register(
    ...
    {
    "Calendar" : "Ημερολόγιο",
    "%s has published the calendar \"%s\"" : "%s το ημερολόγιο έχει δημοσιευθεί \"%s\"",
    "Too many redirects. Aborting ..." : "Πάρα πολλές ανακατευθύνσεις. Ματαίωση ...",
    "The remote server did not give us access to the calendar (HTTP {%s} error)" : "Ο απομακρυσμένος διακομιστής δεν μας δίνει πρόσβαση στο ημερολόγιο (HTTP {%s} σφάλμα)",
    ...
    "There was an issue while sending your EMail." : "Υπήρξε πρόβλημα κατά την αποστολή Email.",
    "group" : "ομάδα",
