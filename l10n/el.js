OC.L10N.register(
    ...
    "Add holiday calendar" : "Προσθήκη εορταστικού ημερολογίου",
    ...
    "Global" : "Καθολικό",
    "Holiday calendars" : "Ημερολόγια εορτών",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Τα ημερολόγια διακοπών παρέχονται από τον Thunderbird. Τα δεδομένα του ημερολογίου θα ληφθούν από {website}",
    "By {authors}" : "Από {authors}",
    "Subscribed" : "Εγγεγραμμένα",
    "Subscribe" : "Εγγραφή",
    "Holidays in {region}" : "Αργίες σε {region}",
    "An error occurred, unable to create the holiday calendar." : "Εμφανίστηκε σφάλμα, δεν ήταν δυνατή η δημιουργία του ημερολογίου αργιών.",
    ...
    "Relax" : "Ξεκούραση",
    "Break" : "Διάλειμμα",
    "Commute" : "Μετακίνηση προς την εργασία",
