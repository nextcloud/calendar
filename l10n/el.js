OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Το ραντεβού σας \"%s\" χρειάζεται επιβεβαίωση.",
    "Dear %s, please confirm your booking" : "Αγαπητέ %s, παρακαλω επιβεβαιώστε την κράτησή σας",
    "Confirm" : "Επιβεβαιώνω",
    "This confirmation link expires in %s hours." : "Αυτός ο σύνδεσμος επιβεβαίωσης λήγει σε %s ώρες",
    "If you wish to cancel the appointment after all, please contact your organizer." : "Εάν τελικά επιθυμείτε να ακυρώσετε την κράτησή σας, παρακαλούμε να ενημερώσετε τον διοργανωτή σας.",
    ...
    "Edit" : "Επεξεργασία",
    "Delete" : "Διαγραφή",
    "Appointment link was copied to clipboard" : "Ο σύνδεσμος λίστας αντιγράφηκε στο πρόχειρο.",
    "Appointment link could not be copied to clipboard" : "Δεν ήταν δυνατή η αντιγραφή του συνδέσμου λίστας στο πρόχειρο.",
    ...
    "Time increments" : "Χρονικές προσαυξήσεις",
    ...
    "To configure appointments, add your email address in personal settings." : "Για να ρυθμίσετε τα ραντεβού σας, προσθέστε την διέυθυνση email στις προσωπικές ρυθμίσεις",
    ...
    "Saturday" : "Σάββατο",
    "Sunday" : "Κυριακή",
    "Add time before and after the event" : "Προσθέστε χρόνο πρίν και μετά απο το γεγονός",
    "Before the event" : "Πρίν το γεγονός",
    ...
    "Max slots per day" : "Μέγιστες θέσεις ανα ημέρα",
    ...
    "Save" : "Αποθήκευση",
    "Update" : "Ενημέρωση",
    "Your appointment is booked" : "Το ραντεβού σας έχει κανονιστεί",
    ...
    "Book the appointment" : "Κλείστε το Ραντεβού Σας",
    "Reminder" : "Υπενθύμιση",
    ...
    "Participation marked as tentative" : "Η συμμετοχή χαρακτηρίστηκε ως δοκιμαστική",
    ...
    "No recurrence" : "Καμμία επανάληψη",
    ...
    "Relax" : "Ξεκούραση",
    "Break" : "Διάλλειμα",
    "Commute" : "Μετακίνούμαι",
    "Commuting" : "Μετακίνηση",
    "Invoice" : "Tιμολόγιο",
    ...
    "Hairdresser" : "Κουρείο",
    "Exam" : "Εξετάσεις",
    "Written test" : "Γραπτή εξέταση",
    "Oral test" : "Προφορική εξέταση",
    "Working" : "Εργαζόμενος",
