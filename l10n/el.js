OC.L10N.register(
    ...
    "URL violates local access rules" : "Ο σύνδεσμος URL παραβιάζει τους κανόνες τοπικής πρόσβασης",
    "The remote server did not give us access to the calendar (HTTP 404 error)" : "Ο απομακρυσμένος διακομιστής δεν έδωσε άδεια στο ημερολόγιο (Σφάλμα HTTP 404)",
