OC.L10N.register(
    ...
    "Default calendar for invitations and new events" : "Taklifnomalar va yangi tadbirlar uchun birlamchi taqvim",
    "Appointment was created successfully" : "Uchrashuv muvaffaqiyatli yaratildi",
    "Appointment was updated successfully" : "Uchrashuv muvaffaqiyatli yangilandi",
    "Create appointment" : "Uchrashuv yaratish",
    "Edit appointment" : "Uchrashuvni tahrirlash",
    "Book the appointment" : "Uchrashuvni bronlash",
    "You do not own this calendar, so you cannot add attendees to this event" : "Siz ushbu taqvimga ega emassiz, shuning uchun siz ushbu tadbirga ishtirokchilarni qo'sha olmaysiz",
    "Create Talk room for this event" : "Ushbu tadbir uchun suhbat xonasi yarating",
    "Search for emails, users, contacts or groups" : "Elektron pochta, foydalanuvchilar, kontaktlar yoki guruhlarni qidiring",
    "Select date" : "Sanani tanlang",
    "[Today]" : "[Bugun]",
    "[Tomorrow]" : "[Ertaga]",
    "[Yesterday]" : "[Kecha]",
    "[Last] dddd" : "[Oxirgi] dddd",
    "Create a new event" : "Yangi tadbirni yarating",
    "in {monthNames}" : " {monthNames} da",
    "Add a description" : "Tavsif qo'shing",
    "Chat room for event" : "Tadbir uchun suhbat xonasi"
},
"nplurals=1; plural=0;");
