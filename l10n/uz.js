OC.L10N.register(
    ...
    "Requestor Comments:" : "So'rovchining izohlari:",
    "Appointment Description:" : "Uchrashuv tavsifi:",
    ...
    "Location:" : "Manzil:",
    "%1$s minutes" : "%1$s daqiqa",
    "Duration:" : "Davomiyligi:",
    "%1$s from %2$s to %3$s" : "%1$s: %2$s dan %3$s gacha",
    "Dates:" : "Sanalar:",
    "Respond" : "Javob bering",
    "[Proposed] %1$s" : "[Proposed] %1$s",
    "Calendar App" : "Taqvim ilovasi",
    "Calendars App settings including proposals and appointments schedule configurations." : "Takliflar va uchrashuvlar jadvali konfiguratsiyalarini o'z ichiga olgan kalendarlar ilovasi sozlamalari.",
    ...
    "Calendar name can not be blank" : "Taqvim nomi bo'sh bo'lmasligi kerak",
    ...
    "My calendars" : "Mening taqvimlarim",
    ...
    "can edit and see confidential events" : "maxfiy tadbirlarni tahrirlashi va ko'rishi mumkin",
    ...
    "events" : "tadbirlar",
    "tasks" : "vazifalar",
    "journal entries" : "kundalik yozuvlari",
    "This calendar supports neither events, tasks nor journal entries." : "Bu taqvim na tadbirlarni, na vazifalarni, na kundalik yozuvlarini qo'llab-quvvatlamaydi.",
    "_This calendar supports only {types}._::_This calendar supports {types}._" : ["Bu taqvim {types} ni qo'llab-quvvatlaydi."],
    "None" : "Yo'q",
    ...
    "Select default reminder" : "Standart eslatmani tanlang",
    "This reminder will be automatically added to all new events created in this calendar" : "Ushbu eslatma ushbu taqvimda yaratilgan barcha yangi tadbirlarga avtomatik ravishda qo'shiladi",
    ...
    "View" : "Ko'rish",
    "Delete proposal" : "Taklifni o'chirish",
    "Import destination selection" : "Import qilinadigan joyni tanlash",
    ...
    "Attachments folder" : "Qo'shimchalar jildi",
    ...
    "Availability settings" : "Mavjudlik sozlamalari",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Boshqa ilova va qurilmalardan Nextcloud taqvimlariga kirish",
    "CalDAV URL" : "CalDAV URL",
    "Server Address for iOS and macOS" : "iOS va macOS uchun server manzili",
    "Appearance" : "Tashqi ko'rinish",
    "Birthday calendar" : "Tug'ilgan kun taqvimi",
    "Tasks in calendar" : "Taqvimdagi vazifalar",
    "Weekends" : "Dam olish kunlari",
    "Week numbers" : "Hafta raqamlari",
    "Limit number of events shown in Month view" : "Oylik ko'rinishda ko'rsatiladigan tadbirlar sonini cheklash",
    "Density in Day and Week View" : "Kun va hafta ko'rinishidagi zichlik",
    "Editing" : "Tahrirlash",
    "Simple event editor" : "Oddiy tadbir muharriri",
    "\"More details\" opens the detailed editor" : "\"Batafsil ma'lumot\" batafsil muharrirni ochadi",
    "Files" : "Fayllar",
    ...
    "Select existing conversation" : "Mavjud suhbatni tanlang",
    "Select conversation" : "Suhbatni tanlang",
    "Or create a new conversation" : "Yoki yangi suhbat yarating",
    "Create public conversation" : "Ommaviy suhbat yarating",
    "Create private conversation" : "Shaxsiy suhbat yarating",
    "on" : "da",
    "at" : "ga",
    "Default reminder of calendar" : "Taqvimning standart eslatmasi",
    "Amount" : "Miqdori",
    "before at" : "oldin",
    ...
    "You are about to navigate to {link}. Are you sure to proceed?" : "Siz {link} sahifasiga o'tmoqchisiz. Davom etishga ishonchingiz komilmi?",
    ...
    "Failed to copy" : "Nusxalashda xatolik yuz berdi",
    "Copy name and email address" : "Ism va elektron pochta manzilini nusxalash",
    "Send email to {email}" : "Elektron pochta xabarini {email} ga yuboring",
    "No attendees yet" : "Hozircha ishtirokchilar yoʻq",
    "{confirmedCount} confirmed, {waitingCount} awaiting response" : "{confirmedCount} tasdiqlandi, {waitingCount} javob kutmoqda",
    ...
    "Attendees" : "Ishtirokchilar",
    "_%n more attendee_::_%n more attendees_" : ["%n ta ko'proq ishtirokchi"],
    ...
    "Public calendar subscriptions selection" : "Ommaviy taqvim obunalarini tanlash",
    ...
    "Create meeting" : "Uchrashuv yaratish",
    ...
    "The visibility of this event in read-only shared calendars." : "Ushbu tadbirning faqat o'qish uchun umumiy taqvimlarda ko'rinishi.",
