OC.L10N.register(
    ...
    "You are in an unknown timezone ({tz}), falling back to UTC" : "Está numa zona horário desconhecida ({tz}), a repor para UTC",
    ...
    "start" : "Inicio",
    "end" : "fim",
    "Editing reminders of uknown type not supported." : "Não é suportada a edição de lembretes de tipo desconhecido.",
    ...
    "Support for advanced rules will be added with subsequent updates." : "Suporte para regras avançadas será adicionado nas atualizações subsequentes.",
