...
"Wrong calendar" => "CalendarManager greșit",
...
"Dec." => "Dec.",
"All day" => "Toată ziua",
"New CalendarManager" => "CalendarManager nou",
...
"Share CalendarManager" => "Partajați calendarul",
"Download" => "Descarcă",
"Edit" => "Modifică",
"Delete" => "Șterge",
"New calendar" => "CalendarManager nou",
"Edit calendar" => "Modifică calendarul",
"Displayname" => "Nume afișat",
"Active" => "Activ",
"CalendarManager color" => "Culoarea calendarului",
"Save" => "Salveză",
"Submit" => "Trimite",
"Cancel" => "Anulează",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Un calendar cu acest nume există deja. Dacă oricum veți continua, aceste calendare vor fi fuzionate.",
...
"URLs" => "linkuri",
"CalendarManager CalDAV syncing addresses" => "Adrese de sincronizare calendar CalDAV",
