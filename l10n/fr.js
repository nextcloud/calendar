OC.L10N.register(
    ...
    "can edit and see confidential events" : "peut éditer et voir les événements confidentiels",
    ...
    "This calendar supports neither events, tasks nor journal entries." : "Ce agenda ne prend en charge ni les événements, ni les tâches, ni les entrées de journal.",
    ...
    "Delegates" : "Délégués",
    "Allow users to manage your calendar events and invitations on your behalf." : "Autorise les utilisateurs de gérer les événements et invitations de votre calendrier en votre nom.",
    ...
    "Revoke access?" : "Révoquer l'accès ?",
    "Search for a user…" : "Chercher un utilisateur...",
    ...
    "You are about to navigate to {link}. Are you sure to proceed?" : "Vous êtes sur le point de visiter le site {link}. Êtes vous sûr de le vouloir ?",
    ...
    "{confirmedCount} confirmed, {waitingCount} awaiting response" : "{confirmedCount} confirmé(s), {waitingCount} en attente de réponse",
    ...
    "Optional participant" : "Participant facultatif",
    "Non-participant" : "Ne participe pas",
    "Attendees copied to clipboard" : "Invités copiés dans le presse-papier",
    "Failed to copy attendees to clipboard" : "Impossible de copier les invités dans le presse papier",
    "Copy attendees to clipboard" : "Copier les invités dans le presse-papier",
    ...
    "Talk conversation for proposal" : "Parler de conversation pour proposition",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Impossible de déléguer les agendas. Assurez-vous que le serveur supporte la délégation d'agenda.",
