OC.L10N.register(
    ...
    "Some calendars are disabled because this file contains {types}." : "Certains calendriers sont désactivés parce que ce fichier contient {types}.",
    ...
    "The visibility of this event in read-only shared calendars." : "La visibilité de cet événement dans les calendriers partagés en lecture seule.",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Impossible de délégué les calendriers. Assurez-vous que le serveur supporte la délégation de calendrier.",
