OC.L10N.register(
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Si vous souhaitez finalement annuler ce rendez-vous, merci de prendre contact avec l'organisateur.",
    ...
    "_Elements in the trash bin are deleted after {numDays} day_::_Elements in the trash bin are deleted after {numDays} days_" : ["Les éléments dans la corbeille sont supprimés après {numDays} jours","Les éléments dans la corbeille sont supprimés après {numDays} jours"],
    ...
    "_Successfully imported %n event_::_Successfully imported %n events_" : [" %n évènement importé avec succès","%n évènements importés avec succès"],
    ...
    "0 minutes" : "0 minutes",
    "_{duration} hour_::_{duration} hours_" : ["{duration} heure","{duration} heures"],
    "_{duration} day_::_{duration} days_" : ["{duration} jour","{duration} jours"],
    ...
    "Failed to decline the invitation." : "Échec lors du refus de l'invitation.",
    ...
    "_{seatingCapacity} seat_::_{seatingCapacity} seats_" : ["{seatingCapacity} place assise","{seatingCapacity} places assises"],
