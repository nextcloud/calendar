OC.L10N.register(
    ...
    "Global" : "Général",
    "Holiday calendars" : "Calendrier des vacances",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Les calendriers des vacances sont fournis par Thunderbird. Les données des calendriers seront téléchargées à partir de {website}",
    "By {authors}" : "Par {authors}",
    "Subscribed" : "Abonné",
    "Subscribe" : "S'abonner",
    "Holidays in {region}" : "Vacances dans {region}",
    "An error occurred, unable to create the holiday calendar." : "Une erreur est survenue, impossible de créer l'agenda des vacances.",
