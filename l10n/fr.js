OC.L10N.register(
    ...
    "_User requires access to your file_::_Users requires access to your file_" : ["Un utilisateur nécessite l'accès à votre fichier","Des utilisateurs nécessitent l'accès à votre fichier","Des utilisateurs nécessitent l'accès à votre fichier"],
    "_Attachment requiring shared access_::_Attachments requiring shared access_" : ["Pièce jointe nécessitant un accès partagé","Pièces jointes nécessitant un accès partagé","Pièces jointes nécessitant un accès partagé"],
    "Close" : "Fermer",
