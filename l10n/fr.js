OC.L10N.register(
    ...
    "%s has updated a proposed meeting" : "%sa mis à jour une réunion proposée",
    ...
    "Location:" : "Lieu :",
    "Duration:" : "Durée :",
    "%1$s from %2$s to %3$s" : "%1$s de %2$s pour %3$s",
    "Dates:" : "Dates:",
    "Respond" : "Répondre",
    ...
    "Failed to delete proposal" : "La suppression de la proposition a échoué",
    "Failed to retrieve proposals" : "Échec de la récupération des propositions",
    ...
    "Create" : "Créer",
    "No participants or dates available" : "Aucun participant ni date disponible",
    ...
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Créer une réunion pour « {date} » ? Cela créera un événement dans le calendrier avec tous les participants.",
    ...
    "Failed to fetch proposals" : "Échec de la récupération des propositions",
    "Failed to fetch free/busy data" : "Échec de la récupération des informations de disponibilité",
