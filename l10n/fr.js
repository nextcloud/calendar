OC.L10N.register(
    ...
    "Date:" : "Date :",
    "You will receive a link with the confirmation email" : "Vous recevrez un lien avec l'e-mail de confirmation",
    "Where:" : "Lieu :",
    "Comment:" : "Commentaire :",
    ...
    "Add holiday calendar" : "Ajouter l'agenda de congés",
    ...
    "Location" : "Lieu",
    "Create a Talk room" : "Créer un salon de discussion",
    ...
    "Global" : "Général",
    "Holiday calendars" : "Agendas de congés",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Les agendas de congés sont fournis par Thunderbird. Les données de l'agenda seront téléchargés à partir de {website}",
    "By {authors}" : "Par {authors}",
    "Subscribed" : "Abonné",
    "Subscribe" : "S'inscrire",
    "Holidays in {region}" : "Congés dans {region}",
    "An error occurred, unable to create the holiday calendar." : "Une erreur est survenue, impossible de créer l'agenda de congés.",
