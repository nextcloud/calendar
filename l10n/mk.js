OC.L10N.register(
    ...
    "You are about to download a file. Please check the file name before opening it. Are you sure to proceed?" : "Ќе преземете датотека. Проверете го името пред да ја отворите. Дали сте сигурни дека сакате да продолжите?",
    ...
    "Limit number of events shown in month view" : "Ограничи го бројот на прикажани настани во месечен преглед",
    "Time division in day and week view" : "Поделба на време во дневен и неделен преглед",
