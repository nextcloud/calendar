OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Потребна е потврда за состанокот \"%s\"",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Доколку сепак сакате да го откажете терминот, ве молиме контактирајте го вашиот организатор.",
    ...
    "Pick time ranges where appointments are allowed" : "Изберете временски интервал кога состаноците се дозволени",
    "to" : "до",
    ...
    "Limit how far in the future appointments can be booked" : "Ограничете колку далеку во иднина може да се резервираат состаноци",
    "Create appointment" : "Креирајте состанок",
    "Edit appointment" : "Уреди состанок",
    "Save" : "Зачувај",
    "Update" : "Ажурирај",
    "Please confirm your reservation" : "Ве молиме потврдете ја вашата резервација",
    "We sent you an email with details. Please confirm your appointment using the link in the email. You can close this page now." : "Ви испративме е-пошта со детали. Ве молиме потврдете го вашиот состанок користејќи ја врската во е-поштата. Можете да ја затворите оваа страница сега.",
    ...
    "Could not book the appointment. Please try again later or contact the organizer." : "Не може да се резервира состанокот. Обидете се повторно подоцна или контактирајте со организаторот.",
    "Book the appointment" : "Резервирајте состанок",
    "Reminder" : "Потсетник",
    "before at" : "пред",
    ...
    "No recurrence" : "Нема повторување",
    ...
    "The slot for your appointment has been confirmed" : "Терминот за вашиот состанок е потврден",
    "Appointment Details:" : "Детали за состанокот:",
    "Time:" : "Време:",
    ...
    "The slot for your appointment from {startDate} to {endDate} is not available any more." : "Терминот за вашиот состанок од {startDate} до {endDate} не е достапен повеќе.",
    "Please book a different slot:" : "Ве молиме резервирајте друг термин:",
    "Book an appointment with {name}" : "Закажан е состанок со {name}",
    "No public appointments found for {name}" : "Нема пронајдено јавни состаноци за {name}",
    "Personal" : "Лично",
    ...
    "Office" : "Канцеларија",
    "Contributor week" : "Недела на соработници",
    ...
    "Hairdresser" : "Фризер",
    "Exam" : "Испит",
    "Written test" : "Писмен тест",
    "Oral test" : "Усно тестирање",
    "Working" : "Работа",
