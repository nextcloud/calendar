OC.L10N.register(
    ...
    "10 minutes before" : "10 นาทีก่อนหน้านั้น",
    ...
    "start" : "เริ่ม",
    "end" : "จบ",
    "Editing reminders of unknown type not supported." : "แจ้งเตือนการแก้ไขที่ไม่รู้จัก ไม่ได้รับการสนับสนุน",
    "Week {number} of {year}" : "สัปดาห์ที่ {number} ของปี {year}",
    "Successfully imported" : "นำเข้าสำเร็จ",
    "Partially imported, 1 failure" : "นำเข้าได้แค่บางส่วน ล้มเหลวไปแล้ว 1 ",
    "Partially imported, {n} failures" : "นำเข้าได้แค่บางส่วน ล้มเหลวไปแล้ว {n}",
    ...
    "Month" : "เดือน",
    "Today" : "วันนี้",
    "Some events in this calendar are broken. Please check the JS console for more info." : "เหตุการณ์บางอย่างในปฏิทินนี้เสียหาย กรุณาตรวจสอบคอนโซล JS สำหรับข้อมูลเพิ่มเติม",
    ...
    "Subscriptions" : "สมัครสมาชิก",
    "New Subscription" : "สมัครสมาชิกใหม่",
    "Url" : "Url",
    ...
    "Add" : "เพิ่ม",
    "E-Mail address of attendee" : "ที่อยู่อีเมลของผู้เข้าร่วมประชุม",
    "Please add your email address in the personal settings in order to add attendees." : "กรุณาเพิ่มที่อยู่อีเมลของคุณในการตั้งค่าส่วนบุคคลเพื่อเพิ่มผู้เข้าร่วมประชุม",
    "from" : "จาก",
    "to" : "ถึง",
    "This event's repeating rule is not supported yet." : "กฎการทำซ้ำของเหตุการณ์นี้ยังไม่ได้รับการสนับสนุน",
    "Support for advanced rules will be added with subsequent updates." : "การสนับสนุนสำหรับกฎขั้นสูงจะถูกเพิ่มในภายหลังที่มีการอัพเดท",
    "Reset repeating rule" : "รีเซ็ตกฎการทำซ้ำ",
    "Repeat every ..." : "ทำซ้ำตลอด ...",
    "end repeat ..." : "ยกเลิกการทำซ้ำ ...",
    "times" : "ครั้ง",
    "Import Calendars" : "นำเข้าปฏิทิน",
    "Import canceled" : "การนำเข้าถูกยกเลิก",
