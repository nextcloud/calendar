OC.L10N.register(
    ...
    "Cheers!" : "Priekā!",
    "Recipient" : "Saņēmējs",
    "URL violates local access rules" : "Saite pārkāpj lokālos pieejas noteikumus",
    "The remote server did not give us access to the calendar (HTTP 404 error)" : "Attālais serveris mums nedeva piekļuvi kalendāram (HTTP 404 kļūda)",
    ...
    "Some events in this calendar are broken. Please check the JS console for more info." : "Daži notikumi šajā kalendārā ir bojāti. Papildu informācijai pārbaudiet JS konsoli.",
    ...
    "Imported {imported} out of {all}, skipped one duplicate" : "Importēja {imported} no {all}, izlaida vienu dublikātu",
    "Imported {imported} out of {all}, one failure" : "Importēja {imported} no {all}, viena kļūme",
    "Imported {imported} out of {all}, {errors} failures" : "Importēja {imported} no {all}, {errors} kļūmes",
    "Imported {imported} out of {all}, skipped {duplicates} duplicates" : "Importēja {imported} no {all}, izlaida {duplicates} dublikātus",
    ...
    "Email at the event's start" : "Notikumam sākoties, nosūtīt e-apstu",
