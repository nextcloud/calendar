OC.L10N.register(
    ...
    "from {startDate}" : "no",
    "from {startDate} at {startTime}" : "no {startDate} plkst. {startTime}",
    "to {endDate}" : "līdz {endDate}",
    "to {endDate} at {endTime}" : "līdz {endDate} plkst. {endTime}",
    "Repeat" : "Atkārtot",
    ...
    "Conference-call" : "Konferences zvans",
    "Video-call" : "Videozvans",
