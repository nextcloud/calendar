...
"Share CalendarManager" => "Сделать календарь общим",
"Download" => "Загрузка",
"Edit" => "Редактировать",
"Delete" => "Удалить",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Календарь с таким именем  существует. Если вы будете продолжать так или иначе, эти календари будут объединены.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "Адреса синхронизации CalDAV календаря",
