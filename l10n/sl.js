OC.L10N.register(
    ...
    "Cheers!" : "Lep pozdrav!",
    "Recipient" : "Prejemnik",
    "URL violates local access rules" : "Naslov URL krši krajevna pravila dostopa",
    "Too many redirects. Aborting ..." : "Zaznanih je preveč preusmeritev. Opravilo je prekinjeno ...",
    ...
    "Error requesting resource on remote server. This could possible be related to a certificate mismatch" : "Napaka med zahtevo dostopa do vira na oddaljenem strežniku. Morda je problem v neskladnosti potrdila za dostop.",
    "Error requesting resource on remote server" : "Napaka med zahtevo dostopa do vira na oddaljenem strežniku",
    ...
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Obvestilo: %s je objavil koledar {boldstart}%s{boldend}.",
    "Click here to access it" : "Klikni tukaj za dostop.",
    "We wanted to inform you that %s has published the calendar %s." : "Obvestilo: %s je objavil koledar %s.",
    ...
    "Download" : "Prejmi",
    "Share with users, groups or circles" : "Souporaba z uporabniki, skupinami ali krogi",
    ...
    "File could not be parsed" : "Datoteke ni mogoče razčleniti",
