OC.L10N.register(
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Če želite kljub vsemu preklicati sestanek, stopite v stik z organizatorjem.",
    ...
    "We sent you an email with details. Please confirm your appointment using the link in the email. You can close this page now." : "Na elektronski naslov je bilo poslano sporočilo. Prosim, potrdite sestanek s povezavo v sporočilu. To stran lahko zaprete.",
    "Your name" : "Ime",
    ...
    "Participation marked as tentative" : "Udeležba je označena kot začasna",
    ...
    "weekday" : "delovni dan",
    "weekend day" : "vikend",
    "No recurrence" : "Brez ponavljanja",
    ...
    "No public appointments found for {name}" : "Za {name} ni načrtovanih javnih srečanj.",
    "Personal" : "Osebno",
    ...
    "Hairdresser" : "Frizer",
    "Exam" : "Izpit",
    "Written test" : "Pisni izpit, preizkus ali test",
    "Oral test" : "Ustni izpit, preizkus ali test",
    "Working" : "Delo",
