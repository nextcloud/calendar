OC.L10N.register(
    ...
    "An error occurred during sending email" : "Tharla earráid agus ríomhphost á sheoladh",
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "D’fhreagair %1$s do thogra cruinnithe \"%2$s\"",
    "{participant} responded to your meeting proposal {proposal}" : "D’fhreagair {participant} do thogra cruinnithe {proposal}",
    "Appointments" : "Coinní",
    ...
    "Notifications muted" : "Fógraí balbhaithe",
    "Delegated to you by" : "Tarmligthe chugat ag",
    ...
    "Calendar name can not be blank" : "Ní féidir ainm an fhéilire a fhágáil bán",
    ...
    "Deck" : "Deic",
    "Tasks" : "Tascanna",
    "Delegated by {name} (read-only)" : "Tarmligthe ag {name} (léamh amháin)",
    "Delegated by {name}" : "Tarmligthe ag {name}",
    ...
    "Disable alarm notifications for this calendar" : "Díchumasaigh fógraí aláraim don fhéilire seo",
    "Default reminder for part-day events" : "Meabhrúchán réamhshocraithe le haghaidh imeachtaí cuid den lá",
    "Select default reminder" : "Roghnaigh meabhrúchán réamhshocraithe",
    "Default reminder for full-day events" : "Meabhrúchán réamhshocraithe le haghaidh imeachtaí lae iomláin",
    "These reminders will be automatically added to new events created in this calendar" : "Cuirfear na meabhrúcháin seo le himeachtaí nua a chruthaítear sa fhéilire seo go huathoibríoch.",
    ...
    "View" : "Amharc",
    "Delete proposal" : "Scrios an togra",
    "Event legend" : "Finscéal imeachta",
    "Calendar events are styled to convey additional information at a glance." : "Tá imeachtaí féilire stílithe chun faisnéis bhreise a chur in iúl go hachomair.",
    "Free / Busy" : "Saor / Gnóthach",
    "Busy" : "Gnóthach",
    "Busy: your time is marked as occupied" : "Gnóthach: tá do chuid ama marcáilte mar ghnóthach",
    "Free" : "Saor",
    "Free: your time is still available" : "Saor in aisce: tá do chuid ama fós ar fáil",
    "Participation status" : "Stádas rannpháirtíochta",
    "Accepted" : "Glactar leis",
    "Accepted: you confirmed your attendance" : "Glactha: dheimhnigh tú do láithreacht",
    "Tentative" : "Sealadach",
    "Tentative: your participation is uncertain" : "Sealadach: tá do rannpháirtíocht neamhchinnte",
    "Invited" : "Cuireadh",
    "Invited: you have not yet responded to this invitation" : "Cuireadh: níor fhreagair tú an cuireadh seo go fóill",
    "Declined" : "Diúltaithe",
    "Declined: you declined this event" : "Diúltaithe: dhiúltaigh tú don imeacht seo",
    "All declined" : "Diúltaíodh dóibh uile",
    "All declined: all participants declined" : "Dhiúltaigh gach duine: dhiúltaigh na rannpháirtithe uile",
    "Icons" : "Deilbhíní",
    "Attendees" : "Lucht freastail",
    "This event has one or more attendees" : "Tá duine amháin nó níos mó i láthair ag an ócáid ​​seo",
    "Past events" : "Imeachtaí san am atá thart",
    "Past event" : "Imeacht san am atá thart",
    "Events that have already ended are shown with a more faded background" : "Taispeántar imeachtaí atá críochnaithe cheana féin le cúlra níos céimnithe",
    ...
    "Some calendars are disabled because this file contains {types}." : "Tá roinnt féilirí díchumasaithe mar go bhfuil {types} sa chomhad seo.",
    ...
    "{email} will no longer be able to act on your behalf." : "Ní bheidh {email} in ann gníomhú ar do shon a thuilleadh.",
    "Revoke" : "Chúlghairm",
    "Viewer" : "Amharcóir",
    "Editor" : "eagarthóir",
    "Could not revoke access." : "Níorbh fhéidir rochtain a chúlghairm.",
    "Access revoked successfully." : "Cealaíodh an rochtain go rathúil.",
    "{name} can now view your calendars." : "Is féidir le {name} féachaint ar do fhéilirí anois.",
    "{name} can now act on your behalf." : "Is féidir le {name} gníomhú ar do shon anois.",
    "Could not add delegate." : "Níorbh fhéidir toscaire a chur leis.",
    "Could not load delegates." : "Níorbh fhéidir toscairí a lódáil.",
    "Delegates" : "Toscairí",
    "Allow users to manage your calendar events and invitations on your behalf." : "Lig d’úsáideoirí imeachtaí agus cuireadh do fhéilire a bhainistiú ar do shon.",
    "Loading delegates…" : "Ag lódáil toscairí…",
    "Revoke access" : "Cealaigh rochtain",
    "No delegates yet." : "Gan aon toscairí fós.",
    ...
    "Choose whether they can view and edit events, or only view them." : "Roghnaigh an féidir leo imeachtaí a fheiceáil agus a chur in eagar, nó iad a fheiceáil amháin.",
    "Add as viewer" : "Cuir leis mar amharcóir",
    "Add as editor" : "Cuir leis mar eagarthóir",
    ...
    "Import calendar file" : "Iompórtáil comhad féilire",
    ...
    "Public – shown on profile page" : "Poiblí – le feiceáil ar leathanach próifíle",
    "Private – only accessible via link" : "Príobháideach – inrochtana trí nasc amháin",
    ...
    "Booking calendar" : "Féilire áirithintí",
    "Calendars to check for conflicts" : "Féilirí le seiceáil le haghaidh coinbhleachtaí",
    "Visibility" : "Infheictheacht",
    "Booking availability" : "Infhaighteacht áirithinte",
    "to" : "chun",
    ...
    "Buffer before the event" : "Maolán roimh an imeacht",
    "Buffer after the event" : "Maolán i ndiaidh na hócáide",
    "Minimum time before next slot" : "Íosmhéid ama roimh an gcéad sliotán eile",
    ...
    "Amount" : "Méid",
    "before at" : "roimh ag",
    "Alarm date and time" : "Dáta agus am an aláraim",
    "Notification" : "Fógra",
    "Email" : "Ríomhphost",
    ...
    "Upload files as attachments" : "Uaslódáil comhaid mar cheangaltáin",
    ...
    "Still available" : "Ar fáil fós",
    "Already booked" : "Tá áirithint déanta cheana féin",
    "Checking availability" : "Infhaighteacht a sheiceáil",
    "Will be booked after saving, if available" : "Déanfar áirithint tar éis sábháil, más féidir",
    ...
    "{name} (delegated by {delegator})" : "{name} (tarmligthe ag {delegator})",
    "Duration" : "Fad",
    "15 minutes" : "15 nóiméad",
    "30 minutes" : "30 nóiméad",
    "45 minutes" : "45 nóiméad",
    "1 hour" : "1 uair",
    "1 hour 30 minutes" : "1 uair 30 nóiméad",
    "2 hours" : "2 uair an chloig",
    "Custom" : "Saincheaptha",
    "_{i} day_::_{i} days_" : ["{i} lá","{i} laethanta","{i} laethanta","{i} laethanta","{i} laethanta"],
    "_{i} hour_::_{i} hours_" : ["{i} uair","{i} uair an chloig","{i} uair an chloig","{i} uair an chloig","{i} uair an chloig"],
    "_{i} minute_::_{i} minutes_" : ["{i} nóiméad","{i} nóiméid","{i} nóiméid","{i} nóiméid","{i} nóiméid"],
    "Days" : "Laethanta",
    "Hours" : "Uaireanta",
    "Minutes" : "Nóiméad",
    ...
    "Available time slots" : "Sliotáin ama atá ar fáil",
    ...
    "Accept this occurrence" : "Glac leis an eachtra seo",
    "Accept entire series" : "Glac leis an tsraith iomlán",
    "Accept" : "Glac",
    "Decline this occurrence" : "Diúltaigh don teagmhas seo",
    "Decline entire series" : "Diúltaigh don tsraith ar fad",
    "Decline" : "Meath",
    "Tentative for this occurrence" : "Sealadach don ócáid ​​seo",
    "Tentative for entire series" : "Sealadach don tsraith ar fad",
    ...
    "Send email to {email}" : "Seol ríomhphost chuig {email}",
    ...
    "Status" : "Stádas",
    "Role" : "Ról",
    "Delegated" : "Tarmligthe",
    "Chairperson" : "Cathaoirleach",
    "Required participant" : "Rannpháirtí riachtanach",
    "Optional participant" : "Rannpháirtí roghnach",
    "Non-participant" : "Neamh-rannpháirtí",
    "Attendees copied to clipboard" : "Cóipeáladh na freastalaithe chuig an ghearrthaisce",
    "Failed to copy attendees to clipboard" : "Theip ar na freastalaithe a chóipeáil chuig an ghearrthaisce",
    "Copy attendees to clipboard" : "Cóipeáil freastalaithe chuig an ghearrthaisce",
    ...
    "Search for attendees" : "Cuardaigh freastalaithe",
    "(organizer)" : "(eagraí)",
    ...
    "Set repetition" : "Socraigh athrá",
    "never" : "riamh",
    "on date" : "ar dháta",
    "after" : "tar éis",
    "End repeat" : "Cuir deireadh leis an athuair",
    "End repeat date" : "Dáta deiridh athdhéanamh",
    ...
    "first" : " an chéad",
    "Week occurrence" : "Tarlú seachtainiúil",
    ...
    "Repeat frequency" : "Minicíocht athdhéanta",
    ...
    "Resources" : "Acmhainní",
    "Show rooms" : "Seomraí taispeántais",
    ...
    "Check availability" : "Seiceáil infhaighteacht",
    ...
    "Projector" : "Teilgeoir",
    "Whiteboard" : "Clár bán",
    "_%n seat_::_%n seats_" : ["%n suíochán","%n suíochán","%n suíochán","%n suíochán","%n suíochán"],
    "Unavailable" : "Gan a bheith ar fáil",
    "Room type" : "Cineál seomra",
    "Any" : "Aon",
    "Minimum seating capacity" : "Toilleadh suíocháin íosta",
    "_{available} of %n room available_::_{available} of %n rooms available_" : ["{available} de %n seomra ar fáil","{available} de %n seomraí ar fáil","{available} de %n seomraí ar fáil","{available} de %n seomraí ar fáil","{available} de %n seomraí ar fáil"],
    "Rooms" : "Seomraí",
    "Search rooms" : "Cuardaigh seomraí",
    "Name, building or room number" : "Ainm, uimhir foirgnimh nó seomra",
    "Building" : "Foirgneamh",
    "Floor" : "Urlár",
    "Minimum capacity" : "Íosacmhainn",
    "Features" : "Gnéithe",
    "Checking availability…" : "Ag seiceáil infhaighteachta…",
    "No rooms match the filters" : "Níl aon seomraí a mheaitseálann na scagairí",
    "No rooms found" : "Níor aimsíodh aon seomraí",
    "Clear filters" : "Glan na scagairí",
    "More details" : "Tuilleadh sonraí",
    "Update entire series" : "Nuashonraigh an tsraith ar fad",
    "Update this and future occurrences" : "Déan an ceann seo agus na himeachtaí amach anseo a nuashonrú",
    ...
    "This booking link is no longer valid" : "Níl an nasc áirithinte seo bailí a thuilleadh",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Tá an nasc deimhnithe imithe in éag nó úsáideadh é cheana féin. Téigh i dteagmháil leis an eagraí le hatháirithint a dhéanamh.",
    "Confirm your appointment" : "Deimhnigh do choinne",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Níorbh fhéidir an coinne a dheimhniú. Déan iarracht arís ar ball nó déan teagmháil leis an eagraí.",
    ...
    "Detailed event editor" : "Eagarthóir imeachtaí mionsonraithe",
    "Event does not exist" : "Níl imeacht ann",
    "Delete this occurrence" : "Scrios an teagmhas seo",
    "Delete this and future occurrences" : "Scrios é seo agus na himeachtaí a bheidh ann amach anseo",
    "Delete entire series" : "Scrios an tsraith ar fad",
    ...
    "Create meeting" : "Cruinniú a chruthú",
    ...
    "Notify me when participants respond" : "Cuir in iúl dom nuair a fhreagraíonn rannpháirtithe",
    ...
    "{startDateTime} to {endTime}" : "{startDateTime} go {endTime}",
    "{startDateTime} to {endDateTime}" : "{startDateTime} go {endDateTime}",
    "{title}, All day: {timeDescription}" : "{title}, An lá ar fad: {timeDescription}",
    "{title}, All day" : "{title}, An lá ar fad",
    ...
    "Event link copied to clipboard" : "Nasc imeachta cóipeáilte chuig an ghearrthaisce",
    "Failed to copy event link" : "Theip ar nasc an imeachta a chóipeáil",
    ...
    "Other" : "Eile",
    "Audio-visual equipment" : "Trealamh closamhairc",
    "Phone" : "Fón",
    "Video conferencing" : "Físchomhdháil",
    "TV" : "Teilifís",
    ...
    "This meeting proposal no longer exists" : "Níl an togra cruinnithe seo ann a thuilleadh",
    "Failed to open meeting proposal" : "Theip ar thogra cruinnithe a oscailt",
    ...
    "We noticed that you adjusted the date or time. Since this is not the first occurrence of the series, the date/time changes have been discarded. To change the date or time of the whole series, please edit the first occurrence." : "Thugamar faoi deara gur athraigh tú an dáta nó an t-am. Ós rud é nach í seo an chéad teagmhas sa tsraith, cuireadh na hathruithe ar an dáta nó ar an am ar ceal. Chun dáta nó am na sraithe ar fad a athrú, déan eagarthóireacht ar an gcéad teagmhas, le do thoil.",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Níorbh fhéidir féilirí tarmligthe a luchtú. Cinntigh go dtacaíonn an freastalaí le tarmligean féilire.",
