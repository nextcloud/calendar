OC.L10N.register(
    ...
    "You are about to download a file. Please check the file name before opening it. Are you sure to proceed?" : "Tá tú ar tí comhad a íoslódáil. Seiceáil ainm an chomhaid sula n-osclaíonn tú é. An bhfuil tú cinnte go leanfaidh tú ar aghaidh?",
    ...
    "These public calendars are suggested by the sever administrator. Calendar data will be downloaded from the respective website." : "Molann riarthóir an fhreastalaí na féilirí poiblí seo. Déanfar sonraí féilire a íoslódáil ón suíomh Gréasáin faoi seach.",
    ...
    "The Calendar app is a user interface for Nextcloud's CalDAV server. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Currently Contacts - more to come.\n* 🌐 **WebCal Support!** Want to see your favorite team’s matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events\n* ⌚️ **Free/Busy!** See when your attendees are available to meet\n* ⏰ **Reminders!** Get alarms for events inside your browser and via email\n* 🔍 Search! Find your events at ease\n* ☑️ Tasks! See tasks with a due date directly in the calendar\n* 🙈 **We’re not reinventing the wheel!** Based on the great [c-dav library](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "Is comhéadan úsáideora é an aip Féilire do fhreastalaí CalDAV Nextcloud. Sioncronaigh go héasca imeachtaí ó ghléasanna éagsúla le do Nextcloud agus cuir in eagar iad ar líne.\n\n* 🚀 **Comhtháthú le haipeanna eile Nextcloud!** Teagmhálaithe faoi láthair - tuilleadh le teacht.\n* 🌐 **Tacaíocht WebCal!** Ar mhaith leat laethanta cluichí na foirne is fearr leat a fheiceáil i d’fhéilire? Fadhb ar bith!\n* 🙋 **Freastalaithe!** Tabhair cuireadh do dhaoine teacht chuig d’imeachtaí\n* ⌚️ **Saor/Gnóthach!** Féach nuair a bheidh do lucht freastail ar fáil le bualadh le chéile\n* ⏰ **Meabhrúcháin!** Faigh aláram le haghaidh imeachtaí laistigh de do bhrabhsálaí agus trí ríomhphost\n* 🔍 Cuardach! Aimsigh do chuid imeachtaí ar a suaimhneas\n* ☑️ Tascanna! Féach tascanna le dáta dlite go díreach san fhéilire\n* 🙈 **Nílimid ag athchruthú an rotha!** Bunaithe ar an leabharlann iontach [c-dav]( https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) agus leabharlanna [fullcalendar](https://github.com/fullcalendar/fullcalendar).",
    ...
    "Search for emails, users, contacts or groups" : "Déan cuardach do ríomhphoist, úsáideoirí, teagmhálaithe nó grúpaí",
