OC.L10N.register(
    ...
    "[from] {dateFormat}" : "[dal] {dateFormat}",
    "[to] {dateFormat}" : "[al] {dateFormat}",
    "[on] {dateFormat}" : "[il] {dateFormat}",
    "[from] {dateFormat} [at] {timeFormat}" : "[dal] {dateFormat} [alle] {timeFormat}",
    "[to] {dateFormat} [at] {timeFormat}" : "[al] {dateFormat} [alle] {timeFormat}",
    "[on] {dateFormat} [at] {timeFormat}" : "[il] {dateFormat} [alle] {timeFormat}",
    "{dateFormat} [at] {timeFormat}" : "{dateFormat} [alle] {timeFormat}",
