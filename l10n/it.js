OC.L10N.register(
    ...
    "Select date to navigate to" : "Seleziona la data a cui passare",
    ...
    "Unpublishing calendar failed" : "Rimozione calendario fallita",
    ...
    "Name of calendar" : "Nome del calendario",
    ...
    "Link to iCal" : "Collegamento a iCal",
    ...
    "Import partially failed. Imported {accepted} out of {total}." : "Importazione parzialmente fallita. Importati {accepted} di {total}.",
    ...
    "{name} marked their participation as tentative." : "{name} ha segnato la sua partecipazione come incerta.",
    ...
    "Please select a timezone for the start-date:" : "Seleziona un fuso orario per la data di inizio:",
    "Please select a timezone for the end-date:" : "Seleziona un fuso orario per la data di fine:",
