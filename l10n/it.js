OC.L10N.register(
    ...
    "An error occured during sending email" : "Si è verificato un errore durante l’invio dell’email",
    ...
    "Calendar name can not be blank" : "Il nome del calendario non può essere vuoto",
    ...
    "Default reminder for part-day events" : "Promemoria predefinito per gli eventi di durata parziale",
    "Select default reminder" : "Seleziona il promemoria predefinito",
    "Default reminder for full-day events" : "Promemoria predefinito per gli eventi dell’intera giornata",
    "These reminders will be automatically added to new events created in this calendar" : "Questi promemoria verranno aggiunti automaticamente ai nuovi eventi creati in questo calendario",
    ...
    "View" : "Visualizza",
    "Delete proposal" : "Elimina proposta",
    "Event legend" : "Legenda degli eventi",
    "Calendar events are styled to convey additional information at a glance." : "Gli eventi del calendario sono visualizzati con stili diversi per mostrare informazioni aggiuntive.",
    "Free / Busy" : "Libero / Occupato",
    "Busy" : "Occupato",
    "Busy: your time is marked as occupied" : "Occupato: il tuo tempo risulta non disponibile",
    "Free" : "Libero",
    "Free: your time is still available" : "Libero: il tuo tempo resta disponibile",
    "Participation status" : "Stato di partecipazione",
    "Accepted" : "Accettato",
    "Accepted: you confirmed your attendance" : "Accettato: hai confermato la tua partecipazione",
    "Tentative" : "Provvisorio",
    "Tentative: your participation is uncertain" : "Da confermare: la tua partecipazione non è certa",
    "Invited" : "Invitati",
    "Invited: you have not yet responded to this invitation" : "Invitato: non hai ancora risposto all’invito",
    "Declined" : "Rifiutato",
    "Declined: you declined this event" : "Rifiutato: hai rifiutato l'invito",
    "All declined" : "Tutti hanno rifiutato",
    "All declined: all participants declined" : "Tutti hanno rifiutato: tutti i partecipanti hanno rifiutato l’invito",
    "Icons" : "Icone",
    "Attendees" : "Partecipanti",
    "This event has one or more attendees" : "Questo evento ha uno o più partecipanti",
    "Past events" : "Eventi passati",
    "Past event" : "Evento passato",
    "Events that have already ended are shown with a more faded background" : "Gli eventi già conclusi vengono mostrati con uno sfondo più attenuato",
    ...
    "Public – shown on profile page" : "Pubblico – visibile nella pagina del profilo",
    "Private – only accessible via link" : "Privato – accessibile solo tramite link",
    ...
    "Calendars to check for conflicts" : "Calendari da controllare per evitare sovrapposizioni",
    "Visibility" : "Visibilità",
    "Booking availability" : "Disponibilità per le prenotazioni",
    "to" : "a",
    ...
    "Buffer before the event" : "Tempo di margine prima dell’evento",
    "Buffer after the event" : "Tempo di margine dopo l’evento",
    "Minimum time before next slot" : "Tempo minimo prima del prossimo slot",
    ...
    "on" : "il",
    "at" : "alle",
    "Default reminder of calendar" : "Promemoria predefinito del calendario",
    "Amount" : "Quantità",
    "before at" : "prima di",
    ...
    "_{i} day_::_{i} days_" : ["{i} giorno","{i} giorni","{i} giorni"],
    "_{i} hour_::_{i} hours_" : ["{i} ora","{i} ore","{i} ore"],
    "_{i} minute_::_{i} minutes_" : ["{i} minuto","{i} minuti","{i} minuti"],
    "Days" : "Giorni",
    "Hours" : "Ore",
    "Minutes" : "Minuti",
    ...
    "Send email to {email}" : "Invia email a {email}",
    ...
    "Optional participant" : "Partecipante facoltativo",
    "Non-participant" : "Non partecipante",
    "Attendees copied to clipboard" : "Partecipanti copiati negli appunti",
    "Failed to copy attendees to clipboard" : "Non è stato possibile copiare i partecipanti negli appunti",
    "Copy attendees to clipboard" : "Copia partecipanti negli appunti",
    ...
    "Set repetition" : "Imposta ricorrenza",
    "never" : "mai",
    "on date" : "in data",
    "after" : "dopo",
    ...
    "Contact your server administrator to resolve this issue." : "Contatta l’amministratore del server per risolvere il problema.",
    ...
    "This booking link is no longer valid" : "Questo link di prenotazione non è più valido",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Il link di conferma è scaduto oppure è già stato utilizzato. Contatta l’organizzatore per effettuare una nuova prenotazione.",
    "Confirm your appointment" : "Conferma il tuo appuntamento",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Non è stato possibile confermare l’appuntamento. Riprova più tardi oppure contatta l’organizzatore.",
    ...
    "Allow forwarding" : "Consenti l’inoltro",
    "Anyone with the invitation can respond" : "Chiunque abbia l’invito può rispondere",
    "Only invited attendees can respond" : "Solo i partecipanti possono rispondere",
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Scegli “Solo i partecipanti possono rispondere” per impedire che l’invito venga inoltrato ad altre persone.",
    ...
    "Event link copied to clipboard" : "Link dell’evento copiato negli appunti",
    "Failed to copy event link" : "Non è stato possibile copiare il link dell’evento",
