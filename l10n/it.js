OC.L10N.register(
    ...
    "CalDAV address for clients" : "Indirizzo CalDAV per i clients",
    "Error saving WebCal-calendar" : "Errore durante il salvataggio del calendario WebCal",
    "WebDAV address for subscriptions" : "Indirizzo WebDAV per la sottoscrizione",
    "EMail has been sent." : "L'email è stata inviata.",
    "There was an issue while sending your EMail." : "C'è stato un problema durante l'invio della tua email.",
    "Details" : "Dettagli",
    ...
    "Click here to access it" : "Clicca qui per accedere",
    "Cheers!" : "Evviva!",
    "We wanted to inform you that %s has published the calendar %s." : "Ti vogliamo informare che %s ha pubblicato il calendario %s.",
    "Click on the link below to access it" : "Clicca il link sotto per accedere",
    ...
    "Email link to person" : "Invia il link alla persona tramite email",
    "Send" : "Invia",
    ...
    "Add" : "Aggiungi",
    "E-Mail address of attendee" : "Indirizzo email del partecipante",
    ...
    "Iframe to integrate" : "Iframe per integrare",
