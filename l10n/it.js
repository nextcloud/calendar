OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Il tuo appuntamento \"%s\" richiede una conferma",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Se tuttavia desideri disdire l'appuntamento, contatta l'organizzatore.",
    ...
    "New calendar" : "Nuovo calendario",
    "Name for new calendar" : "Nome per il nuovo calendario",
    ...
    "_Successfully imported %n event_::_Successfully imported %n events_" : ["%n evento importato con successo","%n evento importato con successo"],
    ...
    "_{duration} minute_::_{duration} minutes_" : ["{duration} minuto","{duration} minuti"],
    "0 minutes" : "0 minuti",
    "_{duration} hour_::_{duration} hours_" : ["{duration} ora","{duration} ore"],
    "_{duration} day_::_{duration} days_" : ["{duration} giorno","{duration} giorni"],
    "_{duration} week_::_{duration} weeks_" : ["{duration} settimana","{duration} settimane"],
    "_{duration} month_::_{duration} months_" : ["{duration} mese","{duration} mesi"],
    "_{duration} year_::_{duration} years_" : ["{duration} anno","{duration} anni"],
    ...
    "No times set" : "Nessun'ora impostata",
    "Add" : "Aggiungi",
    "Monday" : "Lunedì",
    "Tuesday" : "Martedì",
    "Wednesday" : "Mercoledì",
    ...
    "Limit how far in the future appointments can be booked" : "Limita fino a che punto è possibile prenotare appuntamenti futuri",
    ...
    "Book the appointment" : "Prenota l'appuntamento",
    "Reminder" : "Promemoria",
    "before at" : "prima di",
    ...
    "Checking availability." : "Controllo disponibilità.",
    ...
    "Invitation is delegated." : "L'invito è delegato.",
    "Participation marked as tentative." : "Partecipazione segnata come probabile.",
    ...
    "Search for emails, users or contacts" : "Cerca email, utenti o contatti",
    ...
    "_{seatingCapacity} seat_::_{seatingCapacity} seats_" : ["{seatingCapacity} sedia","{seatingCapacity} sedie"],
    "Available" : "Disponibile",
