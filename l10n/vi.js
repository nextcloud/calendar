OC.L10N.register(
    ...
    "The Calendar app is a user interface for Nextcloud's CalDAV server. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Currently Contacts - more to come.\n* 🌐 **WebCal Support!** Want to see your favorite team’s matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events\n* ⌚️ **Free/Busy:** See when your attendees are available to meet\n* ⏰ **Reminders!** Get alarms for events inside your browser and via email.\n* 🙈 **We’re not reinventing the wheel!** Based on the great [c-dav library](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "Ứng dụng Lịch Nextcloud một ứng dụng tương tác cho người dùng dành cho máy chủ CardDAV của Nextcloud. Dễ dàng đồng bộ sự kiện từ đa dạng các thiết bị với Nextcloud của bạn và sửa đổi chúng trực tuyến.\n\n* 🚀 **Tương tác với các ứng dụng Nextcloud khác!** Ứng dụng Thư và Lịch hiện hành - Và nhiều hơn nữa sẽ ra mắt.\n\n* 🌐 **Hỗ trợ Webcal!** Muốn xem lịch thi đấu của đội ưa thích của bạn? không vấn đề\n\n* 🙋**Người tham gia!** mời mọi người vào các sự kiện của bạn\n\n* ⌚️ **Rãnh/Bận** Xem khi nào những người tham dự có ngày trống để gặp gỡ \n\n* ⏰**Lịch nhắc hẹn** Nhận các báo thức cho các sự kiện bên trong trình duyệt và thông qua email.\n\n* 🙈 ** Chúng tôi không tạo ra những thay đổi khác lạ!** Chỉ dựa trên sự tuyệt vời và nguồn mở của [thư viện C-DAV](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) và các thư viện [fullcalendar](https://github.com/fullcalendar/fullcalendar).",
    ...
    "Attendees, Resources and Rooms" : "Người tham gia, các nguồn lực và phòng",
    ...
    "Search for e-mails, users, contacts, resources or rooms" : "Tìm kiếm cho email, người dùng, liên hệ, nguồn lực hoặc phòng ốc",
    ...
    "All day" : "Cả ngày",
    "Can not modify all-day setting for events that are part of a recurrence-set." : "Không thể chỉnh sửa thiết lập cho cả-ngày dành cho các sự kiện có một phần là của sự kiện lặp lại",
    ...
    "after" : "sau khi",
    "_time_::_times_" : ["lần"],
    "This event is the recurrence-exception of a recurrence-set. You can not add a recurrence-rule to it." : "Sự kiện này là một sự kiện không có trong chũi sự kiện lặp lại. bạn không thể thêm vào một luật lệ lặp lại cho nó. ",
    "first" : "đầu tiên",
    "third" : "vị trí thứ ba",
    ...
    "Summary" : "tóm tắt",
    "The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost." : "Định nghĩa về định kỳ của sự kiện này không hoàn toàn được hỗ trợ bởi Nextcloud. Nếu bạn sửa các lựa chọn định kỳ này, một vài định kỳ có thể sẽ bị mất ",
    "More" : "hơn",
    "Save" : "Lưu",
    "Update" : "Cập nhật",
    ...
    "Type to search timezone" : "Nhập để tìm kiếm múi giờ",
    "Personal" : "Cá nhân",
