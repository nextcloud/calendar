OC.L10N.register(
    ...
    "An error occurred during sending email" : "Ocorreu um erro ao enviar o e-mail",
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "%1$s respondeu à sua proposta de reunião “%2$s”",
    "{participant} responded to your meeting proposal {proposal}" : "{participant} respondeu à sua proposta de reunião {proposal}",
    ...
    "Delegated to you by" : "Delegado a você por",
    ...
    "Disable alarm notifications for this calendar" : "Desativar notificações de alarme para este calendário",
    ...
    "Default reminder for full-day events" : "Lembrete padrão para eventos de dia inteiro",
    ...
    "Busy" : "Ocupado",
    "Busy: your time is marked as occupied" : "Ocupado: seu horário está marcado como ocupado",
    "Free" : "Livre",
    "Free: your time is still available" : "Livre: você ainda tem tempo disponível",
    "Participation status" : "Status de participação",
    "Accepted" : "Aceito",
    "Accepted: you confirmed your attendance" : "Aceito: você confirmou sua presença",
    "Tentative" : "Tentativa",
    "Tentative: your participation is uncertain" : "Tentativa: sua participação ainda é incerta",
    "Invited" : "Convidado",
    ...
    "This event has one or more attendees" : "Este evento tem um ou mais participantes",
    "Past events" : "Eventos passados",
    "Past event" : "Evento passado",
    ...
    "{name} can now act on your behalf." : "{name} agora pode agir em seu nome.",
    ...
    "Delegates" : "Delegados",
    "Allow users to manage your calendar events and invitations on your behalf." : "Permita que os usuários gerenciem seus eventos de calendário e convites em seu nome.",
    "Loading delegates…" : "Carregando delegados…",
    "Revoke access" : "Revogar acesso",
    "No delegates yet." : "Ainda sem delegados.",
    "Add delegate" : "Adicionar delegado",
    "Revoke access?" : "Revogar acesso?",
    "Search for a user…" : "Pesquisar um usuário…",
    "No users found" : "Nenhum usuário encontrado",
    "Choose whether they can view and edit events, or only view them." : "Escolha se eles podem visualizar e editar eventos, ou apenas visualizá-los.",
    ...
    "Show declined appointments" : "Exibir compromissos recusados",
    ...
    "Calendars to check for conflicts" : "Calendários para verificar se há conflitos",
    ...
    "Minimum time before next slot" : "Tempo mínimo até o próximo horário disponível",
    ...
    "Proceed" : "Prosseguir",
    "Upload files as attachments" : "Enviar arquivos como anexos",
    ...
    "Still available" : "Ainda disponível",
    "Already booked" : "Já reservado",
    "Checking availability" : "Verificando disponibilidade",
    "Will be booked after saving, if available" : "Será agendado após o salvamento, se houver disponibilidade",
    ...
    "_{i} day_::_{i} days_" : ["{i} dia","{i} de dias","{i} dias"],
    "_{i} hour_::_{i} hours_" : ["{i} hora","{i} de horas","{i} horas"],
    "_{i} minute_::_{i} minutes_" : ["{i} minuto","{i} de minutos","{i} minutos"],
    "Days" : "Dias",
    "Hours" : "Horas",
    "Minutes" : "Minutos",
    ...
    "Accept this occurrence" : "Aceitar esta ocorrência",
    "Accept entire series" : "Aceitar a series inteira",
    "Accept" : "Aceitar",
    "Decline this occurrence" : "Recusar esta ocorrência",
    "Decline entire series" : "Recusar a series inteira",
    "Decline" : "Recusar",
    "Tentative for this occurrence" : "Aceitar tentativamente esta ocorrência",
    "Tentative for entire series" : "Aceitar tentativamente a series inteira",
    ...
    "Optional participant" : "Participante opcional",
    "Non-participant" : "Não participante",
    "Attendees copied to clipboard" : "Participantes copiados para a área de transferência",
    "Failed to copy attendees to clipboard" : "Falha ao copiar os participantes para a área de transferência",
    "Send email to all attendees" : "Enviar e-mail para todos os participantes",
    ...
    "first" : "primeiro",
    "Week occurrence" : "Ocorrência semanal",
    ...
    "Repeat frequency" : "Frequência de repetição",
    ...
    "Search for resources" : "Pesquisar recursos",
    "Projector" : "Projetor",
    "Whiteboard" : "Quadro branco",
    "_%n seat_::_%n seats_" : ["%n assento","%n de assentos","%n assentos"],
    "Unavailable" : "Indisponível",
    "Room type" : "Tipo de sala",
    "Any" : "Qualquer",
    "Minimum seating capacity" : "Capacidade mínima de assentos",
    "_{available} of %n room available_::_{available} of %n rooms available_" : ["{available} de %n sala disponível","{available} de %n de salas disponíveis","{available} de %n salas disponíveis"],
    "Rooms" : "Salas",
    "Search rooms" : "Pesquisar salas",
    "Name, building or room number" : "Nome, edifício ou número da sala",
    "Building" : "Edifício",
    "Floor" : "Andar",
    "Minimum capacity" : "Capacidade mínima",
    "Features" : "Caraterísticas",
    "Checking availability…" : "Verificando a disponibilidade…",
    "No rooms match the filters" : "Nenhuma sala corresponde aos filtros",
    "No rooms found" : "Nenhuma sala encontrada",
    "Clear filters" : "Limpar filtros",
    "More details" : "Mais detalhes",
    "Update entire series" : "Atualizar a series inteira",
    "Update this and future occurrences" : "Atualizar esta e as ocorrências futuras",
    ...
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Não foi possível confirmar o compromisso. Tente novamente mais tarde ou entre em contato com o organizador.",
    ...
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Selecione \"Somente os participantes convidados podem responder\" para impedir que os participantes encaminhem o convite a outras pessoas.",
    "Detailed event editor" : "Editor detalhado de eventos",
    "Event does not exist" : "O evento não existe",
    "Delete this occurrence" : "Excluir esta ocorrência",
    "Delete this and future occurrences" : "Excluir esta e as ocorrências futuras",
    "Delete entire series" : "Excluir a series inteira",
    "All day" : "Dia inteiro",
    ...
    "Notify me when participants respond" : "Notificar-me quando os participantes responderem",
    ...
    "{time} before the event starts" : "{time} antes do início do evento",
    "{time} before the event ends" : "{time} antes do fim do evento",
    ...
    "{startDateTime} to {endTime}" : "das {startDateTime} às {endTime}",
    "{startDateTime} to {endDateTime}" : "de {startDateTime} até {endDateTime}",
    ...
    "Failed to copy event link" : "Não foi possível copiar o link do evento",
    ...
    "Other" : "Outro",
    "Audio-visual equipment" : "Equipamentos audiovisuais",
    "Phone" : "Telefone",
    ...
    "This meeting proposal no longer exists" : "Essa proposta de reunião não existe mais",
    "Failed to open meeting proposal" : "Falha ao abrir a proposta de reunião",
    ...
    "We noticed that you adjusted the date or time. Since this is not the first occurrence of the series, the date/time changes have been discarded. To change the date or time of the whole series, please edit the first occurrence." : "Percebemos que você alterou a data ou a hora. Como esta não é a primeira ocorrência da série, as alterações de data e hora foram descartadas. Para alterar a data ou a hora de toda a série, edite a primeira ocorrência.",
