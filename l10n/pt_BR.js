OC.L10N.register(
    ...
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Criar reunião para \"{date}\"? Isso irá criar um evento no calendário de todos os participantes.",
    ...
    "More days" : "Mais dias",
    "Loading meetings proposal" : "Carregando mais propostas de reuniões",
    "No meetings proposal found" : "Nenhuma proposta de reunião encontrada",
    "Please wait while we load the meeting proposal." : "Por favor aguarde enquanto carregamos a proposta da reunião",
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "O link que você estou pode estar quebrado, ou a proposta para a reunião pode não mais existir.",
