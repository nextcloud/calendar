OC.L10N.register(
    ...
    "CalDAV address for clients" : "Endereço CalDAV para clients",
    ...
    "Hello," : "Ola,",
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Gostaríamos de avisa-lo que %s publicou um calendário {boldstart}%s{boldend}",
    "Click here to access it" : "Clique aqui para acessar",
    "Cheers!" : "Saúde!",
    "We wanted to inform you that %s has published the calendar %s." : "Gostaríamos de avisa-lo que %s publicou um calendário %s.",
