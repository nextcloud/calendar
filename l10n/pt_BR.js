OC.L10N.register(
    ...
    "There was an issue while sending your EMail." : "Houve um erro ao enviar o E-mail",
    "group" : "grupo",
    "Details" : "Detalhes",
    ...
    "Severe error in webcal proxy. Please contact administrator for more information." : "Erro severo no proxy webcam. Favor contate o administrador para mais informações",
    ...
    "Export" : "Exportar",
    "%s has published the calendar %s" : "%s foi publicado no calendário%s",
    "Hello," : "Olá,",
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Gostaríamos de avisá-lo que %s publicou um calendário {boldstart}%s{boldend}",
    "Click here to access it" : "Clique aqui para acessar",
    "Cheers!" : "Saúde!",
    "We wanted to inform you that %s has published the calendar %s." : "Gostaríamos de avisá-lo que %s publicou um calendário %s.",
    "Click on the link below to access it" : "Clique no link abaixo para acessar",
    "Due to an upstream bug, the calendar is currently not able to provide support for the asset pipeline feature." : "Devido a um bug, o calendário não é atualmente capaz de fornecer suporte para o recurso de pipeline ativo.",
    "Please contact your administrator and ask them to disable the \"asset-pipeline.enabled\" config option." : "Por favor entre em contato com o administrador e solicite a desativação da opção de configuração \"asset-pipeline.enabled\".",
    "Day" : "Dia",
    "Week" : "Semana",
    "Month" : "Mês",
    "Today" : "Hoje",
    ...
    "Email link to person" : "Link via E-mail para pessoa",
    "Send" : "Enviar",
    ...
    "New calendar" : "Novo calendário",
    "File is empty" : "Arquivo em branco",
    "Import scheduled" : "Importar agendados",
    "Subscribe & embed" : "Subscrever & incorporar",
