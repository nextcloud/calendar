OC.L10N.register(
    ...
    "Add holiday calendar" : "Adicionar calendário de feriados",
    ...
    "Global" : "Global",
    "Holiday calendars" : "Calendários de feriados",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Os calendários de feriados são fornecidos pelo Thunderbird. Os dados do calendário serão baixados de {website}",
    "By {authors}" : "Por {authors}",
    "Subscribed" : "Inscrita",
    "Subscribe" : "Se inscrever",
    "Holidays in {region}" : "Feriados em {region}",
    "An error occurred, unable to create the holiday calendar." : "Ocorreu um erro, não foi possível criar o calendário de feriados.",
