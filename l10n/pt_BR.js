OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Seu compromisso \"1%s\" precisa de confirmação",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Se você deseja cancelar o compromisso, por favor, entre em contato com o seu organizador.",
    ...
    "_Successfully imported %n event_::_Successfully imported %n events_" : ["Importado com sucesso %n evento","Importados com sucesso %n eventos"],
    ...
    "_{duration} day_::_{duration} days_" : ["{duration} dia","{duration} dias"],
    "_{duration} week_::_{duration} weeks_" : ["{duration} semana","{duration} semanas"],
    "_{duration} month_::_{duration} months_" : ["{duration} mês","{duration} meses"],
    ...
    "Save" : "Salvar",
    "Update" : "Atualizar",
    "Your appointment is booked" : "Seu compromisso está agendado",
