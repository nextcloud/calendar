OC.L10N.register(
    ...
    "{display_name} ({email}) booked the appointment \"{config_display_name}\" on {date_time}." : "{display_name} ({email}) marcou o agendamento \"{config_display_name}\" em {date_time}.",
    "Appointments" : "Agendamentos",
    "Schedule appointment \"%s\"" : "Marcar agendamento \"%s\"",
    "Schedule an appointment" : "Marcar agendamento",
    "%1$s - %2$s" : "%1$s - %2$s",
    ...
    "Confirm" : "Confirmar",
    "Appointment with:" : "Agendamento com:",
    "Description:" : "Descrição:",
    "This confirmation link expires in %s hours." : "Este link de confirmação expirará em %s horas.",
    "If you wish to cancel the appointment after all, please contact your organizer by replying to this email or by visiting their profile page." : "Se quiser cancelar o agendamento, entre em contato com o organizador respondendo a este e-mail ou visitando a página de perfil dele.",
    "Your appointment \"%s\" with %s has been accepted" : "Seu agendamento \"%s\" com %s foi aceito",
    "Dear %s, your booking has been accepted." : "Olá %s, sua reserva foi aceito.",
    ...
    "Never show me as busy (set this calendar to transparent)" : "Nunca me mostrar como ocupado (definir esse calendário como transparente)",
    ...
    "Successfully added Talk conversation link to location." : "Adicionado com sucesso o link da conversa do Talk ao local.",
    ...
    "You are about to download a file. Please check the file name before opening it. Are you sure to proceed?" : "Você está prestes a fazer o download de um arquivo. Verifique o nome do arquivo antes de abri-lo. Tem certeza de que pode prosseguir?",
    ...
    "Participation marked as tentative" : "Participação marcada como provisoriamente",
    ...
    "The invitation has been declined successfully." : "O convite foi recusado com successo.",
    ...
    "Please book a different slot:" : "Reserve uma vaga diferente:",
    ...
    "Your participation is tentative" : "Sua participação é provisória",
