OC.L10N.register(
    ...
    "Audio alarm {time} before the event starts" : "イベントが始まる前にオーディオアラーム{時間}",
    "Pop-up {time} before the event starts" : "イベント開始前に{time}ポップアップ",
    "Email {time} before the event starts" : "イベントが開始される前に{time}までメールしてください",
    "None {time} before the event starts" : "イベントが開始される前に{時間}はありません",
    "{type} {time} before the event starts" : "イベント開始の{type} {time} 前",
    "Audio alarm {time} before the event ends" : "イベントが終了する前にオーディオアラーム{時間}",
    "Pop-up {time} before the event ends" : "イベントが終了する前に{time}ポップアップ",
    "Email {time} before the event ends" : "イベントが終了する前にメール{時間}",
    "None {time} before the event ends" : "イベントが終了する前に{時間}はありません",
    "{type} {time} before the event ends" : "イベント終了の{type} {time} 前",
    "Audio alarm {time} after the event starts" : "イベント開始後のオーディオアラーム{時間}",
    "Pop-up {time} after the event starts" : "イベント開始後のポップアップ{time}",
    "Email {time} after the event starts" : "イベントが開始された後にメール{時間}",
    "None {time} after the event starts" : "イベント開始後は{時間}なし",
    "{type} {time} after the event starts" : "イベント開始の{type} {time} 後",
    "Audio alarm {time} after the event ends" : "イベント終了後のオーディオアラーム{時間}",
    "Pop-up {time} after the event ends" : "イベント終了後のポップアップ{time}",
    "Email {time} after the event ends" : "イベントが終了した後にメール{時間}",
    "None {time} after the event ends" : "イベントが終了した後は{時間}はありません",
