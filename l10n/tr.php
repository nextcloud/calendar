...
"Dec." => "Ara.",
"All day" => "Tüm gün",
"New CalendarManager" => "Yeni Takvim",
...
"Share CalendarManager" => "Takvimi paylaş",
"Download" => "İndir",
"Edit" => "Düzenle",
"Delete" => "Sil",
...
"Active" => "Aktif",
"CalendarManager color" => "Takvim rengi",
"Save" => "Kaydet",
"Submit" => "Gönder",
"Cancel" => "İptal",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Bu isimde bir takvim zaten mevcut. Yine de devam ederseniz bu takvimler birleştirilecektir.",
...
"URLs" => "URL'ler",
"CalendarManager CalDAV syncing addresses" => "CalDAV takvimi adresleri senkronize ediyor.",
