OC.L10N.register(
    ...
    "Add holiday calendar" : "Dodaj kalendarz świąt",
    ...
    "Attachments folder successfully saved." : "Zapisano katalog załączników.",
    ...
    "No recurrence" : "Brak powtarzalności",
    ...
    "Global" : "Globalnie",
    "Holiday calendars" : "Kalendarz świąt",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Kalendarze świąt są dostarczane przez Thunderbird. Dane kalendarza zostaną pobrane z {website}",
    "By {authors}" : "Autorstwa {authors}",
    "Subscribed" : "Zasubskrybowano",
    "Subscribe" : "Subskrybuj",
    "Holidays in {region}" : "Święta w {region}",
    "An error occurred, unable to create the holiday calendar." : "Wystąpił błąd, nie można utworzyć kalendarza świąt.",
