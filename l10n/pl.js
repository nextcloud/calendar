OC.L10N.register(
    ...
    "An error occured during sending email" : "Wystąpił błąd podczas wysyłania wiadomości e-mail",
    ...
    "Calendar name can not be blank" : "Nazwa kalendarza nie może być pusta",
    ...
    "Default reminder for part-day events" : "Domyślne przypomnienie dla wydarzeń częściowo całodniowych",
    "Select default reminder" : "Wybierz domyślne przypomnienie",
    "Default reminder for full-day events" : "Domyślne przypomnienie dla wydarzeń całodniowych",
    "These reminders will be automatically added to new events created in this calendar" : "Te przypomnienia będą automatycznie dodawane do nowych wydarzeń utworzonych w tym kalendarzu",
    ...
    "View" : "Podgląd",
    "Delete proposal" : "Usuń propozycję",
    "Event legend" : "Legenda wydarzeń",
    "Calendar events are styled to convey additional information at a glance." : "Wydarzenia w kalendarzu są stylizowane tak, aby przekazywać dodatkowe informacje na pierwszy rzut oka",
    "Free / Busy" : "Wolny / Zajęty",
    "Busy" : "Brak dostępności",
    "Busy: your time is marked as occupied" : "Zajęty: Twój czas jest oznaczony jako zajęty",
    "Free" : "Dostępność",
    "Free: your time is still available" : "Wolny: Twój czas jest nadal dostępny",
    "Participation status" : "Status uczestnictwa",
    "Accepted" : "Zaakceptowano",
    "Accepted: you confirmed your attendance" : "Zaakceptowano: potwierdziłeś/aś swój udział",
    "Tentative" : "Niepewne",
    "Tentative: your participation is uncertain" : "Wstępnie zaakceptowano: Twój udział jest niepewny",
    "Invited" : "Zaproszeni",
    "Invited: you have not yet responded to this invitation" : "Zaproszony: jeszcze nie odpowiedziałeś/aś na to zaproszenie",
    "Declined" : "Odrzucono",
    "Declined: you declined this event" : "Odrzucono: odrzuciłeś/aś to wydarzenie",
    "All declined" : "Wszyscy odrzucili",
    "All declined: all participants declined" : "Wszyscy odrzucili: wszyscy uczestnicy odrzucili wydarzenie",
    "Icons" : "Ikony",
    "Attendees" : "Uczestnicy",
    "This event has one or more attendees" : "To wydarzenie ma jednego lub więcej uczestników",
    "Past events" : "Minione wydarzenia",
    "Past event" : "Minione wydarzenie",
    "Events that have already ended are shown with a more faded background" : "Wydarzenia, które już się zakończyły, są wyświetlane z bardziej wyblakłym tłem",
    "Import destination selection" : "Wybór miejsca importu",
    ...
    "Public – shown on profile page" : "Publiczne — widoczne na stronie profilu",
    "Private – only accessible via link" : "Prywatne — dostępne tylko przez link",
    ...
    "Calendars to check for conflicts" : "Kalendarze sprawdzane pod kątem konfliktów",
    "Visibility" : "Widoczne",
    "Booking availability" : "Dostępność rezerwacji",
    "to" : "do",
    ...
    "Buffer before the event" : "Bufor przed wydarzeniem",
    "Buffer after the event" : "Bufor po wydarzeniu",
    "Minimum time before next slot" : "Minimalny czas przed następnym terminem",
    ...
    "on" : "o",
    "at" : "o",
    "Default reminder of calendar" : "Domyślne przypomnienie kalendarza",
    "Amount" : "Ilość",
    "before at" : "przed",
    ...
    "45 minutes" : "45 minut",
    "1 hour" : "1 godzina",
    "1 hour 30 minutes" : "1 godzina 30 minut",
    "2 hours" : "2 godziny",
    "Custom" : "Dowolnie",
    "_{i} day_::_{i} days_" : ["{i} dzień","{i} dni","{i} dni","{i} dni"],
    "_{i} hour_::_{i} hours_" : ["{i} godzina"," {i} godzin"," {i} godzin","{i} godziny"],
    "_{i} minute_::_{i} minutes_" : ["{i} minuta"," {i} minut"," {i} minut","{i} minuty"],
    "Days" : "Dni",
    "Hours" : "Godzin",
    "Minutes" : "Minuty",
    ...
    "Send email to {email}" : "Wyślij e-mail do {email}",
    ...
    "Attendees copied to clipboard" : "Uczestnicy skopiowani do schowka",
    "Failed to copy attendees to clipboard" : "Nie udało się skopiować uczestników do schowka",
    "Copy attendees to clipboard" : "Skopiuj uczestników do schowka",
    ...
    "Set repetition" : "Ustaw powtarzanie",
    "never" : "nigdy",
    "on date" : "o czasie",
    "after" : "po",
    ...
    "Public calendar subscriptions selection" : "Wybór publicznych subskrypcji kalendarza",
    ...
    "Contact your server administrator to resolve this issue." : "Skontaktuj się z administratorem serwera, aby rozwiązać ten problem",
    ...
    "This booking link is no longer valid" : "Ten link rezerwacji nie jest już ważny",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Link potwierdzający wygasł lub został już użyty. Skontaktuj się z organizatorem, aby zarezerwować ponownie.",
    "Confirm your appointment" : "Potwierdź swoje spotkanie",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Nie udało się potwierdzić spotkania. Spróbuj ponownie później lub skontaktuj się z organizatorem.",
    ...
    "Allow forwarding" : "Zezwól na przekazywanie dalej",
    "Anyone with the invitation can respond" : "Każdy, kto ma zaproszenie, może odpowiedzieć",
    "Only invited attendees can respond" : "Tylko zaproszeni uczestnicy mogą odpowiadać",
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Wybierz \"Tylko zaproszeni uczestnicy mogą odpowiadać\", aby uniemożliwić uczestnikom przekazywanie zaproszenia innym osobom.",
    ...
    "Event link copied to clipboard" : "Link do wydarzenia skopiowany do schowka",
    "Failed to copy event link" : "Nie udało się skopiować linku do wydarzenia",
    ...
    "Duration suggestions" : "Sugestie czasu trwania",
