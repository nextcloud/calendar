OC.L10N.register(
    ...
    "EMail has been sent." : "Email został wysłany.",
    ...
    "Pop-up" : "Pop-up",
    "E-Mail" : "E-mail",
    "{type} {time} before the event starts" : "{type} {time} przed rozpoczęciem zdarzenia",
    "{type} {time} before the event ends" : "{type} {time} przed zakończeniem zdarzenia",
    "{type} {time} after the event starts" : "{type} {time} po rozpoczęciu zdarzenia",
    "{type} {time} after the event ends" : "{type} {time} po zakończeniu zdarzenia",
    ...
    "%s has published the calendar %s" : "%s opublikował kalendarz %s",
    "Hello," : "Witaj,",
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Chcieliśmy poinformować, że %s opublikował kalendarz {boldstart}%s{boldend}.",
    ...
    "Click on the link below to access it" : "Kliknij na link poniżej, aby uzyskać dostęp do niego",
