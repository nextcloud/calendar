OC.L10N.register(
    ...
    "Email {time} before the event starts" : "Email az esemény kezdete előtt ennyivel: {time}",
    ...
    "Email {time} before the event ends" : "Email az esemény vége előtt ennyivel: {time}",
    ...
    "Email {time} after the event starts" : "Email az esemény kezdete után ennyivel: {time}",
    ...
    "Email {time} after the event ends" : "Email az esemény vége után ennyivel: {time}",
    ...
    "Email at the event's start" : "Email az esemény kezdetekor",
    ...
    "Email at the event's end" : "Email az esemény végén",
    ...
    "Email at {time}" : "Email ekkor: {time}",
    ...
    "Email reminders have not been implemented in the CalDAV server yet, hence no email reminders will be send." : "Az email emlékeztetők még nincsenek implementálva a CalDAV szerverbe, ezért email emlékeztetők nem lesznek küldve.",
    "Add" : "Hozzáadás",
