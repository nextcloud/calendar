OC.L10N.register(
    ...
    "Add holiday calendar" : "Ünnepnapok naptárának hozzáadása",
    ...
    "Global" : "Globális",
    "Holiday calendars" : "Ünnepnapok naptára",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Az ünnepnapok naptárát a Thunderbird biztosítja. A naptáradatok innen lesznek letöltve: {website}.",
    "By {authors}" : "Szerzők: {authors}",
    "Subscribed" : "Feliratkozott",
    "Subscribe" : "Feliratkozás",
    "Holidays in {region}" : "Ünnepnapok itt: {region}",
    "An error occurred, unable to create the holiday calendar." : "Hiba történt, nem hozható létre az ünnepnapok naptára.",
