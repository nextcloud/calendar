OC.L10N.register(
    ...
    "Unexpected error sending email. Please contact your administrator." : "Unerwarteter Fehler beim Senden der E-Mail. Bitte wende Dich an den Administrator.",
    ...
    "To send out invitations and handle responses,  [linkopen]add your email address in personal settings[linkclose]." : "Um Einladungen zu versenden und Antworten zu verarbeiten, [linkopen]gebe Deine E-Mailadress in den persönlichen Einstellungen ein[linkclose].",
    ...
    "_%n day before the event at {formattedHourMinute}_::_%n days before the event at {formattedHourMinute}_" : ["%n Tag vor dem Start des Ereignisses um {formattedHourMinute}","%n Tage vor dem Start des Termins um {formattedHourMinute}"],
    "_%n week before the event at {formattedHourMinute}_::_%n weeks before the event at {formattedHourMinute}_" : ["%n Woche vor dem Start des Ereignisses um {formattedHourMinute}","%n Wochen vor dem Start des Termins um {formattedHourMinute}"],
