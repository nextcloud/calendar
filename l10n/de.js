OC.L10N.register(
    ...
    "A Calendar app for Nextcloud. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Like Contacts, Talk, Tasks, Deck and Circles\n* 🌐 **WebCal Support!** Want to see your favorite team's matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events\n* ⌚ **Free/Busy!** See when your attendees are available to meet\n* ⏰ **Reminders!** Get alarms for events inside your browser and via email\n* 🔍 **Search!** Find your events at ease\n* ☑️ **Tasks!** See tasks or Deck cards with a due date directly in the calendar\n* 🔈 **Talk rooms!** Create an associated Talk room when booking a meeting with just one click\n* 📆 **Appointment booking** Send people a link so they can book an appointment with you [using this app](https://apps.nextcloud.com/apps/appointments)\n* 📎 **Attachments!** Add, upload and view event attachments\n* 🙈 **We’re not reinventing the wheel!** Based on the great [c-dav library](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "Eine Kalender-App für Nextcloud. Termine von verschiedenen Geräten ganz einfach mit deiner Nextcloud synchronisieren und online bearbeiten.* 🚀 **Integration mit anderen Nextcloud-Apps!** Wie Kontakte, Talk, Aufgaben, Deck und Kreise* 🌐 **WebCal-Unterstützung!** Sollen die Spieltage deiner Lieblingsmannschaft in deinem Kalender stehen? Kein Problem!* 🙋 **Teilnehmer!** Lade Personen zu deinen Veranstaltungen ein.* ⌚ **Frei/Beschäftigt!** Sieh nach, wann deine Teilnehmer verfügbar sind.* ⏰ **Erinnerungen!** Erhalte Benachrichtigungen für Veranstaltungen direkt im Browser und per E-Mail.* 🔍 **Suche!** Finde deine Veranstaltungen ganz einfach.* ☑️ **Aufgaben!** Sehe Aufgaben oder Karten mit Fälligkeitsdatum direkt im Kalender.* 🔈 **Chatrooms!** Erstelle beim Buchen eines Meetings mit nur einem Klick einen zugehörigen Chatroom.* 📆 **Terminbuchung** Sende Personen einen Link, damit sie [mit dieser App](https://apps.nextcloud.com/apps/appointments) einen Termin mit dir buchen können.* 📎 **Anhänge!** Füge Veranstaltungsanhänge hinzu, lade sie hoch und sieh sie ein.* 🙈 **Wir erfinden das Rad nicht neu!** Basierend auf den großartigen [c-dav Bibliothek](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) und [fullcalendar](https://github.com/fullcalendar/fullcalendar) Bibliotheken.",
