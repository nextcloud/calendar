OC.L10N.register(
    ...
    "An error occurred during sending email" : "Beim Senden der E-Mail ist ein Fehler aufgetreten",
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "%1$s hat auf deinen Terminvorschlag \"%2$s\" geantwortet",
    "{participant} responded to your meeting proposal {proposal}" : "{participant} hat auf deinen Terminvorschlag {proposal} geantwortet",
    ...
    "Year" : "Jahr",
    "List" : "Liste",
    "Filter events …" : "Veranstaltungen filtern …",
    ...
    "Notifications muted" : "Benachrichtigungen stummgeschaltet",
    ...
    "Disable alarm notifications for this calendar" : "Alarmbenachrichtigungen für diesen Kalender deaktivieren",
    ...
    "Free / Busy" : "Frei / Beschäftigt",
    "Busy" : "Beschäftigt",
    "Busy: your time is marked as occupied" : "Beschäftigt: Der Zeitbereich ist als nicht verfügbar markiert",
    "Free" : "Frei",
    "Free: your time is still available" : "Frei: Der Zeitbereich ist als verfügbar markiert",
    ...
    "Events that have already ended are shown with a more faded background" : "Abgeschlossene Ereignisse werden mit einem blasseren Hintergrund dargestellt",
    ...
    "Choose whether they can view and edit events, or only view them." : "Auswählen, ob sie Ereignisse anzeigen und bearbeiten oder nur anzeigen können.",
    ...
    "Could not book the appointment. Please try again later or contact the organizer." : "Termin konnte nicht gebucht werden. Bitte später noch einmal versuchen oder an den Organisator wenden.",
    "Back" : "Zurück",
    ...
    "Accept this occurrence" : "Dieses Vorkommen akzeptieren",
    "Accept entire series" : "Die gesamte Serie akzeptieren",
    "Accept" : "Annehmen",
    "Decline this occurrence" : "Dieses Vorkommen ablehnen",
    "Decline entire series" : "Die gesamte Serie ablehnen",
    "Decline" : "Ablehnen",
    "Tentative for this occurrence" : "Vorläufig für dieses Vorkommen",
    "Tentative for entire series" : "Vorläufig für die gesamte Serie",
    ...
    "_%n seat_::_%n seats_" : ["%n Platz","%n Plätze"],
    "Unavailable" : "Nicht verfügbar",
    "Room type" : "Raum-Typ",
    "Any" : "Irgendein",
    "Minimum seating capacity" : "Mindestsitzplatzkapazität",
    "_{available} of %n room available_::_{available} of %n rooms available_" : ["{available} von %n Räumen verfügbar","{available} von %n Räumen verfügbar"],
    "Rooms" : "Räume",
    "Search rooms" : "Räume suchen",
    "Name, building or room number" : "Name, Gebäude oder Raumnummer",
    "Building" : "Gebäude",
    "Floor" : "Stockwerk",
    "Minimum capacity" : "Mindestkapazität",
    "Features" : "Funktionen",
    "Checking availability…" : "Prüfe Verfügbarkeit …",
    "No rooms match the filters" : "Keine Räume passen zu den Filtern",
    "No rooms found" : "Keine Räume gefunden",
    "Clear filters" : "Filter zurücksetzen",
    "More details" : "Weitere Einzelheiten",
    "Update entire series" : "Die gesamte Serie aktualisieren",
    "Update this and future occurrences" : "Dieses und künftige Vorkommen aktualisieren",
    ...
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Termin konnte nicht bestätigt werden. Bitte später erneut versuchen oder an den Organisator wenden.",
    ...
    "Delete this and future occurrences" : "Dieses und künftige Vorkommen löschen",
    "Delete entire series" : "Die gesamte Serie löschen",
    "All day" : "Ganztägig",
    ...
    "Notify me when participants respond" : "Mich benachrichtigen, wenn Teilnehmer antworten",
    ...
    "This meeting proposal no longer exists" : "Dieser Terminvorschlag existiert nicht mehr",
    "Failed to open meeting proposal" : "Terminvorschlag konnte nicht geöffnet werden",
    ...
    "We noticed that you adjusted the date or time. Since this is not the first occurrence of the series, the date/time changes have been discarded. To change the date or time of the whole series, please edit the first occurrence." : "Wir haben festgestellt, dass Datum oder Uhrzeit angepasst wurde. Da dies nicht der erste Eintrag dieser Serie ist, wurden die Änderungen verworfen. Um Datum oder Uhrzeit der gesamten Serie zu ändern, bitte den ersten Eintrag bearbeiten.",
