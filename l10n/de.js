OC.L10N.register(
    ...
    "Delegated to you by" : "An dich übertragen durch",
    ...
    "Deck" : "Deck",
    "Tasks" : "Aufgaben",
    "Delegated by {name} (read-only)" : "Übertragen durch {name} (schreibgeschützt)",
    "Delegated by {name}" : "Übertragen durch {name}",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Delegierte Kalender konnten nicht geladen werden. Stelle sicher, dass der Server die Kalenderdelegierung unterstützt.",
