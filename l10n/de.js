OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Dein Termin \"%s\" benötigt eine Bestätigung",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Wenn Du den Termin doch noch absagen möchtest, wende Dich bitte an Deinen Organisator.",
    "Appointment:" : "Termin:",
    "Date:" : "Datum:",
    "Where:" : "Ort:",
    ...
    "You do not have any deleted elements." : "Du hast kein gelöschten Elemente",
    "Name" : "Name",
    "Deleted" : "Gelöscht",
    ...
    "Your appointment is booked" : "Dein Termin ist gebucht",
    ...
    "Has not responded to {organizerName}'s invitation yet." : "Noch keine Rückmeldung auf die Einladung von {organizerName}",
    ...
    "The slot for your appointment from {startDate} to {endDate} is not available any more." : "Der Platz für Deinen Termin von {startDate} bis {endDate} ist nicht mehr verfügbar.",
    ...
    "Haircut" : "Friseur",
    "Exam" : "Prüfung",
    "Written test" : "Schriftliche Prüfung",
