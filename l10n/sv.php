...
"Share CalendarManager" => "Dela kalender",
"Download" => "Ladda ner",
"Edit" => "Redigera",
"Delete" => "Radera",
...
"Active" => "Aktiv",
"CalendarManager color" => "Kalender-färg",
"Save" => "Spara",
"Submit" => "Lägg till",
"Cancel" => "Avbryt",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "En kalender med detta namn finns redan. Om du fortsätter ändå så kommer dessa kalendrar att slås samman.",
...
"URLs" => "URL:er",
"CalendarManager CalDAV syncing addresses" => "Kalender CalDAV synkroniserar adresser",
"more info" => "mer info",
