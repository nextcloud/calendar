OC.L10N.register(
    ...
    "[from] {dateFormat}" : "[nuo] {dateFormat}",
    "[to] {dateFormat}" : "[iki] {dateFormat}",
    "[from] {dateFormat} [at] {timeFormat}" : "[nuo] {dateFormat}, {timeFormat}",
    "[to] {dateFormat} [at] {timeFormat}" : "[iki] {dateFormat}, {timeFormat}",
