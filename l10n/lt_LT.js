OC.L10N.register(
    ...
    "%s has published the calendar »%s«" : "%s pasidalino kalendoriumi \"%s\"",
    "Hello," : "Sveiki,",
    "We wanted to inform you that %s has published the calendar »%s«." : "Norėtume informuoti, kad %s pasidalino kalendoriumi \"%s\"",
    "Open »%s«" : "Atidaryti \"%s\"",
    "Cheers!" : "Sveikinimai!",
    "Recipient" : "Gavėjas",
    ...
    "Error requesting resource on remote server. This could possible be related to a certificate mismatch" : "Klaida užklausiant išteklių iš nuotolinio serverio. Tai galimai gali būti susiję su liudijimų neatitikimu",
    ...
    "There was an issue while sending your email." : "Siunčiant jūsų laišką įvyko klaida.",
    "group" : "grupė",
    "Details" : "Išsamiau",
    "Attendees" : "Dalyviai",
    ...
    "Go back" : "Atgal",
    "Go forward" : "Pirmyn",
    "Calendar does not exist" : "Kalendorius neegzistuoja",
    "Maybe you got a wrong link or the calendar was unshared?" : "Galbūt gavote blogą nuorodą? Gal kalendorius nesidalinamas?",
