OC.L10N.register(
    ...
    "Shared calendars" : "Calendarios compartido",
    "Deck" : "Deck",
    "Hidden" : "Oculto",
    ...
    "Never show me as busy (set this calendar to transparent)" : "Nunca me muestres como ocupado (establecer este calendario como transparente)",
    ...
    "Appointment schedule successfully created" : "Horario de citas creado correctamente",
    "Appointment schedule successfully updated" : "Horario de citas actualizado correctamente",
    ...
    "Create appointment schedule" : "Horario de citas creado",
    ...
    "Select a Talk Room" : "Selecciona una sala de Talk",
    "Add Talk conversation" : "Añade una conversación de Talk",
    ...
    "Successfully added Talk room link to location." : "Se ha añadido correctamente el enlace a la sala de Talk en la ubicación.",
    "Successfully added Talk room link to description." : "Se ha añadido correctamente el enlace a la sala de Talk en la descripción.",
    "Failed to apply Talk room." : "Error al guardar la sala Talk.",
    "Error creating Talk room." : "Error al crear sala Talk.",
    ...
    "Check room availability" : "Comprueba la disponibilidad de la sala",
    "Accept" : "Aceptar",
    "Decline" : "Declinar",
    "Tentative" : "Pendiente",
    ...
    "Search for emails, users, contacts, teams or groups" : "Busca correos, usuarios, contactos, equipos o grupos",
    ...
    "Note that members of contact groups get invited but are not synced yet." : "Ten en cuenta que los miembros de los grupos de contactos son invitados pero aún no están sincronizados.",
    "(organizer)" : "(organizador)",
    "Make {label} the organizer" : "Haz a {label} el organizador",
    "Make {label} the organizer and attend" : "Haz a {label} el organizador y asiste tú",
    ...
    "Show all rooms" : "Muestra todas las salas",
    "Projector" : "Proyector",
    ...
    "Select a time zone" : "Selecciona una zona horaria",
    ...
    "Default calendar for invitations and new events" : "Calendario por defecto para invitaciones y nuevos eventos",
