OC.L10N.register(
    ...
    "An error occured during sending email" : "Ha ocurrido un error durante el envío del correo electrónico",
    "%s has published the calendar »%s«" : "%s ha publicado el calendario »%s«",
    "Unexpected error sending email. Please contact your administrator." : "Error inesperado enviando correo electrónico. Por favor comuníquese con el administrador.",
    ...
    "Calendar name can not be blank" : "El nombre del calendario no puede estar vacío",
    ...
    "Default reminder for part-day events" : "Recordatorio por defecto para eventos de parte del día",
    "Select default reminder" : "Seleccionar recordatorio predeterminado",
    "Default reminder for full-day events" : "Recordatorio por defecto para eventos de día completo",
    "These reminders will be automatically added to new events created in this calendar" : "Estos recordatorios se añadirán automáticamente a los nuevos eventos creados en este calendario",
    ...
    "Calendar events are styled to convey additional information at a glance." : "Los eventos del calendario se formatea para ofrecer información adicional de un vistazo.",
    "Free / Busy" : "Libre / Ocupado",
    "Busy" : "Ocupado",
    "Busy: your time is marked as occupied" : "Ocupado: tu tiempo se marca como ocupado",
    "Free" : "Libre",
    "Free: your time is still available" : "Libre: tu tiempo todavía está disponible",
    "Participation status" : "Estado de la participación",
    "Accepted" : "Aceptado",
    "Accepted: you confirmed your attendance" : "Aceptado: has confirmado tu asistencia",
    "Tentative" : "Tentativo",
    "Tentative: your participation is uncertain" : "Provisional: tu participación es incierta",
    "Invited" : "Invitado",
    "Invited: you have not yet responded to this invitation" : "Invitado: no has respondido todavía a esta invitación",
    "Declined" : "Declinado",
    "Declined: you declined this event" : "Declinado: has declinado este evento",
    "All declined" : "Todos declinados",
    "All declined: all participants declined" : "Todos declianods: todos los participantes han declinado",
    "Icons" : "Íconos",
    ...
    "Send email to {email}" : "Enviar email a {email}",
    ...
    "To send out invitations and handle responses, [linkopen]add your email address in personal settings[linkclose]." : "Para enviar invitaciones y gestionar las respuestas,  [linkopen]añade tu dirección de correo electrónico en los ajustes personales[linkclose].",
    ...
    "This event is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it." : "Este evento es la excepción a la serie recurrente. No se puede añadir una regla recurrente.",
    "first" : "primero",
    ...
    "The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost." : "Nextcloud no soporta completamente la definición de recurrencia de este evento. Si editas las opciones de recurrencia, ciertas repeticiones pueden perderse.",
    ...
    "Please ask your administrator to enable the Tasks App." : "Por favor, solicita a tu administrador que permita la aplicación de tareas.",
    ...
    "Take this event into account when calculating free-busy information." : "Toma este evento en consideración cuando calcules la información acerca de libre-ocupado.",
    ...
    "Please enter a valid date" : "Por favor especifica una fecha válida",
    "Please enter a valid date and time" : "Especifica valores correctos de fecha y hora, por favor",
