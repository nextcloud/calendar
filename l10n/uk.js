OC.L10N.register(
    ...
    "Add holiday calendar" : "Додати календар свят",
    ...
    "Limit the number of events displayed in the monthly view" : "Обмежте число подій, які показано у щомісячному поданні.",
    "Show weekends" : "Показувати вихідні дні",
    "Show week numbers" : "Показувати номери тижнів",
    "Time increments" : "Крок",
    "Default reminder" : "Нагадувати",
    ...
    "Minimum time before next available slot" : "Найменший час перед наступним можливим часовим діапазоном",
    ...
    "No attachments" : "Відсутні долучені файли",
    ...
    "Global" : "Загальний",
    "Holiday calendars" : "Святкові календарі",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Календарі свят надаються Thunderbird. Дані календаря будуть завантажені з {website}",
    "By {authors}" : "Автор: {authors}",
    "Subscribed" : "Підписано",
    "Subscribe" : "Підписатися",
    "Holidays in {region}" : "Свята в {region}",
    "An error occurred, unable to create the holiday calendar." : "Виникла помилка, не вдалося створити календар свят.",
    "Select date" : "Виберіть дату",
    "Select slot" : "Виберіть діапазон",
    "No slots available" : "Відсутні доступні часові діапазони",
