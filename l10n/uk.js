OC.L10N.register(
    ...
    "An error occurred during sending email" : "Помилка під час надсилання ел. листа",
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "%1$s відповів(-ла) на вашу пропозицію зустрічі \"%2$s\"",
    "{participant} responded to your meeting proposal {proposal}" : "{participant} відповів(-ла) на вашу пропозицію зустрічі {proposal}",
    ...
    "Notifications muted" : "Сповіщення вимкнено",
    "Delegated to you by" : "Делеговано вам від",
    ...
    "Calendar name can not be blank" : "Назва календаря не може бути порожньою",
    ...
    "Deck" : "Колода",
    "Tasks" : "Завдання",
    "Delegated by {name} (read-only)" : "Делеговано від {name} (тільки читання)",
    "Delegated by {name}" : "Делеговано від {name}",
    ...
    "Disable alarm notifications for this calendar" : "Вимкнути нагадування для цього календаря",
    "Default reminder for part-day events" : "Типове нагадування для подій на частину дня",
    "Select default reminder" : "Вибрати типове нагадування",
    "Default reminder for full-day events" : "Типове нагадування для подій на весь день",
    "These reminders will be automatically added to new events created in this calendar" : "Ці нагадування будуть автоматично додаватися до нових подій, які буде створено в цьому календарі.",
    ...
    "View" : "Подання",
    "Delete proposal" : "Вилучити пропозицію",
    "Event legend" : "Підпис під подіями",
    "Calendar events are styled to convey additional information at a glance." : "Календарні події позначатимуться додатковим оформленням для зручності.",
    "Free / Busy" : "Вільно / зайнято",
    "Busy" : "Зайнято",
    "Busy: your time is marked as occupied" : "Зайнято: ваш час буде позначено \"зайнято\"",
    "Free" : "Вільно",
    "Free: your time is still available" : "Вільно: маєте доступний час",
    "Participation status" : "Статус участи",
    "Accepted" : "Прийнято",
    "Accepted: you confirmed your attendance" : "Прийнято: підтверджено вашу участь",
    "Tentative" : "Можливо так",
    "Tentative: your participation is uncertain" : "Умовно: участь не підтверджено повністю",
    "Invited" : "Запрошено",
    "Invited: you have not yet responded to this invitation" : "Запрошено: не відповіли на запрошення",
    "Declined" : "Відхилено",
    "Declined: you declined this event" : "Відхилено: ви відхилили участь в цій зустрічі",
    "All declined" : "Всі відхилили",
    "All declined: all participants declined" : "Всі відхилили: всі учасники відхилили",
    "Icons" : "Значки",
    "Attendees" : "Учасники",
    "This event has one or more attendees" : "Ця подія має одного або кілька учасників",
    "Past events" : "Минулі події",
    "Past event" : "Минула подія",
    "Events that have already ended are shown with a more faded background" : "Події, які вже завершилися, показуватимуться на притлумленому тлі",
    ...
    "Some calendars are disabled because this file contains {types}." : "Деякі календарі вимкнено, оскільки цей файл містить {types}.",
    ...
    "{email} will no longer be able to act on your behalf." : "{email} більше не зможе діяти від вашого імени.",
    "Revoke" : "Відкликати",
    "Viewer" : "Переглядач",
    "Editor" : "Редактор",
    "Could not revoke access." : "Не вдалося відкликати доступ.",
    "Access revoked successfully." : "Доступ успішно відкликано.",
    "{name} can now view your calendars." : "{name} тепер може переглядати ваші календарі.",
    "{name} can now act on your behalf." : "{name} тепер може діяти від вашого імени.",
    "Could not add delegate." : "Не вдалося додати делегата.",
    "Could not load delegates." : "Не вдалося завантажити делегатів.",
    "Delegates" : "Делегати",
    "Allow users to manage your calendar events and invitations on your behalf." : "Дозволити користувачам керувати вашим календарем та запрошеннями від вашого імени.",
    "Loading delegates…" : "Завантаження делегатів...",
    "Revoke access" : "Відкликати доступ",
    "No delegates yet." : "Відсутні делегати.",
    "Add delegate" : "Додати делегата",
    "Revoke access?" : "Відкликати доступ?",
    "Search for a user…" : "Пошук користувача ...",
    "No users found" : "Не знайдено користувачів",
    "Choose whether they can view and edit events, or only view them." : "Виберіть, чи зможуть вони переглядати та редагувати події або лише переглядати їх.",
    "Add as viewer" : "Додати як переглядача",
    "Add as editor" : "Додати як редактора",
    ...
    "Import calendar file" : "Імпортувати файл календаря",
    ...
    "Public – shown on profile page" : "Публічне - показуватиметься на сторінці профіля",
    "Private – only accessible via link" : "Приватне - доступне тільки за посиланням",
    ...
    "Description" : "Опис",
    "Duration (minutes)" : "Тривалість (хв.)",
    "Increments" : "Крок",
    "Booking calendar" : "Резервування календаря",
    "Calendars to check for conflicts" : "Календарі для перевірки на конфлікти",
    "Visibility" : "Видимість",
    "Booking availability" : "Резервування доступності",
    "to" : "до",
    ...
    "Buffer before the event" : "Час перед подією",
    "Buffer after the event" : "Час після події",
    "Minimum time before next slot" : "Щонайменше перед наступним діяпазоном часу",
    ...
    "Amount" : "Сума",
    "before at" : "до о",
    "Alarm date and time" : "Дата та час будильника",
    ...
    "Proceed" : "Продовжити",
    "Upload files as attachments" : "Завантажити файли вкладеннями",
    ...
    "{name} (delegated by {delegator})" : "{name} (делеговано від {delegator})",
    "Duration" : "Тривалість",
    ...
    "2 hours" : "2 години",
    "Custom" : "Власне",
    "_{i} day_::_{i} days_" : ["{i} день","{i} дні","{i} днів","{i} днів"],
    "_{i} hour_::_{i} hours_" : ["{i} година","{i} години","{i} годин","{i} годин"],
    "_{i} minute_::_{i} minutes_" : ["{i} хвилина","{i} хвилини","{i} хвилин","{i} хвилин"],
    "Days" : "Дні",
    "Hours" : "Години",
    "Minutes" : "Хвилин",
    ...
    "Available time slots" : "Доступні проміжки часу",
    ...
    "Send email to {email}" : "Надіслати ел.пошт до {email}",
    ...
    "Attendees copied to clipboard" : "Список учасників скопійовано",
    "Failed to copy attendees to clipboard" : "Не вдалося скопіювати учасників",
    "Copy attendees to clipboard" : "Копіювати учасників",
    ...
    "Search for attendees" : "Пошук учасників",
    ...
    "Set repetition" : "Встановити повторення",
    "never" : "завжди",
    "on date" : "дата",
    "after" : "опісля",
    "End repeat" : "Повторювати до",
    "End repeat date" : "Дата завершення повторення",
    ...
    "first" : "перший",
    "Week occurrence" : "Щотижневе повторення",
    ...
    "Repeat frequency" : "Частота повторень",
    ...
    "Search for resources" : "Пошук ресурсів",
    "Projector" : "Проєктор",
    "Whiteboard" : "Біла дошка",
    "_%n seat_::_%n seats_" : ["%n місце","%n місця","%n місць","%n місць"],
    "Unavailable" : "Недоступно",
    "Room type" : "Вид кімнати",
    "Any" : "Будь-яка",
    "Minimum seating capacity" : "Мінімальна кількість місць",
    "_{available} of %n room available_::_{available} of %n rooms available_" : ["{available} із %n кімнат доступна","{available} із %n кімнат доступно","{available} із %n кімнат доступно","{available} із %n кімнат доступно"],
    "Rooms" : "Кімнати",
    "Search rooms" : "Пошук кімнат",
    "Name, building or room number" : "Ім'я, будинок або номер кімнати",
    "Building" : "Будівля",
    "Floor" : "Поверх",
    "Minimum capacity" : "Мінімальні здатності",
    "Features" : "Функціональність",
    "Checking availability…" : "Перевірка доступності...",
    "No rooms match the filters" : "Жодна кімната не відповідає фільтрам",
    "No rooms found" : "Кімнати не знайдено",
    ...
    "Contact your server administrator to resolve this issue." : "Сконтактуйте з адміністратором сервера для вирішення проблеми.",
    ...
    "This booking link is no longer valid" : "Це посилання на бронювання більше не чинне",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Термін дії посилання на підтвердження сплив або його було вже використано. Сконтактуйте з організатором для повторного бронювання. ",
    "Confirm your appointment" : "Підтвердити вашу зустріч",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Не вдалося підтвердити зустріч. Спробуйте ще раз пізніше або сконтактуйте з організатором.",
    ...
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Виберіть \"Лише запрошені учасники можуть відповідати\", щоби заборонити учасниками пересилати запрошення іншим користувачам.",
    "Detailed event editor" : "Розгорнутий редактор події",
    ...
    "Notify me when participants respond" : "Повідомити мене, коли учасники дадуть відповідь",
    ...
    "{title}, All day: {timeDescription}" : "{title}, цілодобово: {timeDescription}",
    "{title}, All day" : "{title}, цілодобово",
    "{title}, {timeDescription}" : "{title}, {timeDescription}",
    "All participants declined" : "Всі користувачі відхилили запрошення",
    ...
    "Event link copied to clipboard" : "Посилання на подію скопійовано",
    "Failed to copy event link" : "Не вдалося скопіювати посилання на подію",
    ...
    "Other" : "Інші",
    "Audio-visual equipment" : "Аудіовізуальне обладнання",
    "Phone" : "Телефон",
    "Video conferencing" : "Відеоконференції",
    "TV" : "ТБ",
    ...
    "This meeting proposal no longer exists" : "Пропозиція зустрічі більше не існує",
    "Failed to open meeting proposal" : "Не вдалося відкрити пропозицію зустрічі",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Не вдалося завантажити делеговані календарі. Перевірте, чи сервер підтримує делегування календарів.",
