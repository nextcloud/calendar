OC.L10N.register(
    ...
    "[from] {dateFormat}" : "[dende] {dateFormat}",
    "[to] {dateFormat}" : "[ata] {dateFormat}",
    "[on] {dateFormat}" : "[o] {dateFormat}",
    "[from] {dateFormat} [at] {timeFormat}" : "[dende] {dateFormat} [ás] {timeFormat}",
    "[to] {dateFormat} [at] {timeFormat}" : "[ata] {dateFormat} [á] {timeFormat}",
    "[on] {dateFormat} [at] {timeFormat}" : "[o] {dateFormat} [ás] {timeFormat}",
    "{dateFormat} [at] {timeFormat}" : "{dateFormat} [ás] {timeFormat}",
