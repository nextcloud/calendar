OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Вашата среща „%s“ се нуждае от потвърждение",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Ако все пак желаете да отмените срещата, моля, свържете се с вашия организатор.",
    "Appointment:" : "Среща:",
    "Date:" : "Дата:",
    "Where:" : "Къде:",
    ...
    "Search for emails, users or contacts" : "Търсене на имейли, потребители или контакти",
