OC.L10N.register(
    "calendar",
    {
    "Provided email-address is too long" : "Предоставеният e mail адрес е прекалено дълъг",
    ...
    "Create new event" : "Създай ново събитие",
    "Event" : "Събитие",
    "Today" : "Днес",
    "Day" : "Ден",
    "Week" : "Седмица",
    ...
    "Edit" : "Редакция",
    "Delete" : "Изтриване",
    "Appointment schedules" : "Графици за срещи",
    ...
    "{teamDisplayName} (Team)" : "{teamDisplayName}(Екип)",
    ...
    "can edit and see confidential events" : "може да редактира и вижда поверителни събития",
    ...
    "Failed to save calendar name and color" : "Запазването на името и цвета на календара не бе успешно",
    "Calendar name …" : "Име на календар ...",
    "Never show me as busy (set this calendar to transparent)" : "Никога не ме показвай като зает (задай този календар да бъде прозрачен)",
    ...
    "Deleting proposal \"{title}\"" : "Предложение за изтриване\"{title}\"",
    "Successfully deleted proposal" : "Успешно изтриване",
    "Failed to delete proposal" : "Неуспешно изтриване",
    "Failed to retrieve proposals" : "Неуспешно извличане",
    "Meeting proposals" : "Предложения за срещи",
    "A configured email address is required to use meeting proposals" : "Необходим е конфигуриран имейл адрес, за да се използват предложения за срещи",
    "No active meeting proposals" : "Няма активни предложения за срещи",
    "View" : "Изглед",
    ...
    "At event start" : "В началото на събитието",
    "No reminder" : "Без напомняне",
    "Failed to save default calendar" : "Неуспешно записване на календарът по подразбиране",
    ...
    "General" : "Общи",
    "Availability settings" : "Настройки за наличност",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Достъп до календари на Nextcloud от други приложения и устройства",
    "CalDAV URL" : "CalDAV URL",
    "Copy iOS/macOS CalDAV address" : "Копиране iOS/macOS CalDAV адрес",
    "Appearance" : "Изглед",
    "Birthday calendar" : "Календар за рожден ден",
    "Tasks in calendar" : "Задачи в календар",
    "Weekends" : "Почивни дни",
    "Week numbers" : "Номера на седмиците",
    "Limit number of events shown in Month view" : "Ограничаване на броя на събитията, показвани в месечния изглед",
    "Density in Day and Week View" : "Натовареност на дневен и седмичен изглед",
    "Editing" : "Редактиране",
    ...
    "Default calendar for incoming invitations" : "Календар по подразбиране за входящи покани",
    ...
    "Appointment schedule saved" : "Графикът на срещите е запазен",
    "Create appointment schedule" : "Създайте график за срещи",
    "Edit appointment schedule" : "Редактирайте графика за срещи",
    "Update" : "Обновяване",
    ...
    "It seems a rate limit has been reached. Please try again later." : "Изглежда е достигнат лимит на скоростта. Моля, опитайте отново по-късно.",
    ...
    "Back" : "Назад",
    "Book appointment" : "Резервиране на срещата",
    "Error fetching Talk conversations." : "Грешка при извличане на гласовите разговори.",
    "Conversation does not have a valid URL." : "Разговорът няма валиден URL адрес",
    "Successfully added Talk conversation link to location." : "Връзката към разговора е успешно добавена.",
    "Successfully added Talk conversation link to description." : "Връзката към разговора е успешно добавена в описанието.",
    "Failed to apply Talk room." : "Неуспешно прилагане на стая за разговори.",
    "Error creating Talk conversation" : "Грешка при създаването на разговор в Talk",
    "Select a Talk Room" : "Изберете стая за разговори",
    "Add Talk conversation" : "Добавете разговор в Talk",
    "Fetching Talk rooms…" : "Извличане на стаи за разговори…",
    "No Talk room available" : "Няма налична стая за разговори",
    "Create a new public conversation" : "Създаване на нов публичен разговор",
    ...
    "Could not upload attachment(s)" : "Невъзможност да се пркачи файл",
    "You are about to download a file. Please check the file name before opening it. Are you sure to proceed?" : "На път сте да изтеглите файл. Моля проверете името на файла преди да го отворите. Наистина ли искате да продължите?",
    "You are about to navigate to {host}. Are you sure to proceed? Link: {link}" : "Вие сте на път да навигирате до {host} . Наистина ли искате да продължите? Връзка: {link}",
    "Proceed" : "Продължете",
    ...
    "Availability will be checked" : "Наличността ще бъде проверена",
    "Invitation will be sent" : "Поканата ще бъде изпратена",
    "Failed to check availability" : "Неуспешна проверка за наличност",
    "Failed to deliver invitation" : "Неуспешно доставяне на поканата",
    ...
    "Selected slot" : "Избран слот",
    "Availability of attendees, resources and rooms" : "Наличие на присъстващи, ресурси и стаи",
    "Suggestion accepted" : "Предложението е прието",
    "Previous date" : "Предходна дата",
    ...
    "Done" : "Завършено",
    "Search room" : "Търсене на стая",
    "Room name" : "Име на стаята",
    "Check room availability" : "Проверка за наличност на стая",
    "Free" : " Свободни",
    "Busy (tentative)" : "Зает (временно)",
    "Busy" : "Зает",
    "Unknown" : "Непознат",
    "Find a time" : "Намерете време",
    ...
    "Successfully appended link to talk room to location." : "Връзката към стаята за разговори е успешно добавена към местоположението.",
    ...
    "Request reply" : "Повторете заявката",
    "Chairperson" : "Председател",
    ...
    "Note that members of circles get invited but are not synced yet." : "Обърнете внимание, че членовете на кръговете получават покани, но все още не са синхронизирани.",
    "Note that members of contact groups get invited but are not synced yet." : "Обърнете внимание, че членовете на групите с контакти получават покани, но все още не са синхронизирани.",
    "(organizer)" : "(организатор)",
    "Make {label} the organizer" : "Направете {label} организатор",
    "Make {label} the organizer and attend" : "Направете {label} организатор и присъствайте",
    ...
    "From" : "От",
    "To" : "До",
    "Your Time" : "Вашето време",
    "Repeat" : "Да се повтаря",
    "Repeat event" : "Повторете събитието",
    ...
    "Show all rooms" : "Покажи всички стаи",
    "Projector" : "Проектор",
    "Whiteboard" : "Табло",
    "Room type" : "Тип стая",
    "Any" : "Всяка",
    ...
    "Remove date" : "Премахване на дата",
    "Attendance required" : "Задължително присъствие",
    "Attendance optional" : "Присъствие по желание",
    "Remove participant" : "Премахване на участник",
    "Yes" : "Да",
    "No" : "Не",
    "Maybe" : "Може би",
    "None" : "Няма",
    "Select your meeting availability" : "Изберете Вашата възможност за среща",
    "Create a meeting for this date and time" : "Създаване на среща за тази дата и час",
    "Create" : "Създаване",
    "No participants or dates available" : "Няма налични участници или дати",
    ...
    "Select a time zone" : "Изберете часова зона",
    ...
    "Global" : "Глобални",
    "Holidays in {region}" : "Празници в {region}",
    "An error occurred, unable to read public calendars." : "Възникна грешка, невъзможност да се четат публични календари.",
    "An error occurred, unable to subscribe to calendar." : "Възникна грешка, невъзможност за абониране за календар.",
    "Public holiday calendars" : "Календари за официални празници",
    "Public calendars" : "Публични календари",
    "No valid public calendars configured" : "Няма конфигурирани валидни публични календари",
    "Speak to the server administrator to resolve this issue." : "Говорете със сървърния администратор, за да разрешите този проблем.",
    "Public holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Календарите с официални празници се предоставят от Thunderbird. Данните от календара ще бъдат изтеглени от {website}",
    "These public calendars are suggested by the server administrator. Calendar data will be downloaded from the respective website." : "Тези публични календари са предложени от администратора на сървъра. Данните от календара ще бъдат изтеглени от съответния уебсайт.",
    "By {authors}" : "От {authors}",
    "Subscribed" : "Абониран",
    "Subscribe" : "Абониране",
    "Could not fetch slots" : "Слотовете не можаха да бъдат извлечени",
    ...
    "Discard event" : "Отхвърляне на събитието",
    ...
    "All day" : "Цял ден",
    "Modifications wont get propagated to the organizer and other attendees" : "Промените няма да бъдат разпространени до организатора и другите участници",
    ...
    "Are you sure you want to discard the changes made to this event?" : "Сигурни ли сте, че искате да отхвърлите промените направени в това събитие?",
    ...
    "Close" : "Затвори",
    "Modifications will not get propagated to the organizer and other attendees" : "Промените няма да бъдат разпространени до организатора и другите участници",
    "Meeting proposals overview" : "Преглед на предложения за среща",
    "Edit meeting proposal" : "Редактиране на предложение за среща",
    "Create meeting proposal" : "Създайте предложение за среща",
    "Update meeting proposal" : "Актуализиране на предложение за среща",
    "Saving proposal \"{title}\"" : "Запазване на предложение \"{title}\"",
    "Successfully saved proposal" : "Успешно запазено предложение",
    "Failed to save proposal" : "Неуспешно запазване на предложение",
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Създайте среща за \"{date}\"? Това ще създаде събитие в календара с всички участници.",
    ...
    "Failed to fetch free/busy data" : "Неуспешно извличане на данни за заетост/свободен час",
    "Selected" : "Избранo",
    "No Description" : "Няма описание",
    "No Location" : "Няма местоположение",
    "Edit this meeting proposal" : "Редактирайте това предложение за среща",
    "Delete this meeting proposal" : "Изтрийте това предложение за среща",
    "Title" : "Заглавие",
    "15 min" : "15 мин",
    "30 min" : "30 мин",
    "60 min" : "60 мин",
    ...
    "Selected times" : "Избрани часове",
    "Previous span" : "Предишен период",
    "Next span" : "Следващ период",
    "Less days" : "По-малко дни",
    "More days" : "Още дни",
    "Loading meeting proposal" : "Предложението за среща се зарежда",
    "No meeting proposal found" : "Няма намерено предложение за среща",
    "Please wait while we load the meeting proposal." : "Моля изчакайте, докато заредим предложението за среща.",
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "Връзката, която сте последвали, може да е неработеща или предложението за среща може вече да не съществува.",
    "Thank you for your response!" : "Благодарим Ви за отговора!",
    "Your vote has been recorded. Thank you for participating!" : "Вашият вот е записан. Благодарим Ви за участието!",
    "Unknown User" : "Неизвестен потребител",
    "No Title" : "Без заглавие",
    "No Duration" : "Без продължителност",
    "Select a different time zone" : "Изберете друга часова зона",
    "Submit" : "Изпращане",
    "Subscribe to {name}" : "Абониране за {name}",
    "Export {name}" : "Експортиране /изнасям/ на {name}",
    "Show availability" : "Показване на наличност",
    ...
    "You are not allowed to edit this event as an attendee." : "Нямате право да редактирате това събитие като присъстващ.",
    "W" : "W",
    "%n more" : "%n повече",
    "No events to display" : "Няма събития за показване",
    "All participants declined" : "Всички участници отказаха",
    "Please confirm your participation" : "Моля потвърдете Вашето участие",
    "You declined this event" : "Вие отказахте това събитие",
    "Your participation is tentative" : "Участието Ви е условно",
    ...
    "Failed to save event" : "Неуспешно запазване на събитие",
    ...
    "The visibility of this event in read-only shared calendars." : "Видимостта на това събитие в споделени календари само за четене.",
    "Add a location" : "Добавяне на местоположение",
    "Add a description\n\n- What is this meeting about\n- Agenda items\n- Anything participants need to prepare" : "Добавете описание\n\n- За какво е тази среща\n- Точки от дневния ред\n- Всичко, което участниците трябва да подготвят",
    "Status" : "Състояние",
    ...
    "Attachment {fileName} added!" : "Прикаченият файл {fileName}е добавен!",
    "An error occurred during uploading file {fileName}" : "Възникна грешка при качването на файл {fileName}",
    ...
    "Talk conversation for proposal" : "Talk разговор за предложение",
    ...
    "{invitedCount} invited, {confirmedCount} confirmed" : "{invitedCount} поканен, {confirmedCount}потвърден",
    ...
    "Limit number of events shown in month view" : "Ограничаване на броя събития показвани в месечен изглед",
    "Time division in day and week view" : "Разделяне на времето в дневен и седмичен изглед",
    "Enable simple editor" : "Активиране на опростен редактор"
},
