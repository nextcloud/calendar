...
"Dec." => "Дек.",
"All day" => "Цел ден",
"New CalendarManager" => "Нов календар",
...
"Share CalendarManager" => "Сподели календар",
"Download" => "Преземи",
"Edit" => "Уреди",
"Delete" => "Избриши",
...
"Active" => "Активен",
"CalendarManager color" => "Боја на календарот",
"Save" => "Сними",
"Submit" => "Прати",
"Cancel" => "Откажи",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Календар со ова име веќе постои. Ако сепак продолжите календарите ќе бидат споени.",
...
"URLs" => "URL",
"CalendarManager CalDAV syncing addresses" => "CalDAV адреси за синхронизирање со календар",
