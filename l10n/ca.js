OC.L10N.register(
    ...
    "Appointments" : "Cites",
    "Schedule appointment \"%s\"" : "Agenda una cita \"%s\"",
    "Schedule an appointment" : "Agenda una cita",
    "Prepare for %s" : "Preparar-se per a %s",
    "Follow up for %s" : "Seguiment de %s",
    "Your appointment \"%s\" needs confirmation" : "La vostra cita \"%s\" necessita confirmació",
    ...
    "If you wish to cancel the appointment after all, please contact your organizer." : "Si després de tot voleu cancel·lar la cita, poseu-vos en contacte amb el vostre organitzador.",
    "Appointment:" : "Cita:",
    "Date:" : "Data:",
    "Where:" : "Ubicació:",
    ...
    "Max slots per day" : "Màxim de unitats temporals per dia",
    ...
    "Please share anything that will help prepare for our meeting" : "Si us plau, compartiu qualsevol cosa que us ajudi a preparar la nostra reunió",
    "Could not book the appointment. Please try again later or contact the organizer." : "No s'ha pogut reservar la cita. Torneu-ho a provar més tard o poseu-vos en contacte amb l'organitzador.",
    ...
    "Declined {organizerName}'s invitation" : "{name} ha declinat la invitació de {organizerName}.",
    ...
    "Successfully appended link to talk room to description." : "S'ha afegit l'enllaç d'una nova sala del Talk a la descripció de l'esdeveniment.",
