OC.L10N.register(
    ...
    "Create appointment schedule" : "Crea d'una planificació de cites",
    "Edit appointment schedule" : "Edició la planificació de cites",
    "Update" : "Actualitza",
    ...
    "Successfully added Talk conversation link to location." : "S'ha afegit correctament l'enllaç de Converses a la ubicació.",
    "Successfully added Talk conversation link to description." : "S'ha afegit correctament l'enllaç de Converses a la descripció.",
    "Failed to apply Talk room." : "No s'ha pogut aplicar la sala de Converses.",
    "Error creating Talk conversation" : "S'ha produït un error en crear la Converses",
    "Select a Talk Room" : "Seleccioneu una sala de Converses",
    "Add Talk conversation" : "Afegeix una Converses",
    "Fetching Talk rooms…" : "S'estan obtenint sales de Converses…",
    ...
    "Could not upload attachment(s)" : "No s'han pogut pujar els fitxers adjunts",
    ...
    "Search for emails, users, contacts, contact groups or teams" : "Cerca correus electrònics, usuaris, contactes, grups de contactes o equips",
    ...
    "Modifications wont get propagated to the organizer and other attendees" : "Les modificacions no es propagaran a l'organitzador i als altres assistents",
    "Details" : "Detalls",
    ...
    "You are not allowed to edit this event as an attendee." : "No teniu permès editar aquest esdeveniment com a assistent.",
    "W" : "S",
    "%n more" : "%n més",
    "No events to display" : "No hi ha esdeveniments per visualitzar",
    "All participants declined" : "Tots els participants van rebutjar",
    "Please confirm your participation" : "Si us plau, confirmeu la vostra participació",
    "You declined this event" : "Has rebutjat aquest esdeveniment",
    "Your participation is tentative" : "La vostra participació és provisional",
