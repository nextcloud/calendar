OC.L10N.register(
    ...
    "Add holiday calendar" : "Afegeix un calendari de festius",
    ...
    "Global" : "Global",
    "Holiday calendars" : "Calendari de festius",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Els calendaris de festius són proporcionats pel Thunderbird. Les dades dels calendaris es baixaran de {website}",
    "By {authors}" : "Per {authors}",
    "Subscribed" : "Subscrit",
    "Subscribe" : "Subscriu-m'hi",
    "Holidays in {region}" : "Festius a {region}",
    "An error occurred, unable to create the holiday calendar." : "S'ha produït un error. No s'ha pogut crear el calendari de festius.",
