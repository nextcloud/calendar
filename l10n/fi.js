OC.L10N.register(
    ...
    "Appointment Description:" : "Tapaamisen kuvaus:",
    ...
    "%s has proposed a meeting" : "%s ehdotti tapaamista",
    "%s has updated a proposed meeting" : "%s päivitti kokousehdotuksen",
    "%s has canceled a proposed meeting" : "%s perui kokousehdotuksen",
    "Dear %s, a new meeting has been proposed" : "%s, uutta kokousta on ehdotettu",
    "Dear %s, a proposed meeting has been updated" : "%s, ehdotettu kokous on päivitetty",
    "Dear %s, a proposed meeting has been cancelled" : "%s, ehdotettu kokous on peruttu",
    "Respond" : "Vastaa",
    "Location:" : "Sijainti:",
    "%1$s minutes" : "%1$s minuuttia",
    "Duration:" : "Kesto:",
    "Dates:" : "Päivät:",
    "[Proposed] %1$s" : "[Ehdotettu] %1$s",
    "Calendar App" : "Kalenterisovellus",
    ...
    "Year" : "Vuosi",
    "List" : "Lista",
    "Filter events …" : "Suodata tapahtumia  ...",
    ...
    "Edit" : "Muokkaa",
    "Delete" : "Poista",
    "Appointment schedules" : "Tapaamisaikataulut",
    "Create new" : "Luo uusi",
    ...
    "Calendar name can not be blank" : "Kalenterin nimi ei voi olla tyhjä.",
    ...
    "can edit and see confidential events" : "voi nähdä ja muokata luottamuksellisia tapahtumia",
    ...
    "Never show me as busy (set this calendar to transparent)" : "Älä ikinä näytä minua varattuna (aseta tämä kalenteri läpinäkyväksi)",
    "Select default reminder" : "Valitse oletusmuistutus",
    "Default reminder for full-day events" : "Oletusmuistutus koko päivän kestäville tapahtumille",
    "These reminders will be automatically added to new events created in this calendar" : "Nämä muistutukset lisätään automaattisesti niihin tapahtumiin, jotka luodaan tähän kalenteriin",
    ...
    "Cancel" : "Peruuta",
    "Deleting proposal \"{title}\"" : "Poistetaan ehdotus \"{title}\"",
    "Successfully deleted proposal" : "Ehdotus poistettu",
    "Failed to delete proposal" : "Ehdotuksen poistaminen epäonnistui",
    "Failed to retrieve proposals" : "Ehdotusten noutaminen epäonnistui",
    "Meeting proposals" : "Kokousehdotukset",
    "A configured email address is required to use meeting proposals" : "Sähköpostiosoitteesi vaaditaan tapaamisehdotusten käyttämiseen.",
    "No active meeting proposals" : "Ei aktiivisia kokousehdotuksia",
    "View" : "Näkymä",
    "Delete proposal" : "Poista ehdotus",
    "Event legend" : "Tapahtuman selite",
    "Calendar events are styled to convey additional information at a glance." : "Kalenterin tapahtumat on tyylitelty niin, että niistä saa lisätietoa yhdellä vilkaisulla.",
    "Free / Busy" : "Vapaa / Varattu",
    "Busy" : "Varattu",
    "Busy: your time is marked as occupied" : "Varattu: aikasi on merkattu varatuksi",
    "Free" : "Vapaa",
    "Free: your time is still available" : "Vapaa: aikasi on edelleen saatavilla",
    "Accepted" : "Hyväksytty",
    "Accepted: you confirmed your attendance" : "Hyväksytty: vahvistit osallistuvasi",
    "Tentative" : "Alustava",
    "Tentative: your participation is uncertain" : "Alustava: osallistumisesi on epävarmaa",
    "Invited" : "Kutsuttu",
    "Invited: you have not yet responded to this invitation" : "Kutsuttu: et ole vielä vastannut tähän kutsuun",
    "Declined" : "Kieltäydytty",
    "Declined: you declined this event" : "Kieltäydytty: vastasit kieltävästi tähän kutsuun",
    "All declined" : "Kaikki kieltäytyneet",
    "All declined: all participants declined" : "Kaikki kieltäytyneet: jokainen osanottaja on kieltäytynyt",
    "Icons" : "Kuvakkeet",
    "Attendees" : "Osallistujat",
    "This event has one or more attendees" : "Tällä tapahtumalla on yksi tai useampi osallistuja",
    "Past events" : "Menneet tapahtumat",
    "Past event" : "Mennyt tapahtuma",
    "Events that have already ended are shown with a more faded background" : "Päättyneet tapahtumat näytetään haaleammalla taustalla",
    ...
    "Error on saving attachments folder." : "Virhe liitetiedostokansiota tallennettaessa.",
    "Attachments folder" : "Liitteiden kansio",
    "{email} will no longer be able to act on your behalf." : "{email} ei enää voi toimia puolestasi.",
    "Revoke" : "Peru oikeus",
    "Viewer" : "Katselin",
    "Editor" : "Muokkain",
    "Could not revoke access." : "Pääsyoikeutta ei voitu perua.",
    "Access revoked successfully." : "Pääsyoikeus peruttu onnistuneesti.",
    "{name} can now view your calendars." : "{name} voi nyt nähdä kalenterisi.",
    "{name} can now act on your behalf." : "{name} voi nyt toimia puolestasi.",
    "Revoke access" : "Peru pääsyoikeus",
    "Revoke access?" : "Perutaanko pääsyoikeus?",
    "Search for a user…" : "Etsi käyttäjää...",
    "No users found" : "Käyttäjiä ei löytynyt",
    "Add as viewer" : "Lisää katsojana",
    "Add as editor" : "Lisää muokkaajana",
    ...
    "Import calendar file" : "Tuo kalenteritiedosto",
    ...
    "At event start" : "Tapahtuman alkaessa",
    ...
    "Availability settings" : "Saatavuuden asetukset",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Käytä Nextcloud-kalentereita muista sovelluksista ja laitteilta",
    "CalDAV URL" : "CalDAV:in URL-osoite",
    "Server Address for iOS and macOS" : "Palvelinosoite iOS:lle ja macOS:lle",
    "Appearance" : "Ulkoasu",
    "Birthday calendar" : "Syntymäpäiväkalenteri",
    "Tasks in calendar" : "Tehtävät kalenterissa",
    "Weekends" : "Viikonloput",
    "Week numbers" : "Viikkonumerot",
    "Limit number of events shown in Month view" : "Rajoita kuukausinäkymässä näytettävien tapahtumien määrää",
    "Editing" : "Muokkaaminen",
    "Simple event editor" : "Yksinkertainen tapahtumamuokkain",
    "Files" : "Tiedostot",
    "Appointment schedule successfully created" : "Tapaamisaikataulu luotu onnistuneesti",
    "Appointment schedule successfully updated" : "Tapaamisaikataulu päivitetty onnistuneesti",
    ...
    "Public – shown on profile page" : "Julkinen – näytetään profiilisivulla",
    "Private – only accessible via link" : "Yksityinen – pääsy vain linkin kautta",
    "Appointment schedule saved" : "Tapaamisaikataulu tallennettu",
    "Create appointment schedule" : "Luo tapaamisaikataulu",
    "Edit appointment schedule" : "Muokkaa tapaamisaikataulua",
    "Update" : "Päivitä",
    "(copy)" : "(kopioi)",
    ...
    "Error creating Talk conversation" : "Virhe luotaessa Talk-keskustelua",
    "Select a Talk Room" : "Valitse Talk-huone",
    "Fetching Talk rooms…" : "Noudetaan Talk-huoneita…",
    "No Talk room available" : "Talk-huonetta ei ole käytettävissä",
    "Select existing conversation" : "Valitse olemassa oleva keskustelu",
    "Select conversation" : "Valitse keskustelu",
    "Or create a new conversation" : "Tai luo uusi keskustelu",
    "Create public conversation" : "Luo julkinen keskustelu",
    "Create private conversation" : "Luo yksityinen keskustelu",
    "on" : "päivä",
    "at" : "kellonaika",
    "Default reminder of calendar" : "Kalenterin oletusmuistutus",
    "before at" : "ennen",
    ...
    "You are about to navigate to {host}. Are you sure to proceed? Link: {link}" : "Olet aikeissa siirtyä kohteeseen {host}. Haluatko varmasti jatkaa? Linkki: {link}",
    "Proceed" : "Jatka",
    ...
    "Invitation will be sent" : "Kutsu lähetetään",
    "Failed to check availability" : "Saatavuuden tarkistus epäonnistui",
    "Failed to deliver invitation" : "Kutsun toimittaminen epäonnistui",
    ...
    "_{i} day_::_{i} days_" : ["{i} päivä","{i} päivää"],
    "_{i} hour_::_{i} hours_" : ["{i} tunti","{i} tuntia"],
    "_{i} minute_::_{i} minutes_" : ["{i} minuutti","{i} minuuttia"],
    "Days" : "Päivää",
    "Hours" : "Tunnit",
    "Minutes" : "Minuutit",
    "Suggested times" : "Ehdotetut ajat",
    ...
    "Previous date" : "Edellinen päivä",
    "Next date" : "Seuraava päivä",
    "Legend" : "Selite",
    ...
    "Copy name and email address" : "Kopioi nimi ja sähköpostiosoite",
    ...
    "Attendees copied to clipboard" : "Osallistujat kopioitu leikepöydälle",
    "Failed to copy attendees to clipboard" : "Osallistujen kopioiminen leikepöydälle ei onnistunut",
    "Copy attendees to clipboard" : "Kopioi osallistujat leikepöydälle",
    ...
    "Search for emails, users, contacts, contact groups or teams" : "Etsi sähköpostiosoitteita, käyttäjiä, yhteystietoja, yhteystietoryhmiä tai tiimejä",
    ...
    "Name, building or room number" : "Nimi, rakennus tai huoneen numero",
    "Building" : "Rakennus",
    "Floor" : "Kerros",
    "Minimum capacity" : "Kapasiteetti vähintään",
    "Features" : "Ominaisuudet",
    "Checking availability…" : "Tarkistetaan saatavuutta…",
    "No rooms match the filters" : "Yksikään huone ei vastaa suodattimia",
    "No rooms found" : "Huoneita ei löytynyt",
    ...
    "Attendance required" : "Osallistuminen vaaditaan",
    "Attendance optional" : "Osallistuminen valinnaista",
    ...
    "Create" : "Luo",
    "No participants or dates available" : "Osanottajia tai ajankohtia ei ole saatavilla",
    "Type to search time zone" : "Kirjoita etsiäksesi aikavyöhykettä",
    "Global" : "Julkinen",
    "Holidays in {region}" : "Juhlapäivä alueella {region}",
    "An error occurred, unable to read public calendars." : "Tapahtui virhe, eikä julkisia kalentereita voitu lukea.",
    "An error occurred, unable to subscribe to calendar." : "Tapahtui virhe, eikä kalenteria voitu tilata.",
    ...
    "Contact your server administrator to resolve this issue." : "Ota yhteyttä palvelimen ylläpitoon ongelman ratkaisemiseksi.",
    ...
    "Confirm your appointment" : "Vahvista ajanvarauksesi",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Ajanvarausta ei voitu vahvistaa. Yritä myöhemmin uudelleen tai ota yhteyttä järjestäjään.",
    ...
    "All day" : "Koko päivä",
    "Add Talk conversation" : "Lisää Talk-keskustelu",
    "Managing shared access" : "Jaetun pääsyn hallinta",
    "Deny access" : "Estä pääsy",
    "Invite" : "Kutsu",
    "Discard changes?" : "Hylätäänkö muutokset?",
    "Are you sure you want to discard the changes made to this event?" : "Haluatko varmasti hylätä tähän tapahtumaan tehdyt muutokset?",
    ...
    "Update meeting proposal" : "Päivitä kokousehdotus",
    "Create meeting" : "Luo tapaaminen",
    "Saving proposal \"{title}\"" : "Tallennetaan ehdotus \"{title}\"",
    ...
    "Edit this meeting proposal" : "Muokkaa tätä kokousehdotusta",
    "Delete this meeting proposal" : "Poista tämä kokousehdotus",
    "Participants" : "Osallistujat",
    "Selected times" : "Valitut ajat",
    "Less days" : "Vähemmän päiviä",
    "More days" : "Enemmän päiviä",
    "Loading meeting proposal" : "Ladataan kokousehdotusta",
    "No meeting proposal found" : "Kokousehdotusta ei löytynyt",
    "Thank you for your response!" : "Kiitos vastauksestasi!",
    "Your vote has been recorded. Thank you for participating!" : "Äänesi on kirjattu. Kiitos osallistumisesta!",
    "Unknown User" : "Tuntematon käyttäjä",
    "No Title" : "Ei otsikkoa",
    "No Duration" : "Ei kestoa",
    "Select a different time zone" : "Valitse eri aikavyöhyke",
    "Submit" : "Lähetä",
    "Subscribe to {name}" : "Tilaa {name}",
    "Export {name}" : "Vie {name}",
    "Show availability" : "Näytä saatavuus",
    ...
    "You are not allowed to edit this event as an attendee." : "Sinulla ei ole oikeutta muokata tätä tapahtumaa osallistujan roolissa.",
    "W" : "Vko",
    "%n more" : "%n lisää",
    "No events to display" : "Ei tapahtumia näytettäväksi",
    "{startDate} to {endDate}" : "{startDate} - {endDate}",
    "{title}, All day: {timeDescription}" : "{title}, Koko päivä: {timeDescription}",
    "{title}, All day" : "{title}, Koko päivä",
    "{title}, {timeDescription}" : "{title}, {timeDescription}",
    "All participants declined" : "Kaikki osallistujat kieltäytyivät",
    "Please confirm your participation" : "Vahvista osallistumisesi",
    "You declined this event" : "Kieltäydyit tästä tapahtumasta",
    "Your participation is tentative" : "Osallistumisesi on alustava.",
    ...
    "Event link copied to clipboard" : "Tapahtuman linkki kopioitu leikepöydälle",
    "Failed to copy event link" : "Tapahtuman linkkiä ei voitu kopioida",
    ...
    "Attachment {fileName} added!" : "Liite {fileName} lisätty!",
    "An error occurred during uploading file {fileName}" : "Tiedostoa {fileName} lähettäessä tapahtui virhe",
