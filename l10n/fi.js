OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Tapaamisesi \"%s\" vaatii hyväksymistä",
    "Dear %s, please confirm your booking" : "%s, ole hyvä ja hyväksy varauksesi",
    "Confirm" : "Hyväksy",
    "This confirmation link expires in %s hours." : "Tämä vahvistuslinkki umpeutuu %s tunnin kuluttua.",
    "If you wish to cancel the appointment after all, please contact your organizer." : "Jos tahdot kuitenkin perua tapaamisen, ole hyvä ja ota yhteyttä järjestäjään.",
    ...
    "Invitation declined." : "Kutsu hylätty.",
    "Declined {organizerName}'s invitation." : "Kieltäydytty järjestäjän {organizerName} kutsusta.",
    "Invitation is delegated." : "Kutsu on valtuutettu.",
    "Participation marked as tentative." : "Osallistuminen merkitty alustavaksi.",
    "Invitation sent." : "Kutsu lähetetty.",
    "Has not responded to {organizerName}'s invitation yet." : "Ei ole vielä vastannut järjestäjän {organizerName} kutsuun.",
