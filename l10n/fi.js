OC.L10N.register(
    ...
    "An error occured during sending email" : "Sähköpostia lähetettäessä tapahtui virhe",
    ...
    "Availability will be checked" : "Saatavuus tarkistetaan",
    ...
    "Create a new public conversation" : "Luo uusi julkinen keskustelu",
    ...
    "_%n more guest_::_%n more guests_" : ["%n muuta vierasta","%n muuta vierasta"],
    ...
    "Speak to the server administrator to resolve this issue." : "Keskustele palvelimen ylläpitäjän kanssa tämän ongelman ratkaisemisesta.",
