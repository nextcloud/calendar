...
"Dec." => "Dic.",
"All day" => "Todo el día",
"New CalendarManager" => "Nuevo calendario",
...
"Share CalendarManager" => "Compartir calendario",
"Download" => "Descargar",
"Edit" => "Editar",
"Delete" => "Eliminar",
...
"Displayname" => "Nombre",
"Active" => "Activo",
"CalendarManager color" => "Color del calendario",
"Save" => "Guardar",
"Submit" => "Guardar",
"Cancel" => "Cancelar",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Ya existe un calendario con este nombre. Si continúas, se combinarán los calendarios.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "Direcciones de sincronización de calendario CalDAV:",
