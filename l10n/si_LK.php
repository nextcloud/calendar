...
"Dec." => "දෙසැ.",
"All day" => "සියලු දින",
"New CalendarManager" => "නව දිනදසුන",
"Title" => "මාතෘකාව",
"From Date" => "දින සිට",
...
"Share CalendarManager" => "බෙදාහදාගත් දිනදසුන",
"Download" => "බාන්න",
"Edit" => "සැකසීම",
"Delete" => "මකන්න",
...
"Active" => "සක්‍රීය",
"CalendarManager color" => "දිනදසුනේ පැහැය",
"Save" => "සුරකින්න",
"Submit" => "යොමු කරන්න",
"Cancel" => "එපා",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "මෙම නමින් තිබෙන දිනදසුනක් දැනටම අඩංගුව පවතී. ඔබ මෙය දිගටම කරන්නේනම්, මෙම දිනදසුන ඉදිරියෙදි මුසුවේ.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "දිනදසුන CalDAV syncing ලිපිනය",
