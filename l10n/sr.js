OC.L10N.register(
    ...
    "%s has proposed a meeting" : "%s је предложио састанак",
    "%s has updated a proposed meeting" : "%s је ажурирао предлог састанка",
    "%s has canceled a proposed meeting" : "%s је отказао предлог састанка",
    "Dear %s, a new meeting has been proposed" : "Поштовани %s, предложен је нови састанак",
    "Dear %s, a proposed meeting has been updated" : "Поштовани %s, ажуриран је предлог састанка",
    "Dear %s, a proposed meeting has been cancelled" : "Поштовани %s, отказан је предлог састанка",
    "Location:" : "Локација:",
    "Duration:" : "Трајање:",
    ...
    "can edit and see confidential events" : "може да уреди и види поверљиве догађаје",
    ...
    "Deleting proposal \"{title}\"" : "Брише се предлог „{title}”",
    "Successfully deleted proposal" : "Предлог је успешно обрисан",
    "Failed to delete proposal" : "Није успело брисање предлога",
    "Failed to retrieve proposals" : "Није успело преузимање предлога",
    "Meeting proposals" : "Предлози састанака",
    "A configured email address is required to use meeting proposals" : "Ако желите да користите предлоге састанака, морате имати подешену и-мејл адресу",
    "No active meeting proposals" : "Нема активних предлога састанака",
    "View" : "Погледај",
    ...
    "General" : "Опште",
    "Availability settings" : "Подешавања доступности",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Приступ Nextcloud календарима из осталих апликација и уређаја",
    "CalDAV URL" : "CalDAV URL",
    "Copy iOS/macOS CalDAV address" : "Копирај iOS/macOS CalDAV адресу",
    "Appearance" : "Изглед",
    "Birthday calendar" : "Календар рођендана",
    "Tasks in calendar" : "Задаци у календару",
    "Weekends" : "Викенди",
    "Week numbers" : "Бројеви седмица",
    "Limit number of events shown in Month view" : "Ограничи број догађаја који се виде у Месечном приказу",
    "Density in Day and Week View" : "Густина у Дневном и Седмичном приказу",
    "Editing" : "Уређивање",
    ...
    "Appointment schedule saved" : "Сачуван је распоред састанка",
    ...
    "Failed to apply Talk room." : "Није успело примењивање Talk собе.",
    "Error creating Talk conversation" : "Грешка при креирању Talk разговора",
    "Select a Talk Room" : "Изабери Talk собу",
    "Add Talk conversation" : "Додај Talk разговор",
    "Fetching Talk rooms…" : "Преузимају се Talk собе…",
    "No Talk room available" : "Није доступна ниједна Talk соба",
    "Create a new public conversation" : "Креирај нови јавни разговор",
    ...
    "You are about to download a file. Please check the file name before opening it. Are you sure to proceed?" : "Управо ћете да преузмете фајл. Молимо вас да пре отварања проверите име фајла. Да ли заиста желите да наставите?",
    ...
    "Availability will be checked" : "Провериће се доступност",
    "Invitation will be sent" : "Послаће се позивница",
    "Failed to check availability" : "Није успела провера доступности",
    "Failed to deliver invitation" : "Позивница није могла да се достави",
    ...
    "Suggested times" : "Предложена времена",
    ...
    "Previous date" : "Претходни датум",
    "Next date" : "Наредни датум",
    "Legend" : "Легенда",
    ...
    "Room name" : "Име собе",
    "Check room availability" : "Провери доступност собе",
    "Free" : "Слободан",
    ...
    "Search for emails, users, contacts, contact groups or teams" : "Претрага и-мејлова, корисника, контакта, група контаката или тимова",
    ...
    "Show all rooms" : "Прикажи све собе",
    "Projector" : "Пројектор",
    "Whiteboard" : "Табла",
    "Room type" : "Тип собе",
    "Any" : "Било који",
    ...
    "Remove date" : "Уклони датум",
    "Attendance required" : "Неопходно је присуство",
    "Attendance optional" : "Присуство није обавезно",
    ...
    "Create" : "Креирање",
    "No participants or dates available" : "Нема доступних учесника или датума",
    ...
    "These public calendars are suggested by the server administrator. Calendar data will be downloaded from the respective website." : "Администратор сервера предлаже ове јавне календаре. Подаци за календар ће се преузети са одговарајућег веб сајта.",
    ...
    "All day" : "Цео дан",
    "Modifications wont get propagated to the organizer and other attendees" : "Измене неће отићи организатору и осталим учесницима",
    "Managing shared access" : "Управљање дељеним приступом",
    "Deny access" : "Одбиј приступ",
    "Invite" : "Позив",
    "Discard changes?" : "Да одбацим измене?",
    "Are you sure you want to discard the changes made to this event?" : "Да ли заиста желите да одбаците измене које сте направили над овим догађајем?",
    ...
    "Saving proposal \"{title}\"" : "Чува се предлог „{title}”",
    "Successfully saved proposal" : "Предлог је успешно сачуван",
    "Failed to save proposal" : "Није успело чување предлога",
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "Да креирам састанак за „{date}”? Ово ће креирати догађај календара са свим учесницима.",
    ...
    "Failed to fetch free/busy data" : "Није успело преузимање података доступан/заузет",
    "Selected" : "Изабрано",
    "No Description" : "Без описа",
    "No Location" : "Без локације",
    "Edit this meeting proposal" : "Уреди овај предлог за састанак",
    ...
    "Selected times" : "Изабрана времена",
    "Previous span" : "Претходни опсег",
    "Next span" : "Наредни опсег",
    "Less days" : "Мање дана",
    "More days" : "Више дана",
    "Loading meeting proposal" : "Учитава се предлог састанка",
    "No meeting proposal found" : "Није пронађен ниједан предлог састанка",
    "Please wait while we load the meeting proposal." : "Сачекајте док се учитају предлози састанака.",
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "Линк који сте следили је можда неисправан, или тај предлог састанка више не постоји.",
    "Thank you for your response!" : "Хвала вам на одговору!",
    "Your vote has been recorded. Thank you for participating!" : "Ваш глас је забележен. Хвала вам што сте учествовали!",
    "Unknown User" : "Непознати корисник",
    "No Title" : "Без наслова",
    "No Duration" : "Без трајања",
    "Select a different time zone" : "Изаберите другу временску зону",
    "Submit" : "Пошаљи",
    "Subscribe to {name}" : "Претплати се на {name}",
    "Export {name}" : "Извези {name}",
    "Show availability" : "Прикажи доступност",
    ...
    "You are not allowed to edit this event as an attendee." : "Није вам дозвољено да уређујете овај догађај као учесник.",
    "W" : "С",
    "%n more" : "Још %n",
    ...
    "The visibility of this event in read-only shared calendars." : "Видљивост овог догађаја у календарима који су само-за-читање.",
    ...
    "Talk conversation for proposal" : "Talk разговор за предлог",
