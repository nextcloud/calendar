OC.L10N.register(
    ...
    "Travel" : "Путовање",
    "Vacation" : "Летовање",
    "Custom Categories" : "Произвољне категорије",
    "Collaborative Tags" : "Ознаке сарадње",
    "Standard Categories" : "Стандардне категорије",
    ...
    "You don't own this calendar, so you cannot add attendees to this event" : "Ово није ваш календар, тако да немате права да додате учеснике у овај догађај",
