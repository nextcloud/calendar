OC.L10N.register(
    ...
    "An error occurred, unable to change the unshare the calendar." : "Дошло је до грешке, није могуће да се прекине дељење календара",
    ...
    "Limit visible events per view" : "Ограничење догађаја који се виде у приказима",
    ...
    "Add reminder" : "Додвање подсетника",
    ...
    "from {startDate} at {startTime}" : "од {startDate} у {startTime}",
    "to {endDate}" : "до {endDate}",
    "to {endDate} at {endTime}" : "до {endDate} у {endTime}",
    "Repeat" : "Понављај",
    ...
    "Close" : "Затвори",
    "Show more details" : "Прикажи више детаља",
    ...
    "Office" : "Канцеларија",
    "Contributor week" : "Недеља сарадника",
    "Mail" : "поштом",
    "Soccer" : "Фудбал",
    "Football" : "Амерички фудбал",
    "Gaming" : "Играње",
    "Drive" : "Вожња",
    "Driving" : "Вожење",
    "Bicycle" : "Бицикл",
    ...
    "Hairdresser" : "Фризер",
    "Exam" : "Испит",
    "Written test" : "Писани тест",
    "Oral test" : "Усмени тест",
    "Working" : "Рад",
    "New Years Eve" : "Новогодишње вече",
    "NYE" : "Новогодишње вече",
    "Fireworks" : "Ватромет",
    "Running" : "Трчање",
    "Go for a run" : "Иди на трку",
    "Marathon" : "Маратон",
    "Video-conference" : "Видео конференција",
    "Conference-call" : "Конференцијски позив",
    "Video-call" : "Видо позив",
    "Video-chat" : "Видео чет",
    "Video-meeting" : "Видео састанак",
    "Call" : "Позив",
    "Calling" : "Позивање",
    "Christmas" : "Божић",
