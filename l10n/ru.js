OC.L10N.register(
    ...
    "Successfully imported {imported} objects" : "Успешно импортировано {imported} объектов",
    ...
    "Audio alarm {time} after the event starts" : "Звуковое оповещение за {time} после начала события",
    "Pop-up {time} after the event starts" : "Всплывающее напоминание за {time} после начала события",
    "Email {time} after the event starts" : "Сообщение по эл. почте за {time} после начала события",
    "None {time} after the event starts" : "Без оповещения за {time} после начала события",
    "{type} {time} after the event starts" : "{type} {time} после начала события",
    "Audio alarm {time} after the event ends" : "Звуковое оповещение за {time} после окончания события",
    "Pop-up {time} after the event ends" : "Всплывающее напоминание за {time} после окончания события",
