OC.L10N.register(
    ...
    "URL violates local access rules" : "Путь URL нарушает локальные правила доступа",
    ...
    "Please create a calendar first." : "Сначала создайте календарь.",
    ...
    "Download" : "Скачать",
    "Share with users, groups or circles" : "Поделиться с пользователями, группами или кругами",
    ...
    "Name" : "Название",
    "New Subscription" : "Создать подписку",
    "Go back" : "Назад",
    "Go forward" : "Вперед",
    ...
    "iOS/macOS CalDAV address" : "Адрес CalDAV для iOS и macOS ",
