OC.L10N.register(
    ...
    "The Calendar app is a user interface for Nextcloud's CalDAV server. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Currently Contacts - more to come.\n* 🌐 **WebCal Support!** Want to see your favorite team’s matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events.\n* 🙈 **We’re not reinventing the wheel!** Based on the great [davclient.js](https://github.com/evert/davclient.js), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "Приложение «Календарь» является пользовательским интерфейсом для CalDAV-сервера Nextcloud. Можно легко синхронизировать события с разных устройств с помощью Nextcloud и редактировать их в Интернете. * * 🚀 ** Интеграция с другими приложениями Nextcloud! ** В настоящее время Контакты - в будущем еще больше. * * * Поддержка WebCal! ** Хотите увидеть дни игр своей любимой команды в календаре? Нет проблем! * 🙋 ** Участники! ** Пригласите людей на свои мероприятия. * * 🙈 ** Мы не изобретаем колесо! ** Основано на следующих библиотеках [davclient.js] (https://github.com /evert/davclient.js), [ical.js] (https://github.com/mozilla-comm/ical.js) и [fullcalendar] (https://github.com/fullcalendar/fullcalendar).",
    ...
    "iOS/macOS CalDAV address" : "iOS/macOS CalDAV адрес",
