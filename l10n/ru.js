OC.L10N.register(
    ...
    "An error occurred during sending email" : "Произошла ошибка при отправке письма",
    ...
    "Requestor Comments:" : "Комментарии запрашивающего:",
    "Appointment Description:" : "Описание встречи:",
    ...
    "Dates:" : "Даты:",
    "[Proposed] %1$s" : "[Предлагаемое] %1$s",
    "Calendar App" : "Приложение Календарь",
    "Calendars App settings including proposals and appointments schedule configurations." : "Настройки приложения «Календари», включая предложения и настройки расписания встреч.",
    ...
    "Delegated to you by" : "Делегировано вам",
    ...
    "Calendar name can not be blank" : "Название календаря не может быть пустым",
    ...
    "Deck" : "Карточки",
    "Tasks" : "Задачи",
    "Delegated by {name} (read-only)" : "Делегировано вам {name} (только чтение)",
    "Delegated by {name}" : "Делегировано {name}",
    ...
    "can edit and see confidential events" : "может редактировать и просматривать конфиденциальные события",
    ...
    "This calendar supports neither events, tasks nor journal entries." : "Этот календарь не поддерживает ни события, ни задачи, ни записи журнала.",
    "_This calendar supports only {types}._::_This calendar supports {types}._" : ["Этот календарь поддерживает только {types}.","Этот календарь поддерживает {types}.","Этот календарь поддерживает {types}.","Этот календарь поддерживает {types}."],
    "None" : "Отсутствует",
    ...
    "Default reminder for part-day events" : "Напоминание по умолчанию о мероприятиях, продолжающихся неполный день",
    "Select default reminder" : "Выбрать напоминание по умолчанию",
    "Default reminder for full-day events" : "Напоминание по умолчанию о мероприятиях на целый день",
    "These reminders will be automatically added to new events created in this calendar" : "Эти напоминания будут автоматически добавлены к новым событиям, созданным в этом календаре",
    ...
    "Delete proposal" : "Удалить предложение",
    "Event legend" : "Легенда события",
    "Calendar events are styled to convey additional information at a glance." : "События календаря созданы для быстрого предоставления дополнительной информации.",
    "Free / Busy" : "Свободен / Занят",
    "Busy" : "Занят",
    "Busy: your time is marked as occupied" : "Занято: ваше время отмечено как занятое",
    "Free" : "Свободен",
    "Free: your time is still available" : "Свободно: ваше время ещё доступно",
    "Participation status" : "Статус участия",
    "Accepted" : "Принято",
    "Accepted: you confirmed your attendance" : "Принято: вы подтвердили своё участие",
    "Tentative" : "Под вопросом",
    "Tentative: your participation is uncertain" : "Предварительно: ваше участие сомнительно",
    "Invited" : "Приглашён",
    "Invited: you have not yet responded to this invitation" : "Приглашён: вы ещё не ответили на это приглашение",
    "Declined" : "Отклонён",
    "Declined: you declined this event" : "Отклонено: вы отклонили это мероприятие",
    "All declined" : "Все отклонены",
    "All declined: all participants declined" : "Все отклонены: все участники отклонены",
    "Icons" : "Значки",
    "Attendees" : "Участники",
    "This event has one or more attendees" : "В этом мероприятии присутствует один или несколько участников",
    "Past events" : "Прошедшие события",
    "Past event" : "Прошедшее событие",
    "Events that have already ended are shown with a more faded background" : "Уже закончившиеся события отображаются с более блеклым фоном",
    "Import destination selection" : "Импортировать выбранный пункт назначения",
    ...
    "Some calendars are disabled because this file contains {types}." : "Некоторые календари отключены, поскольку этот файл содержит файлы {types}.",
    ...
    "{email} will no longer be able to act on your behalf." : "{email} больше не сможет действовать от вашего имени.",
    "Revoke" : "Отозвать",
    "Viewer" : "Просмотр изображений",
    "Editor" : "Редактор",
    "Could not revoke access." : "Не удалось отозвать доступ.",
    "Access revoked successfully." : "Доступ успешно отозван.",
    "{name} can now view your calendars." : "{name} теперь может просматривать ваши календари.",
    "{name} can now act on your behalf." : "{name} теперь может действовать от вашего имени.",
    "Could not add delegate." : "Не удалось добавить делегата.",
    "Could not load delegates." : "Не удалось загрузить делегатов.",
    "Delegates" : "Делегаты",
    "Allow users to manage your calendar events and invitations on your behalf." : "Разрешить пользователям управлять событиями вашего календаря и приглашениями от вашего имени.",
    "Loading delegates…" : "Загрузка делегатов…",
    "Revoke access" : "Отозвать доступ",
    "No delegates yet." : "Делегатов пока нет.",
    "Add delegate" : "Добавить делегата",
    "Revoke access?" : "Отозвать доступ?",
    "Search for a user…" : "Поиск пользователя…",
    "No users found" : "Пользователи не найдены",
    "Choose whether they can view and edit events, or only view them." : "Выберите, смогут ли они просматривать и редактировать события или только просматривать их.",
    "Add as viewer" : "Добавить как зрителя",
    "Add as editor" : "Добавить как редактора",
    ...
    "Import calendar file" : "Импортировать файл календаря",
    ...
    "Density in Day and Week View" : "Плотность в режиме просмотра «День» и «Неделя»",
    ...
    "Public – shown on profile page" : "Публичный – отображается на странице профиля",
    "Private – only accessible via link" : "Частный – доступен только по ссылке",
    ...
    "Calendars to check for conflicts" : "Календари для проверки конфликтов",
    "Visibility" : "Видимость",
    "Booking availability" : "Доступность бронирования",
    "to" : "по",
    ...
    "Buffer before the event" : "Буфер перед событием",
    "Buffer after the event" : "Буфер после события",
    "Minimum time before next slot" : "Минимальное время до следующего слота",
    ...
    "Select existing conversation" : "Выбрать существующий разговор",
    "Select conversation" : "Выберите обсуждение",
    "Or create a new conversation" : "Или создать новый разговор",
    "Create public conversation" : "Создать открытое обсуждение",
    "Create private conversation" : "Создать приватный разговор",
    "on" : "в",
    "at" : "в",
    "Default reminder of calendar" : "Напоминание календаря по умолчанию",
    "Amount" : " Количество",
    "before at" : "ранее в",
    "Alarm date and time" : "Дата и время срабатывания будильника",
    ...
    "Proceed" : "Перейти",
    "Upload files as attachments" : "Прикрепить файлы во вложение",
    ...
    "Will be booked after saving, if available" : "Забронируется после сохранения, при наличии мест",
    ...
    "{name} (delegated by {delegator})" : "{name} (делегировано {delegator})",
    "Duration" : "Продолжительность",
    "15 minutes" : "15 минут",
    "30 minutes" : "30 минут.",
    "45 minutes" : "45 минут",
    ...
    "2 hours" : "2 часа",
    "Custom" : "Задать",
    "_{i} day_::_{i} days_" : ["{i} день","{i} дня","{i} дней","{i} дней"],
    "_{i} hour_::_{i} hours_" : ["{i} час","{i} часа","{i} часов","{i} часов"],
    "_{i} minute_::_{i} minutes_" : ["{i} минута","{i} минуты","{i} минут","{i} минут"],
    "Days" : "Дни",
    "Hours" : "Часы",
    "Minutes" : "Минуты",
    ...
    "Available time slots" : "Доступные временные интервалы",
    ...
    "Copy name and email address" : "Скопировать имя и адрес электронной почты",
    "Send email to {email}" : "Отправить электронное письмо на {email}",
    ...
    "Attendees copied to clipboard" : "Участники скопированы в буфер обмена",
    "Failed to copy attendees to clipboard" : "Не удалось скопировать участников в буфер обмена",
    "Copy attendees to clipboard" : "Скопировать участников в буфер обмена",
    ...
    "Search for attendees" : "Поиск участников",
    ...
    "Set repetition" : "Установить повторение",
    "never" : "никогда",
    "on date" : "в указанную дату",
    "after" : "после",
    "End repeat" : "Прекратить повтор",
    "End repeat date" : "Дата окончания повторения",
    ...
    "first" : "первый",
    "Week occurrence" : "Частота появления за неделю",
    ...
    "Repeat frequency" : "Частота повторения",
    ...
    "Search for resources" : "Поиск ресурсов",
    "Projector" : "Проектор",
    "Whiteboard" : "Доска",
    ...
    "Public calendar subscriptions selection" : "Выбор подписки на общедоступный календарь",
    ...
    "Contact your server administrator to resolve this issue." : "Обратитесь к администратору сервера, чтобы решить эту проблему.",
    ...
    "This booking link is no longer valid" : "Эта ссылка для бронирования больше не действительна",
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "Срок действия ссылки для подтверждения истёк или она уже использовалась. Пожалуйста, свяжитесь с организатором для перебронирования.",
    "Confirm your appointment" : "Подтвердите встречу",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "Не удалось подтвердить встречу. Пожалуйста, повторите попытку позже или свяжитесь с организатором.",
    ...
    "Allow forwarding" : "Разрешить переадресацию",
    ...
    "Detailed event editor" : "Подробный редактор событий",
    ...
    "{startDateTime} to {endTime}" : "{startDateTime} до {endTime}",
    "{startDateTime} to {endDateTime}" : "{startDateTime} до {endDateTime}",
    "{title}, All day: {timeDescription}" : "{title}, Весь день: {timeDescription}",
    "{title}, All day" : "{title}, Весь день",
    ...
    "Event link copied to clipboard" : "Ссылка на мероприятие скопирована в буфер обмена",
    "Failed to copy event link" : "Не удалось скопировать ссылку на мероприятие",
    ...
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "Не удалось загрузить делегированные календари. Убедитесь, что сервер поддерживает делегирование календаря.",
    ...
    "An error occured during sending email" : "Произошла ошибка при отправке письма",
    "%1$s - %2$s" : "%1$s - %2$s",
    "Calendars" : "Календари",
    "Hidden" : "Скрыто",
    "Calendar name …" : "Название календаря ...",
