OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Ваша встреча \"%s\" требует подтверждения",
    "Dear %s, please confirm your booking" : "Уважаемый %s, пожалуйста, подтвердите ваше бронирование",
    "Confirm" : "Подтвердить",
    "This confirmation link expires in %s hours." : "Срок действия этой ссылки для подтверждения истекает через %s часов.",
    "If you wish to cancel the appointment after all, please contact your organizer." : "Если вы хотите отменить встречу, пожалуйста, свяжитесь с организатором.",
    "Appointment:" : "Встреча:",
    "Date:" : "Дата:",
    "Where:" : "Место:",
    ...
    "Edit" : "Редактировать",
    "Delete" : "Удалить",
    "Appointment link was copied to clipboard" : "Ссылка Встречи была скопирована в буфер обмена",
    "Appointment link could not be copied to clipboard" : "Ссылка Встречи не может быть скопирована в буфер обмена",
    ...
    "Empty trash bin" : "Пустая корзина",
    ...
    "Participation marked as tentative." : "Участие под вопросом.",
    "Invitation sent." : "Приглашение отправлено.",
    "Has not responded to {organizerName}'s invitation yet." : "Ответ на приглашение от {organizerName} ещё не отправлено.",
