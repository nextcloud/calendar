OC.L10N.register(
    ...
    "Add holiday calendar" : "Добавить календарь праздников",
    ...
    "Global" : "Общие",
    "Holiday calendars" : "Календарь праздников",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Календари праздников предоставляются Thunderbird. Данные календаря будут загружены с {website}",
    "By {authors}" : "{authors}",
    "Subscribed" : "Подписано",
    "Subscribe" : "Подписаться",
    "Holidays in {region}" : "Праздники в {region}",
    "An error occurred, unable to create the holiday calendar." : "Произошла ошибка, не удалось создать календарь праздников.",
