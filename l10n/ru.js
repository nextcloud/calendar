OC.L10N.register(
    ...
    "Deleting share link …" : "Удаление общедоступной ссылки ...",
    ...
    "Search for e-mails, users, contacts, resources or rooms" : "Поиск адресов эл.почты, пользователей, контактов, ресурсов и комнат",
    ...
    "This event is the recurrence-exception of a recurrence-set. You can not add a recurrence-rule to it." : "Невозможно задать правила повторения этого события, так как оно является исключением из правил повтора исходного события.",
    "first" : "первый",
    "third" : "третий",
    "fourth" : "четвёртый",
    "fifth" : "пятый",
