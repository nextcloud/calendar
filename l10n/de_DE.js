OC.L10N.register(
    ...
    "Your appointment \"%s\" needs confirmation" : "Ihr Termin \"%s\" benötigt eine Bestätigung",
    "Dear %s, please confirm your booking" : "Sehr geehrte/r %s, bitte bestätigen die Terminbuchung",
    "Confirm" : "Bestätigen",
    "This confirmation link expires in %s hours." : "Dieser Bestätigungslink läuft in %s Stunden ab.",
    "If you wish to cancel the appointment after all, please contact your organizer." : "Wenn Sie den Termin doch noch absagen möchten, wenden Sie sich bitte an Ihren Organisator.",
    "Appointment:" : "Termin:",
    "Date:" : "Datum:",
    "Where:" : "Wo:",
    ...
    "Your appointment is booked" : "Ihr Termin ist gebucht",
    ...
    "The slot for your appointment from {startDate} to {endDate} is not available any more." : "Der Platz für Ihren Termin von {startDate} bis {endDate} ist nicht mehr verfügbar.",
