OC.L10N.register(
    ...
    "Date:" : "Datum:",
    "You will receive a link with the confirmation email" : "In der Bestätigungs-E-Mail erhalten Sie einen Link",
    "Where:" : "Wo:",
    "Comment:" : "Kommentar:",
    ...
    "Add holiday calendar" : "Feiertagskalender hinzufügen",
    ...
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Feiertagskalender werden von Thunderbird bereitgestellt. Kalenderdaten werden von {website} heruntergeladen",
    "By {authors}" : "Von {authors}",
    "Subscribed" : "Abonniert",
    "Subscribe" : "Abonnieren",
    "Holidays in {region}" : "Feiertage in {region}",
    "An error occurred, unable to create the holiday calendar." : "Es ist ein Fehler aufgetreten, der Feiertagskalender konnte nicht erstellt werden.",
