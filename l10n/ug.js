OC.L10N.register(
    ...
    "Calendar" : "يىلنامە",
    "New booking {booking}" : "يېڭى زاكاز {booking}",
    "{display_name} ({email}) booked the appointment \"{config_display_name}\" on {date_time}." : "{display_name} ({email}) {date_time} دا «{config_display_name}» تەيىنلەشنى زاكاس قىلدى.",
    "Appointments" : "تەيىنلەش",
    "Schedule appointment \"%s\"" : "ۋاقىت جەدۋىلى \"%s\"",
    "Schedule an appointment" : "ئۇچرىشىشنى ئورۇنلاشتۇرۇڭ",
    "Requestor Comments:" : "تەلەپ قىلغۇچى ئىنكاسلىرى:",
    "Appointment Description:" : "ئۇچۇرشىش چۈشەندۈرۈلىشى:",
    "Prepare for %s" : "%s ئۈچۈن تەييارلىق قىلىڭ",
    "Follow up for %s" : "%s غا ئەگىشىڭ",
    "Your appointment \"%s\" with %s needs confirmation" : "سىزنىڭ %s بىلەن \"%s\" ئۇچرىشىشىڭىز جەزملەشتۈرۈشكە موھتاج",
    ...
    "Create new" : "يېڭى قۇر",
    "Disable calendar \"{calendar}\"" : "كالېندار \"{calendar}\" نى چەكلەڭ",
    "Disable untitled calendar" : "نامسىز كالېندارنى چەكلەڭ",
    "Enable calendar \"{calendar}\"" : "كالېندار \"{calendar}\" نى قوزغىتىڭ",
    ...
    "_Items in the trash bin are deleted after {numDays} day_::_Items in the trash bin are deleted after {numDays} days_" : ["ئەخلەت ساندۇقىدىكى ئېلېمېنتلار {numDays} كۈندىن كېيىن ئۆچۈرۈلدى","ئەخلەت ساندۇقىدىكى ئېلېمېنتلار {numDays} كۈندىن كېيىن ئۆچۈرۈلدى"],
    ...
    "{teamDisplayName} (Team)" : "{teamDisplayName} (ئەتىرەت)",
    ...
    "can edit and see confidential events" : "مەخپىي پائالىيەتلەرنى كۆرەلەيدۇ ھەمدە تەھرىرلىيەلەيدۇ",
    ...
    "Save" : "ساقلا",
    "No title" : "ئۇنىۋانى يوق",
    "Are you sure you want to delete \"{title}\"?" : "\"{title}\" نى ئۆچۈرۈشنى جەزىملەشتۈرەمسىز؟",
    "Deleting proposal \"{title}\"" : "\"{title}\" تەكلىپنى ئۆچۈرۋاتىدۇ",
    "Successfully deleted proposal" : "تەكلىپ مۇۋەپپەقىيەتلىك ئۆچۈرۈلدى",
    "Failed to delete proposal" : "تەكلىپنى ئۆچۈرۈش مەغلۇپ بولدى",
    "Failed to retrieve proposals" : "تەكلىپنى چۈشۈرۈش مەغلۇپ بولدى",
    "Meeting proposals" : "يىغىن تەكلىپى",
    "A configured email address is required to use meeting proposals" : "يىغىن تەكلىپىنى ئىشلىتىش ئۈچۈن ئېلېكترونلۇق خەت ئادرېسىڭىز تەلەپ قىلىنىدۇ.",
    "No active meeting proposals" : "جانلىق يىغىن تەكلىپى يوق",
    "View" : "كۆرۈش",
    ...
    "Cancel" : "ۋاز كەچ",
    "_Import calendar_::_Import calendars_" : ["كالېندار ئەكىرىڭ","كالېندار ئەكىرىڭ"],
    ...
    "{filename} could not be parsed" : "{filename} تەھلىل قىلىشقا بولمايدۇ",
    "No valid files found, aborting import" : "ئۈنۈملۈك ھۆججەت تېپىلمىدى ، ئىمپورتنى ئەمەلدىن قالدۇردى",
    "_Successfully imported %n event_::_Successfully imported %n events_" : ["%n پائالىيەتلەر مۇۋاپىقىيەتلىك ئەكىرىلدى","%n پائالىيەتلەر مۇۋاپىقىيەتلىك ئەكىرىلدى"],
    "Import partially failed. Imported {accepted} out of {total}." : "ئىمپورت قىسمەن مەغلۇپ بولدى. {total} دىن {accepted} سى ئىمپورت قىلىندى.",
    "Automatic" : "ئاپتوماتىك",
    "Automatic ({timezone})" : "ئاپتوماتىك ({timezone})",
    ...
    "General" : "ئۇمۇمىي",
    "Availability settings" : "ھازىرلىق تەڭشەكلىرى",
    "CalDAV" : "CalDAV",
    "Access Nextcloud calendars from other apps and devices" : "Nextcloud يىلنامىسىگە باشقا ئەپ ياكى ئۈسكۈنىلەردىن كىرىڭ",
    "CalDAV URL" : "CalDAV URL",
    "Server Address for iOS and macOS" : " iOS and macOS لارنىڭ مۇلازىمېتىر ئادىرىسلىرى",
    "Appearance" : "كۆرۈنۈش",
    "Birthday calendar" : "تۇغۇلغان كۈن كالىندارى",
    "Tasks in calendar" : "كالېنداردىكى ۋەزىپىلەر",
    "Weekends" : "ھەپتە ئاخىرى",
    "Week numbers" : "ھەپتە نۇمۇرلىرى",
    "Limit number of events shown in Month view" : "ئايلىق كۆرۈنۈشتە كۆرسىتىلگەن پائالىيەت سانىنى چەكلەڭ",
    "Density in Day and Week View" : "كۈن ھەمدە ھەپتە كۆرۈنۈشىدىكى زىچلىق",
    "Editing" : "تەھرىرلەش",
    "Default reminder" : "كۆڭۈلدىكى ئەسكەرتىش",
    "Simple event editor" : "ئاددىي پائالىيەت تەھرىرلىگۈچى",
    "\"More details\" opens the detailed editor" : "\"تېخىمۇ تەپسىلىي\" تەپسىلىي تەھرىرلىگۈچنى ئاچىدۇ",
    "Files" : "ھۆججەتلەر",
    ...
    "0 minutes" : "0 مىنۇت",
    "_{duration} hour_::_{duration} hours_" : ["{duration} سائەت","{duration} سائەت"],
    "_{duration} day_::_{duration} days_" : ["{duration} كۈن","{duration} كۈن"],
    "_{duration} week_::_{duration} weeks_" : ["{duration} ھەپتە","{duration} ھەپتە"],
    "_{duration} month_::_{duration} months_" : ["{duration} ئاي","{duration} ئاي"],
    "_{duration} year_::_{duration} years_" : ["{duration} يىل","{duration} يىل"],
    ...
    "Appointment schedule saved" : "ئۇچۇرشىش پىلانى ساقلاندى",
    ...
    "Failed to apply Talk room." : "پاراڭ ئۈيىگە ئىلتىماس قىلىش مەغلۇپ بولدى",
    "Talk conversation for event" : "پائالىيەتنىڭ پاراڭ سۆھپىتى",
    "Error creating Talk conversation" : "پاراڭ سۆھپىتىنى قۇرۇشتا خاتالىق",
    "Select a Talk Room" : "پاراڭلىشىش ئۆيى تاللا",
    "Fetching Talk rooms…" : "پاراڭ ئۆيىنى چۈشۈرۋاتىدۇ...",
    "No Talk room available" : "پاراڭ ئۆيى بوش ئەمەس",
    "Select existing conversation" : "مەۋجۇت سۆھبەتنى تاللا",
    "Select conversation" : "سۆھبەتنى تاللا",
    "Or create a new conversation" : "ياكى يېڭى سۆھبەت قۇر",
    "Create public conversation" : "ئاممىۋىي پاراڭ قۇر",
    "Create private conversation" : "شەخسىي سۆھبەت قۇر",
    "on" : "دا",
    "at" : "دا",
    "before at" : "دىن بۇرۇن",
    ...
    "Could not upload attachment(s)" : "قوشۇمچە ھۆججەت(لەر)نى يۈكلىيەلمىدى",
    "You are about to navigate to {link}. Are you sure to proceed?" : "{link} نى زىيارەت قىلماقچى بولىۋاتىسىز. داۋاملاشتۇرامسىز؟",
    "You are about to navigate to {host}. Are you sure to proceed? Link: {link}" : "سىز {host} غا يۆتكىمەكچى بولۇۋاتىسىز. داۋاملاشتۇرامسىز؟ ئۇلىنىش: {link}",
    ...
    "Accepted {organizerName}'s invitation" : "{organizerName} نىڭ تەكلىپىنى قوبۇل قىلدى",
    ...
    "Declined {organizerName}'s invitation" : "رەت قىلىنغان {organizerName} نىڭ تەكلىپنامىسى",
    "Availability will be checked" : "بىكارلىقى تەكشۈرۈلدۇ",
    "Invitation will be sent" : "تەكلىپ يوللىندۇ",
    "Failed to check availability" : "بىكارلىقىنى تەكشۈرۈش مەغلۇپ بولدى",
    "Failed to deliver invitation" : "تەكلىپنى يەتكۈزۈش مەغلۇپ بولدى",
    "Awaiting response" : "جاۋاب كۈتۈش",
    "Checking availability" : "بار-يوقلۇقىنى تەكشۈرۈش",
    "Has not responded to {organizerName}'s invitation yet" : "{organizerName} نىڭ تەكلىپىگە تېخى جاۋاب بەرمىدى",
    "Suggested times" : "تەۋسىيە قىلىنغان ۋاقىتلار",
    "chairperson" : "رەئىس",
    "required participant" : "تەلەپچان قاتناشقۇچى",
    "non-participant" : "قاتناشمىغان",
    "optional participant" : "ئىختىيارى قاتناشقۇچى",
    "{organizer} (organizer)" : "{organizer} (تەشكىللىگۈچى)",
    "{attendee} ({role})" : "{attendee} ({role})",
    "Selected slot" : "ئورۇننى تاللاڭ",
    "Availability of attendees, resources and rooms" : "قاتناشقۇچىلار ، بايلىق ۋە ياتاقلار",
    "Suggestion accepted" : "تەكلىپ قوبۇل قىلىندى",
    "Previous date" : "ئالدىنقى چېسلا",
    "Next date" : "كېيىنكى چېسلا",
    "Legend" : "رىۋايەت",
    ...
    "{confirmedCount} confirmed, {waitingCount} awaiting response" : "{confirmedCount} جەزىملەشتۈرۈلدى، {waitingCount} جاۋاپ ساقلاۋاتىدۇ",
    "Please add at least one attendee to use the \"Find a time\" feature." : "\"ۋاقىت ئىزدە\" ئىقتىدارىنى ئىشلىتىش ئۈچۈن ئەڭ كەمدە بىر قاتناشقۇچى تاللاڭ.",
    "Attendees" : "قاتناشقۇچىلار",
    "_%n more attendee_::_%n more attendees_" : ["يەنە %n قاتناشقۇچى","يەنە %n قاتناشقۇچى"],
    ...
    "Optional participant" : "ئىختىيارى قاتناشقۇچى",
    "Non-participant" : "قاتناشمىغان",
    "_%n member_::_%n members_" : ["%n ئەزا","%n ئەزا"],
    "Search for emails, users, contacts, contact groups or teams" : "ئېلخەت، ئىشلەتكۈچى، ئالاقىداش، ئالاقىداش گۇرۇپپا ياكى ئەتىرەت ئىزدە",
    ...
    "Note that members of contact groups get invited but are not synced yet." : "ئالاقە گۇرۇپپىلىرىنىڭ ئەزالىرى تەكلىپ قىلىنىدىغانلىقىغا، ئەمما ھازىرغىچە ماسلاشتۇرۇلمىغانلىقىغا دىققەت قىلىڭ.",
    "(organizer)" : "(تەشكىللىگۈچى)",
    "Make {label} the organizer" : "{label} تەشكىللىگۈچى",
    "Make {label} the organizer and attend" : "{label} تەشكىللىگۈچى ۋە قاتنىشىڭ",
    ...
    "Your Time" : "ۋاقتىڭىز",
    "Repeat" : "قايتىلا",
    "Repeat event" : "پائالىيەتنى تەكرارلا",
    ...
    "Resources" : "بايلىق",
    "_{seatingCapacity} seat_::_{seatingCapacity} seats_" : ["{seatingCapacity} ئورۇن","{seatingCapacity} ئورۇن"],
    ...
    "Remove date" : "چېسلانى ئۆچۈر",
    "Attendance required" : "قاتنىشىش تەلەپ قىلىندۇ",
    "Attendance optional" : "قاتنىشىش ئىختىيارى",
    "Remove participant" : "قاتناشقۇچىنى ئېلىۋېتىڭ",
    "Yes" : "ھەئە",
    "No" : "ياق",
    "Maybe" : "مۇمكىن",
    "None" : "يوق",
    "Select your meeting availability" : "كۆرۈشۈش ۋاقتىڭىزنى تاللاڭ",
    "Create a meeting for this date and time" : "مۇشۇ كۈن ھەم ۋاقىتتا بىر يىغىن قۇر",
    "Create" : "قۇر",
    "No participants or dates available" : "قاتناشقۇچى ياكى چىسلا يوق",
    "from {formattedDate}" : "from {formattedDate}",
    "to {formattedDate}" : "to {formattedDate}",
    "on {formattedDate}" : "on {formattedDate}",
    "from {formattedDate} at {formattedTime}" : "{formattedDate} دىن {formattedTime} دا",
    "to {formattedDate} at {formattedTime}" : "{formattedDate} دىكى {formattedTime}غا ",
    "on {formattedDate} at {formattedTime}" : "{formattedDate} دىكى {formattedTime}دا",
    ...
    "Global" : "ئۇمۇمىي",
    "Holidays in {region}" : "{region} دا دەم ئېلىش",
    ...
    "Public holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "ئاممىۋى دەم ئېلىش كالېندارىنى Thunderbird تەمىنلەيدۇ. كالېندار سانلىق مەلۇماتلىرى {website} دىن چۈشۈرۈلىدۇ",
    "These public calendars are suggested by the server administrator. Calendar data will be downloaded from the respective website." : "بۇ ئاممىۋى كالېندارلار مۇلازىمېتىر باشقۇرغۇچىسى تەرىپىدىن تەۋسىيە قىلىنىدۇ. كالېندار سانلىق مەلۇماتلىرى ئايرىم تور بېكەتتىن چۈشۈرۈلىدۇ.",
    "By {authors}" : "{authors}",
    ...
    "Book an appointment with {name}" : "{name} بىلەن ئۇچرىشىشنى زاكاز قىلىڭ",
    "No public appointments found for {name}" : "{name} ئۈچۈن ئاممىۋى ئۇچرىشىش تېپىلمىدى",
    "Personal" : "شەخسىي",
    ...
    "Discard event" : "پائالىيەتنى تاشلىۋەت",
    ...
    "All day" : "پۈتۈن كۈن",
    "Modifications wont get propagated to the organizer and other attendees" : "ئۆزگەرتىشلەر تەشكىللىگۈچى ۋە باشقا قاتناشقۇچىلارغا تارقىتىلمايدۇ",
    "Add Talk conversation" : "پاراڭ سۆھپىتى قوش",
    ...
    "Are you sure you want to discard the changes made to this event?" : "بۇ پائالىيەتكە كىرگۈزۈلگەن ئۆزگەرتىشلەرنى راستىنلا بىكار قىلماقچىمۇ؟",
    "_User requires access to your file_::_Users require access to your file_" : ["ئىشلەتكۈچىلەر سىزنىڭ ھۆججىتىڭىزگە كىرىشنى تەلەپ قىلىدۇ","ئىشلەتكۈچىلەر سىزنىڭ ھۆججىتىڭىزگە كىرىشنى تەلەپ قىلىدۇ"],
    "_Attachment requires shared access_::_Attachments requiring shared access_" : ["ئورتاق كىرىشنى تەلەپ قىلىدىغان يوللانمىلار","ئورتاق كىرىشنى تەلەپ قىلىدىغان يوللانمىلار"],
    ...
    "Update meeting proposal" : "يىغىن تەكلىپىنى يېڭىلا",
    "Saving proposal \"{title}\"" : "تەكلىپ \"{title}\" نى ساقلاۋاتىدۇ",
    "Successfully saved proposal" : "تەكلىپ مۇۋەپپەقىيەتلىك ساقلاندى",
    "Failed to save proposal" : "تەكلىپنى ساقلاش مەغلۇپ بولدى",
    "Create a meeting for \"{date}\"? This will create a calendar event with all participants." : "«{date}» ئۈچۈن يىغىن قۇرامسىز؟ بۇ بارلىق قاتناشقۇچىلارنى ئۆز ئىچىگە ئالغان كالېندار پائالىيىتىنى قۇرىدۇ.",
    ...
    "Failed to fetch free/busy data" : "بىكار/ئالدىراش ئۇچۇرنى چۈشۈرۈش مەغلۇپ بولدى",
    "Selected" : "تاللانغان",
    "No Description" : "چۈشەندۈرۈش يوق",
    "No Location" : "ئورۇن يوق",
    "Edit this meeting proposal" : "يىغىن تەكلىپىنى تەھرىرلە",
    "Delete this meeting proposal" : "يىغىن تەكلىپىنى ئۆچۈر",
    "Title" : "ماۋزۇ",
    "15 min" : "15 مىنۇت",
    "30 min" : "30 مىنۇت",
    "60 min" : "60 مىنۇت",
    ...
    "Selected times" : "تاللانغان ۋاقىتلار",
    "Previous span" : "ئالدىنقى دائىرە",
    "Next span" : "كىيىنكى دائىرە",
    "Less days" : "ئاز كۈن",
    "More days" : "جىق كۈن",
    "Loading meeting proposal" : "يىغىن تەكلىپىنى يۈكلەۋاتىدۇ",
    "No meeting proposal found" : "يىغىن تەكلىپى تېپىلمىدى",
    "Please wait while we load the meeting proposal." : "بىز يىغىن تەكلىپىنى يۈكلەۋاتقاندا بىر ئاز ساقلاڭ.",
    "The link you followed may be broken, or the meeting proposal may no longer exist." : "سىز ئەگەشكەن ئۇلىنىش ئۈزۈلۈپ قالغان بولۇشى ياكى يىغىن تەكلىپى مەۋجۇت بولماسلىقى مۇمكىن.",
    "Thank you for your response!" : "جاۋابىڭىزغا رەھمەت!",
    "Your vote has been recorded. Thank you for participating!" : "بېلىتىڭىز ساقلاندى. قاتناشقىنىڭىزغا رەھمەت!",
    "Unknown User" : "نامەلۇم ئىشلەتكۈچى",
    "No Title" : "ئۇنىۋانى يوق",
    "No Duration" : "ئۇزۇنلۇقى يوق",
    "Select a different time zone" : "باشقا ۋاقىت رايونىنى تاللا",
    "Submit" : "يوللاڭ",
    "Subscribe to {name}" : "{name} غا مۇشتەرى بولۇڭ",
    "Export {name}" : "چىقىرىش {name}",
    "Show availability" : "بىكارلىقنى كۆرسەت",
    ...
    "_%n day before the event at {formattedHourMinute}_::_%n days before the event at {formattedHourMinute}_" : ["{formattedHourMinute} دىكى پائالىيەتتىن %n كۈن بۇرۇن","{formattedHourMinute} دىكى پائالىيەتتىن %n كۈن بۇرۇن"],
    "_%n week before the event at {formattedHourMinute}_::_%n weeks before the event at {formattedHourMinute}_" : ["{formattedHourMinute} دىكى پائالىيەتتىن %n ھەپتە بۇرۇن","{formattedHourMinute} دىكى پائالىيەتتىن %n ھەپتە بۇرۇن"],
    "on the day of the event at {formattedHourMinute}" : "{formattedHourMinute} دىكى پائالىيەت كۈنىدە",
    "at the event's start" : "پائالىيەت باشلانغاندا",
    "at the event's end" : "پائالىيەت ئاخىرلاشقاندا",
    "{time} before the event starts" : "پائالىيەت باشلىنىشتىن بۇرۇن {time}",
    "{time} before the event ends" : "پائالىيەت ئاخىرلىشىشتىن بۇرۇن {time}",
    "{time} after the event starts" : "پائالىيەت باشلانغاندىن كېيىن {time}",
    "{time} after the event ends" : "پائالىيەت ئاخىرلاشقاندىن كېيىن {time}",
    "on {time}" : "{time} دا",
    "on {time} ({timezoneId})" : "{time} دا ({timezoneId})",
    "Week {number} of {year}" : "{year} نىڭ {number} ھەپتىسى",
    "Daily" : "كۈندىلىك",
    "Weekly" : "ھەپتىلىك",
    "Monthly" : "ئايلىق",
    "Yearly" : "يىللىق",
    ...
    "You are not allowed to edit this event as an attendee." : "سىز بىر قاتناشقۇچى سۈپىتىدە بۇ پائالىيەتنى تەھرىرلەشكە يول قۇيۇلمايسىز.",
    "W" : "ھ.",
    "%n more" : "%n تېخىمۇ كۆپ",
    "No events to display" : "كۆرسىتىدىغان ھېچقانداق ھادىسە يوق",
    "All participants declined" : "ھەممە قاتناشقۇچى رەت قىلدى",
    "Please confirm your participation" : "قاتنىشىدىغانلىقىڭىزنى جەزىملەڭ",
    "You declined this event" : "سىز بۇ پائالىيەتنى رەت قىلدىڭىز",
    "Your participation is tentative" : "قاتنىشىشىڭىز ئېنىقسىز",
    "_+%n more_::_+%n more_" : ["%n+ كۆپ","%n+ كۆپ"],
    ...
    "The visibility of this event in read-only shared calendars." : "بۇ پائالىيەتنىڭ كۆرۈنۈشچانلىقى ئوقۇشقىلا-بولىدىغان ئورتاق يىلنامىدە.",
    "Add a location" : "ئورۇن قوشۇڭ",
    "Add a description\n\n- What is this meeting about\n- Agenda items\n- Anything participants need to prepare" : "چۈشەندۈرۈش قوشۇڭ\n\n- بۇ يىغىن نېمە ھەققىدە\n- كۈنتەرتىپ تۈرلىرى\n- قاتناشقۇچىلارنىڭ تەييارلىشى كېرەك بولغان ھەر قانداق نەرسە",
    "Status" : "ھالەت",
    ...
    "Error creating a folder {folder}" : "قىسقۇچ {folder} نى قۇرۇش خاتالىقى",
    "Attachment {fileName} already exists!" : "قوشۇمچە ھۆججەت {fileName} مەۋجۇت!",
    "Attachment {fileName} added!" : "يوللانما {fileName} قوشۇلدى!",
    "An error occurred during uploading file {fileName}" : "ھۆججەت {fileName} نى چىقىرۋاتقاندا بىر خاتالىق كۆرۈلدى",
    "An error occurred during getting file information" : "ھۆججەت ئۇچۇرىغا ئېرىشىش جەريانىدا خاتالىق كۆرۈلدى",
    "Talk conversation for proposal" : "تەكلىپنىڭ پاراڭ سۆھپىتى",
    "An error occurred, unable to delete the calendar." : "كالېندارنى ئۆچۈرەلمەي خاتالىق كۆرۈلدى.",
    "Imported {filename}" : "{filename} ئىمپورت قىلىندى",
    ...
    "Create a new public conversation" : "يېڭى بىر ئاممىۋى سۆھبەت قۇر",
    "{invitedCount} invited, {confirmedCount} confirmed" : "{invitedCount} تەكلىپ قىلىنغان ، {confirmedCount} جەزملەشتۈرۈلگەن",
    ...
    "_%n more guest_::_%n more guests_" : ["يەنە %n مىھمانلار","يەنە %n مىھمانلار"],
