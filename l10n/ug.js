OC.L10N.register(
    ...
    "{filename} could not be parsed" : "{filename} ئىسمى} تەھلىل قىلىشقا بولمايدۇ",
    "No valid files found, aborting import" : "ئۈنۈملۈك ھۆججەت تېپىلمىدى ، ئىمپورتنى ئەمەلدىن قالدۇردى",
    "Import partially failed. Imported {accepted} out of {total}." : "ئىمپورت قىسمەن مەغلۇپ بولدى. {accepted} دىن ئىمپورت قىلىنغان {total} قىلىندى}.",
    ...
    "Accepted {organizerName}'s invitation" : "{organizerName} ئىسمى} نىڭ تەكلىپىنى قوبۇل قىلدى",
    ...
    "Declined {organizerName}'s invitation" : "رەت قىلىنغان {organizerName} ئىسمى} نىڭ تەكلىپنامىسى",
    ...
    "from {formattedDate} at {formattedTime}" : "{formattedDate} ۋاقىت} دىن {formattedTime} ۋاقىت} دىن",
    "to {formattedDate} at {formattedTime}" : "{formattedDate} ۋاقىت} دىكى {formattedTime} ۋاقىت}",
    "on {formattedDate} at {formattedTime}" : "{formattedDate} ۋاقىت} دىكى {formattedTime} ۋاقىت}",
    ...
    "Global" : "Global",
    "Holidays in {region}" : "{region} دەم ئېلىش}",
    ...
    "on the day of the event at {formattedHourMinute}" : "پائالىيەت كۈنى {formattedHourMinute} HourMinute} دىكى",
    ...
    "{invitedCount} invited, {confirmedCount} confirmed" : "{invitedCount} قىلىنغان سان} تەكلىپ قىلىنغان ، {confirmedCount} سان} جەزملەشتۈرۈلگەن",
