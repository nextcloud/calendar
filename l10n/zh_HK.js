OC.L10N.register(
    ...
    "Global" : "全球",
    "Holiday calendars" : "假期日曆",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "假期日曆由 Thunderbird 提供。將從 {website} 下載日曆數據",
    "By {authors}" : "作者 {authors}",
    "Subscribed" : "已訂閱",
    "Subscribe" : "訂閱",
    "Holidays in {region}" : "{region} 的假期",
    "An error occurred, unable to create the holiday calendar." : "發生錯誤，無法創建假期日曆。",
    "Select date" : "選擇日期",
    "Select slot" : "選擇時段",
