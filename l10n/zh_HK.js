OC.L10N.register(
    ...
    "%1$s responded to your meeting proposal \"%2$s\"" : "%1$s 已回覆你的會議提議「%2$s」",
    "{participant} responded to your meeting proposal {proposal}" : "{participant} 已回覆你的會議提議 {proposal}",
    "Appointments" : "預約",
    ...
    "Delegated to you by" : "由以下使用者委派給你",
    ...
    "Calendar name can not be blank" : "日曆名稱不能為空白",
    ...
    "Disable alarm notifications for this calendar" : "停用此日曆的提醒通知",
    "Default reminder for part-day events" : "部分日活動的預設提醒",
    "Select default reminder" : "選擇默認提醒",
    "Default reminder for full-day events" : "全日活動的預設提醒",
    "These reminders will be automatically added to new events created in this calendar" : "這些提醒將自動加入此日曆中新建立的活動",
    "Share calendar" : "分享日曆",
    ...
    "Event legend" : "活動圖例",
    "Calendar events are styled to convey additional information at a glance." : "日曆活動會以不同樣式顯示，方便一眼辨識額外資訊。",
    "Free / Busy" : "空閒／忙碌",
    "Busy" : "忙碌",
    "Busy: your time is marked as occupied" : "忙碌：你的時間會標示為已被佔用",
    "Free" : "有空",
    "Free: your time is still available" : "空閒：你的時間仍可供安排",
    "Participation status" : "參與狀態",
    "Accepted" : "接納",
    "Accepted: you confirmed your attendance" : "已接受：你已確認出席",
    "Tentative" : "暫定",
    "Tentative: your participation is uncertain" : "暫定：你的參與狀態尚未確定",
    "Invited" : "已邀請",
    "Invited: you have not yet responded to this invitation" : "已邀請：你尚未回覆此邀請",
    "Declined" : "已拒絕",
    "Declined: you declined this event" : "已拒絕：你已拒絕此活動",
    "All declined" : "全部已拒絕",
    "All declined: all participants declined" : "全部已拒絕：所有參加者均已拒絕",
    "Icons" : "圖示",
    "Attendees" : "參與者",
    "This event has one or more attendees" : "此活動有一位或以上參加者",
    "Past events" : "過往活動",
    "Past event" : "過往活動",
    "Events that have already ended are shown with a more faded background" : "已結束的活動會以較淡的背景顯示",
    ...
    "Some calendars are disabled because this file contains {types}." : "部分日曆已停用，因為此檔案包含 {types}。",
    ...
    "{email} will no longer be able to act on your behalf." : "{email} 將無法再代表你執行操作。",
    "Revoke" : "撤銷",
    "Viewer" : "檢視器",
    "Editor" : "編輯器",
    "Could not revoke access." : "無法撤銷存取權限。",
    "Access revoked successfully." : "已成功撤銷存取權限。",
    "{name} can now view your calendars." : "{name} 現可檢視你的日曆。",
    "{name} can now act on your behalf." : "{name} 現可代表你執行操作。",
    "Could not add delegate." : "無法新增受委派者。",
    "Could not load delegates." : "無法載入受委派者。",
    "Delegates" : "受委派者",
    "Allow users to manage your calendar events and invitations on your behalf." : "允許使用者代表你管理日曆活動及邀請。",
    "Loading delegates…" : "正在載入受委派者……",
    "Revoke access" : "撤銷存取權限",
    "No delegates yet." : "尚未有受委派者。",
    "Add delegate" : "新增委派使用者",
    "Revoke access?" : "撤銷存取權限？",
    "Search for a user…" : "搜尋使用者……",
    "No users found" : "找不到用戶",
    "Choose whether they can view and edit events, or only view them." : "選擇他們可檢視及編輯活動，或只可檢視活動。",
    ...
    "Show declined appointments" : "顯示被婉拒的預約",
    "Weekends" : "週末",
    "Week numbers" : "週數",
    ...
    "Public – shown on profile page" : "公開－顯示於個人檔案頁面",
    ...
    "Calendars to check for conflicts" : "用作檢查衝突的日曆",
    "Visibility" : "可見性",
    "Booking availability" : "可預約時段",
    "to" : "至",
    "Delete slot" : "刪除時段",
    "No times set" : "尚未設置時間",
    "Add" : "添加",
    ...
    "Buffer before the event" : "活動前緩衝時間",
    "Buffer after the event" : "活動後緩衝時間",
    "Minimum time before next slot" : "下一時段前的最短間隔時間",
    ...
    "on" : "在",
    "at" : "在",
    "Default reminder of calendar" : "默認日曆提醒",
    "Amount" : "數量",
    "before at" : "之前於",
    "Alarm date and time" : "提醒日期及時間",
    "Notification" : "通告",
    "Email" : "電子郵件",
    ...
    "Proceed" : "進行",
    "Upload files as attachments" : "上載檔案作為附件",
    "No attachments" : "無附件",
    ...
    "Will be booked after saving, if available" : "如有空位，將於儲存後預訂",
    ...
    "Find a time" : "找一個時間",
    "Accept this occurrence" : "接受此次活動",
    "Accept entire series" : "接受整個系列",
    "Accept" : "接受",
    "Decline this occurrence" : "拒絕此次活動",
    "Decline entire series" : "拒絕整個系列",
    "Decline" : "婉拒",
    "Tentative for this occurrence" : "暫定參加此次活動",
    "Tentative for entire series" : "暫定參加整個系列",
    ...
    "Optional participant" : "可不出席的參與者",
    "Non-participant" : "非參與者",
    "Attendees copied to clipboard" : "已複製與會者到剪貼板",
    "Failed to copy attendees to clipboard" : "無法複製與會者至剪貼板",
    "Send email to all attendees" : "發送電郵給參加者",
    "Copy attendees to clipboard" : "複製與會者至剪貼板",
    ...
    "Rooms" : "會議室",
    "Search rooms" : "搜尋會議室",
    "Name, building or room number" : "名稱、大樓或房間號碼",
    "Building" : "建築物",
    "Floor" : "樓層",
    "Minimum capacity" : "最低容納人數",
    "Features" : "功能",
    "Checking availability…" : "正在檢查可用情況…",
    "No rooms match the filters" : "沒有符合篩選條件的會議室",
    "No rooms found" : "找不到會議室",
    "Clear filters" : "清除過濾器",
    "More details" : "更多細節",
    "Update entire series" : "更新整個系列",
    "Update this and future occurrences" : "更新此次及之後的活動",
    ...
    "Contact your server administrator to resolve this issue." : "請聯絡你的伺服器管理員以解決此問題。",
    ...
    "The confirmation link has expired or has already been used. Please contact the organizer to rebook." : "確認連結已過期或已被使用。請聯絡主辦者重新預約。",
    "Confirm your appointment" : "確認你的預約",
    "Could not confirm the appointment. Please try again later or contact the organizer." : "無法確認預約。請稍後再試或聯絡主辦者。",
    ...
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "選擇「只有受邀參加者可回覆」以防止參加者將邀請轉寄他人。",
    "Detailed event editor" : "詳細活動編輯器",
    "Event does not exist" : "活動不存在",
    "Delete this occurrence" : "刪除此次活動",
    "Delete this and future occurrences" : "刪除此次及之後的活動",
    ...
    "{startDateTime} to {endTime}" : "{startDateTime} 至 {endTime}",
    "{startDateTime} to {endDateTime}" : "{startDateTime} 至 {endDateTime}",
    "{title}, All day: {timeDescription}" : "{title}，全日：{timeDescription}",
    "{title}, All day" : "{title}，全日",
    ...
    "Event link copied to clipboard" : "活動連結已複製到剪貼簿",
    "Failed to copy event link" : "無法複製活動連結",
    "It might have been deleted, or there was a typo in the link" : "其可能已經被刪除，或是連結中有錯字",
    "Meeting room" : "會議室",
    "Lecture hall" : "講課廳",
    "Seminar room" : "研討室",
    "Other" : "其它",
    "Audio-visual equipment" : "影音設備",
    "Phone" : "電話",
    ...
    "This meeting proposal no longer exists" : "此會議提議已不存在",
    "Failed to open meeting proposal" : "無法開啟會議提議",
    ...
    "We noticed that you adjusted the date or time. Since this is not the first occurrence of the series, the date/time changes have been discarded. To change the date or time of the whole series, please edit the first occurrence." : "我們留意到你調整了日期或時間。由於這並非系列中的首次活動，日期或時間的變更已捨棄。如要更改整個系列的日期或時間，請編輯首次活動。",
    "An error occurred, unable to delete the calendar." : "發生錯誤，無法刪除日曆",
    "Imported {filename}" : "匯入的 {filename}",
    "Could not load delegated calendars. Make sure the server supports calendar delegation." : "無法載入已委派的日曆。請確定伺服器支援日曆委派。",
