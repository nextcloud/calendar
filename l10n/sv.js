OC.L10N.register(
    ...
    "Appointment Description:" : "Mötesbeskrivning:",
    ...
    "Calendars App settings including proposals and appointments schedule configurations." : "Inställningar för Kalender-appen, inklusive förslag och konfiguration av möten.",
    "A Calendar app for Nextcloud" : "En kalender-app för Nextcloud",
    "A Calendar app for Nextcloud. Easily sync events from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Like Contacts, Talk, Tasks, Deck and Circles\n* 🌐 **WebCal Support!** Want to see your favorite team's matchdays in your calendar? No problem!\n* 🙋 **Attendees!** Invite people to your events\n* ⌚ **Free/Busy!** See when your attendees are available to meet\n* ⏰ **Reminders!** Get alarms for events inside your browser and via email\n* 🔍 **Search!** Find your events at ease\n* ☑️ **Tasks!** See tasks or Deck cards with a due date directly in the calendar\n* 🔈 **Talk rooms!** Create an associated Talk room when booking a meeting with just one click\n* 📆 **Appointment booking** Send people a link so they can book an appointment with you [using this app](https://apps.nextcloud.com/apps/appointments)\n* 📎 **Attachments!** Add, upload and view event attachments\n* 🙈 **We’re not reinventing the wheel!** Based on the great [c-dav library](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) and [fullcalendar](https://github.com/fullcalendar/fullcalendar) libraries." : "En kalenderapp för Nextcloud. Synkronisera enkelt händelser från olika enheter med din Nextcloud och redigera dem online.\n\n* 🚀 **Integration med andra Nextcloud-appar!** Som Kontakter, Talk, Uppgifter, Deck och Circles\n* 🌐 **Stöd för WebCal!** Vill du se ditt favoritlags matchdagar i din kalender? Inga problem!\n* 🙋 **Deltagare!** Bjud in personer till dina händelser\n* ⌚ **Ledig/upptagen!** Se när dina deltagare är tillgängliga för möten\n* ⏰ **Påminnelser!** Få påminnelser om händelser i din webbläsare och via e-post\n* 🔍 **Sök!** Hitta dina händelser enkelt\n* ☑️ **Uppgifter!** Se uppgifter eller Deck-kort med förfallodatum direkt i kalendern\n* 🔈 **Chattrum!** Skapa ett tillhörande chattrum när du bokar ett möte med bara ett klick\n* 📆 **Tidsbokning** Skicka en länk till andra så att de kan boka en tid med dig [med hjälp av den här appen](https://apps.nextcloud.com/apps/appointments)\n* 📎 **Bilagor!** Lägg till, ladda upp och visa bilagor till evenemang\n* 🙈 **Vi uppfinner inte hjulet på nytt!** Baserat på de fantastiska biblioteken [c-dav](https://github.com/nextcloud/cdav-library), [ical.js](https://github.com/mozilla-comm/ical.js) och [fullcalendar](https://github.com/fullcalendar/fullcalendar).\n\n\nTranslated with DeepL.com (free version)",
    ...
    "Default reminder for part-day events" : "Standardpåminnelse för deldagshändelser",
    ...
    "Failed to delete proposal" : "Kunde inte ta bort förslaget",
    "Failed to retrieve proposals" : "Kunde inte hämta förslag",
    ...
    "Booking availability" : "Bokningstillgänglighet",
    "to" : "till",
    ...
    "Buffer before the event" : "Buffert före händelsen",
    "Buffer after the event" : "Buffert efter händelsen",
    "Minimum time before next slot" : "Minsta tid före nästa lucka",
    ...
    "You are about to navigate to {link}. Are you sure to proceed?" : "Du är på väg att navigera till {link}. Är du säker på att du vill fortsätta?",
    ...
    "Failed to copy attendees to clipboard" : "Kunde inte kopiera deltagare till urklipp",
    ...
    "Search for emails, users, contacts, contact groups or teams" : "Sök efter e-post, användare, kontakter, kontaktgrupper eller team",
    ...
    "Attendance optional" : "Närvaro frivillig",
    ...
    "This booking link is no longer valid" : "Denna bokningslänk är inte längre giltig",
    ...
    "Only invited attendees can respond" : "Bara inbjudna deltagare kan svara",
    "Choose \"Only invited attendees can respond\" to prevent attendees from forwarding the invitation to others." : "Välj \"Bara inbjudna deltagare kan svara\" för att förhindra att deltagare vidarebefordrar inbjudan till andra.",
    ...
    "Invite" : "Bjud in",
    "Discard changes?" : "Avbryt ändringar?",
    "Are you sure you want to discard the changes made to this event?" : "Är du säker på att du vill avbryta ändringarna som gjorts i denna händelse?",
    ...
    "Failed to save proposal" : "Kunde inte spara förslaget",
    "Please enter a valid duration in minutes." : "Ange en giltig varaktighet i minuter.",
    "Failed to fetch proposals" : "Kunde inte hämta förslag",
    "Creating meeting for {date}" : "Skapar möte för {date}",
    "Successfully created meeting for {date}" : "Möte har skapats för {date}",
    "Failed to create a meeting for {date}" : "Kunde inte skapa möte för {date}",
    "Failed to fetch free/busy data" : "Kunde inte hämta ledig/upptagen-data",
    "Selected" : "Vald",
    ...
    "Event link copied to clipboard" : "Händelselänk kopierad till urklipp",
    "Failed to copy event link" : "Kunde inte kopiera händelselänk",
    ...
    "Attachment {fileName} added!" : "Bilaga {fileName} tillagd!",
    "An error occurred during uploading file {fileName}" : "Ett fel uppstod vid uppladdning av filen {fileName}",
