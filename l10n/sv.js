OC.L10N.register(
    ...
    "The remote server did not give us access to the calendar (HTTP {%s} error)" : "Fjärrservern gav inte åtkomst när vi försökte ansluta till kalendern (HTTP {%s} error)",
    "Error connecting to remote server" : "Ett fel uppstod med anslutningen till fjärrservern",
    "Error requesting resource on remote server. This could possible be related to a certificate mismatch" : "Ett fel uppstod när en resurs på fjärrservern skulle begäras. Detta kan vara relaterat till ett certifikat som inte matchar",
    "Error requesting resource on remote server" : "Ett fel uppstod när en resurs på fjärrservern skulle begäras ",
