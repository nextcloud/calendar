OC.L10N.register(
    ...
    "{display_name} ({email}) booked the appointment \"{config_display_name}\" on {date_time}." : "{display_name} ({email}) bokade mötet \"{config_display_name}\" på {date_time}.",
    "Appointments" : "Möten",
    ...
    "Add holiday calendar" : "Lägg till helgdagskalender",
    ...
    "Global" : "Global",
    "Holiday calendars" : "Helgdagskalendrar",
    "Holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "Helgdagskalendrar tillhandahålls av Thunderbird. Kalenderdata kommer att laddas ner från {website}",
    "By {authors}" : "Av {authors}",
    "Subscribed" : "Prenumeration aktiverad",
    "Subscribe" : "Prenumerera",
    "Holidays in {region}" : "Helgdagar i {region}",
    "An error occurred, unable to create the holiday calendar." : "Ett fel uppstod, det gick inte att skapa helgdagskalendern.",
    ...
    "Hairdresser" : "Frisör",
    "Exam" : "Prov",
    "Written test" : "Skriftligt prov",
    "Oral test" : "Muntligt prov",
    "Working" : "Arbete",
