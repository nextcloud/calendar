...
"Dec." => "Dez.",
"All day" => "Ganztägig",
"New CalendarManager" => "Neuer Kalender",
...
"Share CalendarManager" => "Kalender freigeben",
...
"Active" => "Aktiv",
"CalendarManager color" => "Kalenderfarbe",
"Save" => "Speichern",
"Submit" => "Bestätigen",
"Cancel" => "Abbrechen",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "Ein Kalender mit diesem Namen existiert bereits. Solltest Du fortfahren, werden die beiden Kalender zusammengeführt.",
...
"URLs" => "URLs",
"CalendarManager CalDAV syncing addresses" => "CalDAV-Kalender gleicht Adressen ab",
