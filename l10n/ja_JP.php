...
"Dec." => "12月",
"All day" => "終日",
"New CalendarManager" => "新しくカレンダーを作成",
...
"Share CalendarManager" => "カレンダーを共有する",
"Download" => "ダウンロード",
"Edit" => "編集",
"Delete" => "削除",
...
"A CalendarManager with this name already exists. If you continue anyhow, these calendars will be merged." => "このカレンダー名はすでに使われています。もし続行する場合は、これらのカレンダーはマージされます。",
...
"URLs" => "URL",
"CalendarManager CalDAV syncing addresses" => "CalDAVカレンダーの同期用アドレス",
"more info" => "さらに",
