OC.L10N.register(
    ...
    "Attachment {name} already exist!" : "المرفق {name} موجودٌ سلفاً!",
    ...
    "Your participation has been marked as tentative." : "تمّ وضع علامة مشاركة مبدئية على مشاركتك.",
    ...
    "(organizer)" : "(مُنظِّم)",
    "To send out invitations and handle responses, [linkopen]add your email address in personal settings[linkclose]." : "لإرسال الدعوات والتعامل مع الاستجابات [linkopen]، أضف بريدك الالكتروني الإعدادات الشخصية [linkclose].",
    ...
    "Public holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}" : "يتم توفير تقاويم العطلات العامة بواسطة ثندربرد. سوف يتم تنزيل بيانات التقويم من {الموقع الإلكتروني}",
    ...
    "Error while sharing file with user" : "حدث خطأ أثناء المُشاركة مع المُستخدِم",
    "Attachment {fileName} already exists!" : "المٌرفق {fileName} موجودٌ سلفاً!",
    ...
    "Dinner" : "عشاء",
    "Lunch" : "غداء",
    "Appointment not found" : "لم يُمكن العثور على الموعد",
