OC.L10N.register(
    ...
    "Send e-mail" : "ارسال بريد",
    "Chairperson" : "الرئيس",
    "Required participant" : "مشارك مطلوب",
    "Optional participant" : "مشارك اختياري",
    "Non-participant" : "غير مشارك",
    "Remove attendee" : "طرد الحاضر",
    "Search for e-mails, users, contacts, resources or rooms" : "البحث باستخدام البريد، الاعضاء، جهات الاتصال، الموارد والغرف",
    ...
    "Can not modify all-day setting for events that are part of a recurrence-set." : "لا يمكن تعيين اعدادات اليوم باكمله للفعالية التي تعيينها مكرر.",
    ...
    "on date" : "في تاريخ",
    "after" : "بعد",
    "This event is the recurrence-exception of a recurrence-set. You can not add a recurrence-rule to it." : "هذه الفعالية تكرار استثنائي من تعيين التكرار. لا يمكن اضافة قانون تكرار لها.",
    "first" : "اول",
    "third" : "ثالث",
    "fourth" : "رابع",
    "fifth" : "خامس",
