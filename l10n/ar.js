OC.L10N.register(
    ...
    "You don't own this calendar, so you cannot add attendees to this event" : "بما أنك لا تمتلك هذا التقويم، فلا يمكنك إضافة مَدعُوِّين لهذا الحدث",
    ...
    "Search for emails, users or contacts" : "إبحث عن إيميلات، مستخدمين، أو جهات اتصال",
    ...
    "from {startDate}" : "منذ {startDate}",
    "from {startDate} at {startTime}" : "منذ {startDate} في {startTime}",
    "to {endDate}" : "إلى {endDate}",
    ...
    "Movie" : "شريط سينمائي",
    "Cinema" : "سينما",
    "Graduation" : "حفل تخرُّج",
    "Brainstorm" : "عصف ذهني",
    "Review" : "مراجعة",
    "Audit" : "مراجعة",
    "Inspection" : "فحص",
    "Proofreading" : "تصحيح لغوي",
    "Baseball" : "بيسبول",
    "Meet" : "اجتماع",
    "Planning" : "تخطيط",
    "Pointing" : "تشكيل",
    "Retrospective" : "إستعادة أحداث",
    "Office" : "مكتب",
    "Contributor week" : "اسبوع المساهمة",
    "Mail" : "البريد",
    ...
    "Hairdresser" : "حلّاق",
    "Exam" : "اختبار",
    "Written test" : "إمتحان كتابي",
    "Oral test" : "إمتحان شفوي",
    "Working" : "يعمل",
    "New Years Eve" : "رأس السنة الميلادية",
    "NYE" : "ليلة رأس السنة",
    "Fireworks" : "ألعاب نارية",
    "Running" : "ركض",
    "Go for a run" : "الذهاب للركض",
    "Marathon" : "سباق ماراثون",
    "Video-conference" : "إجتماع فيديو",
    "Conference-call" : "إجتماع صوتي",
    "Video-call" : "مكالمة مرئية",
    "Video-chat" : "دردشة مرئية",
    "Video-meeting" : "إجتماع مرئي",
    "Call" : "اتصال",
    "Calling" : "جارٍ الاتصال",
    "Christmas" : "رأس السنة الميلادية",
    "Conference" : "مؤتمر",
    "Pizza" : "بيتزا",
    "Travelling" : "مسافر",
    "Trip" : "رحلة",
    ...
    "Birthday" : "عيد ميلاد",
    "Shopping" : "تسوُّق",
    "Groceries" : "مشتروات للمنزل",
    "Skate" : "تزلُّج",
    "Skateboard" : "تزلُّج لوحي",
    "Wine tasting" : "تذوق مشروبات",
    "Golf" : "جولف",
    "Dinner" : "عشاء",
    "Lunch" : "غداء",
