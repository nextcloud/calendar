OC.L10N.register(
    ...
    "Successfully added Talk conversation link to location." : "تمت إضافة رابط المحادثة إلى الموقع بنجاح.",
    "Successfully added Talk conversation link to description." : "تمت إضافة رابط المحادثة إلى الوصف بنجاح.",
    "Failed to apply Talk room." : "تعذّر تطبيق غرفة المحادثة.",
    "Error creating Talk conversation" : "خطأ في إنشاء رابط المحادثة",
    "Select a Talk Room" : "إختَر غرفة المحادثة",
    "Add Talk conversation" : "إضِف محادثة Talk",
    "Fetching Talk rooms…" : "جلب معلومات غرف المحادثة ...",
    ...
    "Availability will be checked" : "سوف يتم اختبار التوافر",
    "Invitation will be sent" : "سوف يتم إرسال الدعوة",
    "Failed to check availability" : "تعذّر اختبار التوافر",
    "Failed to deliver invitation" : "تعذّر تسليم الدعوة",
    ...
    "Modifications wont get propagated to the organizer and other attendees" : "التعديلات لن يتم إذاعتها على المنظم والمشاركين الآخرين",
    "Details" : "التفاصيل",
    ...
    "You are not allowed to edit this event as an attendee." : "أنت غير مسموح لك بتعديل هذا الحدث كأحد الحضور.",
    "W" : "W",
    "%n more" : "%n المزيد",
