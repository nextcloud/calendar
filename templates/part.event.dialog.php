	...
	<fieldset>
		...
		<div id="event-time">
			<div id="event-time-from">
				...
				<input type="time" value="<?php p($_['starttime']);?>" name="fromtime" id="fromtime" ng-model="fromtimemodel" ng-disabled="alldayeventcheckbox fromtimemodel=null" />
			</div>
			<div id="event-time-to">
				<input type="text" value="<?php p($_['enddate']);?>" name="to" id="to" ng-model="todatemodel" placeholder="<?php p($l->t('to'));?>" />
				<input type="time" value="<?php p($_['endtime']);?>" name="totime" id="totime" ng-model="totimemodel" ng-disabled="alldayeventcheckbox; totimemodel=null" />
			</div>
			<div id="action-icons">
