...
describe('fullcalendar/eventDidMount test suite', () => {
	...
	it('should add a group icon if event has attendees - dark', () => {
		const fcTime = document.createElement('span')
		fcTime.classList.add('fc-time')
		fcTime.appendChild(document.createTextNode('2pm'))
		const fcTitle = document.createElement('span')
		...
		const el = document.createElement('div')
		el.classList.add('fc-event-nc-attendees')
		el.appendChild(fcContent)
		...
		expect(el.outerHTML).toEqual('<div class="fc-event-nc-attendees" data-object-id="object123" data-recurrence-id="recurrence456"><div class="fc-content"><span class="fc-time">2pm</span><span class="fc-title">Title 123</span><span class="icon-event-attendee icon-event-attendee--dark"></span></div></div>')
	})

	it('should add a group icon if event has attendees - light', () => {
		const fcTime = document.createElement('span')
		fcTime.classList.add('fc-time')
		fcTime.appendChild(document.createTextNode('2pm'))
		const fcTitle = document.createElement('span')
		...
		expect(el.outerHTML).toEqual('<div class="fc-event-nc-attendees" data-object-id="object123" data-recurrence-id="recurrence456"><div class="fc-content"><span class="fc-time">2pm</span><span class="fc-title">Title 123</span><span class="icon-event-attendee icon-event-attendee--light"></span></div></div>')
	})
