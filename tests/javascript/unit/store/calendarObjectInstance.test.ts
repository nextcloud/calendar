...
describe('store/calendarObjectInstance test suite', () => {
	...
	describe('duplicateCalendarObjectInstance', () => {
		...
		it('duplicates into the same calendar as the source event', async () => {
			...
			expect(calendarObjectsStore.createNewEvent).toHaveBeenCalledWith(expect.objectContaining({ calendarId: 'source-calendar' }))
		})
