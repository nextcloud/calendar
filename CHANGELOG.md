...
* appointment layout ([7539380](https://github.com/nextcloud/calendar/commit/753938023ce02a53a96af1a609659894f6c00f1c))
* **appointments:** avoid nested booking form scrolling ([e413be3](https://github.com/nextcloud/calendar/commit/e413be3edc03d259b65fadd7a6ff14b38c170fce))
* **appointments:** catch actual exception type for invalid timezones ([1da4374](https://github.com/nextcloud/calendar/commit/1da4374bea0e9b799e4c7cb08735bfa5f6a846ab))
* **appointments:** prevent unreachable overflow on the booking page ([a4d38e7](https://github.com/nextcloud/calendar/commit/a4d38e70619611a29fba116398c38bafe0b0e642))
* **attendees:** respect user ID full-match setting ([44f763e](https://github.com/nextcloud/calendar/commit/44f763ec14c095981851decf5b324e1157e36522))
* bell icon for events with reminders ([c5705ef](https://github.com/nextcloud/calendar/commit/c5705eff9a5fc084601eda99ab7777a8eff3c644))
* booking slot ([6490c9d](https://github.com/nextcloud/calendar/commit/6490c9d6101764e8b81ef8f964f8c7cac54576a8))
* **calendar:** use sidebar open lifecycle for unscheduled tasks ([a809116](https://github.com/nextcloud/calendar/commit/a809116b54349337208fd6a3d52f40c6152fc6a4))
* correctly declare icons on NcEmptyContent ([6d4f662](https://github.com/nextcloud/calendar/commit/6d4f6621a620e0af8f9a5146943be2fd37d9d99e))
* **delegation:** display delegated calendars after enable status change ([574215a](https://github.com/nextcloud/calendar/commit/574215a9fd02824d17ebdb4935fd0f54794960b3))
* **deps:** Fix npm audit ([cb6f7a6](https://github.com/nextcloud/calendar/commit/cb6f7a68f9730b61a55d4a8a86dd9412531e0a6b))
* **deps:** Fix npm audit ([8579eb8](https://github.com/nextcloud/calendar/commit/8579eb8b67e53c3fcf814ad2da6de8b756d17e96))
* **deps:** Fix npm audit ([1d6cd30](https://github.com/nextcloud/calendar/commit/1d6cd30af74eba0af86d0d868e2a0c91d2de7dc3))
* **deps:** update dependency @nextcloud/vue to ^9.11.0 (stable6.5) ([a0fd3b5](https://github.com/nextcloud/calendar/commit/a0fd3b553fd8458aeb9d65781c789c16b1ef2cb4))
* **deps:** update dependency vitest to v4.1.11 ([#8904](https://github.com/nextcloud/calendar/issues/8904)) ([d99f0c8](https://github.com/nextcloud/calendar/commit/d99f0c8875848d3f40f4d9ae6ca5c9ac06fbbda5))
* do not assign invalid icon property on NcActionButton ([0bc32ca](https://github.com/nextcloud/calendar/commit/0bc32ca869c9e35fade27f2f655af9f1cc1bc4a6))
* **editor:** correct width and border of property select styling ([11af928](https://github.com/nextcloud/calendar/commit/11af9280acc75af51e05cc7948c87ae0c01854bf))
* **editor:** correct width of property select for narrow view ([00c1d9d](https://github.com/nextcloud/calendar/commit/00c1d9d01c31eaee39095f1c37217c46c543a3b2))
* **editor:** keep close action in simple editor ([e5b47b3](https://github.com/nextcloud/calendar/commit/e5b47b3dc9c4c60c2dfcf9d5ce9440207504e6eb))
* **editor:** prevent close button overlap ([b2d3fae](https://github.com/nextcloud/calendar/commit/b2d3faed090e4e4c4928a681267ee39581459e2e))
* **editor:** use useHotKey for editor shortcuts ([8e9b0e3](https://github.com/nextcloud/calendar/commit/8e9b0e31fcdd6b86170b1a87af8846ab1043528e))
* hide invitation reply buttons on cancelled event ([3fba2b7](https://github.com/nextcloud/calendar/commit/3fba2b743e11838e8dd628f70737c5103a362623))
* **l10n:** Update translations from Transifex ([cfba346](https://github.com/nextcloud/calendar/commit/cfba34654e8d0e2f5bfb58c3f7b09aa33d3bfd8e))
* **l10n:** Update translations from Transifex ([5006b0a](https://github.com/nextcloud/calendar/commit/5006b0a304764fe63372e5e6b94ab37c5cf59266))
* **l10n:** Update translations from Transifex ([4559076](https://github.com/nextcloud/calendar/commit/45590768586bcc437532043176c5396387716b4e))
* **l10n:** Update translations from Transifex ([87eabee](https://github.com/nextcloud/calendar/commit/87eabee75e0dc16e9749f4c9e8675e7a8613dfbf))
* **l10n:** Update translations from Transifex ([c00fc87](https://github.com/nextcloud/calendar/commit/c00fc871effbc7b1d33f3bc362fe395e30f86b31))
* **l10n:** Update translations from Transifex ([e2ea80f](https://github.com/nextcloud/calendar/commit/e2ea80f4838b98e090358a7efce3b7b988c66dde))
* **l10n:** Update translations from Transifex ([6a08e06](https://github.com/nextcloud/calendar/commit/6a08e06d1472ba2ad0397ef78d72053061add06f))
* **l10n:** Update translations from Transifex ([692df39](https://github.com/nextcloud/calendar/commit/692df39c4f9baa331169956125b4adfa15ff3457))
* **l10n:** Update translations from Transifex ([dd1cd5d](https://github.com/nextcloud/calendar/commit/dd1cd5d3087651f944474f62520a355d241c4e9a))
* **l10n:** Update translations from Transifex ([70e3559](https://github.com/nextcloud/calendar/commit/70e35592dc0aba734108e342428198ac695d37a5))
* **l10n:** Update translations from Transifex ([9642ed6](https://github.com/nextcloud/calendar/commit/9642ed6fb867f6a5331f51d8f5bf855a6d273a1c))
* **l10n:** Update translations from Transifex ([a7d9654](https://github.com/nextcloud/calendar/commit/a7d9654eb0a307a4df1ba9b7a9bbcc2677f98d40))
* **l10n:** Update translations from Transifex ([15673ba](https://github.com/nextcloud/calendar/commit/15673ba48d57ecad39bdf1309ad5fe8447182eb4))
* **l10n:** Update translations from Transifex ([2ec01c9](https://github.com/nextcloud/calendar/commit/2ec01c91f0f52229c53eeb22c284d950eb6ada89))
* **l10n:** Update translations from Transifex ([6e2d7d1](https://github.com/nextcloud/calendar/commit/6e2d7d1a354ec07f0289789e55fd07037319ea95))
* **l10n:** Update translations from Transifex ([e7ad230](https://github.com/nextcloud/calendar/commit/e7ad230bf655534294d485fca5f288f5b55d0a7c))
* **l10n:** Update translations from Transifex ([a5e3824](https://github.com/nextcloud/calendar/commit/a5e3824a36fa6683cece074a63269aefda136c47))
* **l10n:** Update translations from Transifex ([095b4bf](https://github.com/nextcloud/calendar/commit/095b4bfc2be55bece405edac9e057b04cabc4781))
* **l10n:** Update translations from Transifex ([5065317](https://github.com/nextcloud/calendar/commit/5065317a960257489ebfa36522ab72c90e95727a))
* **l10n:** Update translations from Transifex ([f8db111](https://github.com/nextcloud/calendar/commit/f8db1116e94cbe3bb9590b772c22bd961a02a726))
* **l10n:** Update translations from Transifex ([1836f14](https://github.com/nextcloud/calendar/commit/1836f149e2169c57d0b273e62d51a9087ba399ad))
* **l10n:** Update translations from Transifex ([0080d33](https://github.com/nextcloud/calendar/commit/0080d331714f199e99cde96aebb0b05eb82e86ad))
* **l10n:** Update translations from Transifex ([2592cad](https://github.com/nextcloud/calendar/commit/2592cad1b9bbd3a90f0d86b9227c79177d02e1ba))
* **l10n:** Update translations from Transifex ([ff06824](https://github.com/nextcloud/calendar/commit/ff06824180eac80e0867f78a2c44ba2e3924bc76))
* **l10n:** Update translations from Transifex ([f1e3414](https://github.com/nextcloud/calendar/commit/f1e34148bf57a2000d11cd5c0392ab9e57da81be))
* **l10n:** Update translations from Transifex ([43f2928](https://github.com/nextcloud/calendar/commit/43f2928c68702fd085f96315790523703c5887fe))
* make period header translation reactive ([20225f1](https://github.com/nextcloud/calendar/commit/20225f1ed50807800c3a3e981932dba6a6dace90)), closes [#8756](https://github.com/nextcloud/calendar/issues/8756)
* meeting proposal date range heading ([89250b3](https://github.com/nextcloud/calendar/commit/89250b3b4ab1cb098c6de6ec78bdd252a95c3fd2))
* **proposals:** handle invalid timezone fallback ([1408d9d](https://github.com/nextcloud/calendar/commit/1408d9da696218158b3338d7ee80cde4d6e06908)), closes [#8914](https://github.com/nextcloud/calendar/issues/8914)
* **proposals:** handle network errors without responses ([95cb4f0](https://github.com/nextcloud/calendar/commit/95cb4f02afa2b6f571714b8ec355a5c82a80343a))
* recurrence rule truncation on nth occurrence save ([84cef1c](https://github.com/nextcloud/calendar/commit/84cef1c28c1e2525a6641de9218def152d05e61f))
* render single-date tasks and task checkbox visibility ([4fef792](https://github.com/nextcloud/calendar/commit/4fef792b6fee84b7f82d49a14e0a1af9ea7739b1))
* replace custom load animation with NcLoadingIcon ([e8a4d8a](https://github.com/nextcloud/calendar/commit/e8a4d8ad873fa9eac54ff13534488203cee1a8f1))
* set reply to on emails when using system mailer ([89c905e](https://github.com/nextcloud/calendar/commit/89c905e624236c1d990d5a7619aceeddbfa17448))
* update, delete, accept, devline all occurrences ([9b4e09c](https://github.com/nextcloud/calendar/commit/9b4e09c7f5dd922dc5e4a5429723c3c921775d1f))
* use properly aligning loading icons in NcActionText ([cbaee65](https://github.com/nextcloud/calendar/commit/cbaee657dd3ec93cc4d2c9db664a56bf544e1d33))
* use shorter wording ([2ededb5](https://github.com/nextcloud/calendar/commit/2ededb5f764e02fcc805399242633029d32cf541))
* use standard hover style for navigation date picker ([1eba18f](https://github.com/nextcloud/calendar/commit/1eba18f8b1ba56d34cd0b37aea8321da976a7f14))
...
* **A11y:** make focused input borders have default styling ([da031ee](https://github.com/nextcloud/calendar/commit/da031ee1569ec41cdd32ed4172531866e94dd22a))
...
* add an extra confirmation step to appointment booking ([63432ec](https://github.com/nextcloud/calendar/commit/63432ec0bc5a2058f6440eafcdd05a1a21d41b3f))
* add delegator as attendee ([b31226a](https://github.com/nextcloud/calendar/commit/b31226ad7557480bbc6abc627589064a1cdb6984))
...
* add event link ([4428857](https://github.com/nextcloud/calendar/commit/442885720417ed958ba6d1acf8d66ec762d69a58))
* add parenthesis to :deep selector to avoid warnings ([683cd51](https://github.com/nextcloud/calendar/commit/683cd5195b27631cbf0de879828db21217eaed6d))
...
* adjust alignment of time and timezone pickers ([d84ac78](https://github.com/nextcloud/calendar/commit/d84ac78d8de59245046777972e52a8e9db489ea4))
* adjust color contrast of avatar participation status ([57506e2](https://github.com/nextcloud/calendar/commit/57506e2762835a7090a37df879df3011c547aa5d))
...
* adjust tests to outgoing_server2server_share_enabled ([020507d](https://github.com/nextcloud/calendar/commit/020507d815b6804d179aae8c59843332edcac709))
...
* **alarms:** do not add ATTENDEE/SUMMARY to DISPLAY alarms ([bc1705d](https://github.com/nextcloud/calendar/commit/bc1705d7ba3665ce44fb777971cc8ee93f85eb8e))
* all day events order ([e7164e0](https://github.com/nextcloud/calendar/commit/e7164e0bb34d6c92074d1c9194d3e8eab5de567a))
...
* appointment booking overview page styling ([a705759](https://github.com/nextcloud/calendar/commit/a705759c3bcdf8d60b2ea98d043591c8e4ba7fb3))
* appointment booking room creation ([640eec2](https://github.com/nextcloud/calendar/commit/640eec2d9e24771aad5e61906e51e90e3ab8b001))
* appointment config check boxes ([3bdd841](https://github.com/nextcloud/calendar/commit/3bdd841c421b66a0fa7f97e7d3f0429c612bff7f))
* appointment config issues ([41e24e4](https://github.com/nextcloud/calendar/commit/41e24e4eb57d7e76de32a5b9da536456348d8fd2))
...
* appointment pages overlapping with footer on mobile ([9f01cd1](https://github.com/nextcloud/calendar/commit/9f01cd182bc81179e124838c9038c610a2eee37f))
* **appointment:** capture Attendee browser language and save it ([791d722](https://github.com/nextcloud/calendar/commit/791d722e599b5710fe9f8c03b941ade362668c8d))
* **appointments:** Make scheduled appointments meeting conversations in Talk ([24bd8dc](https://github.com/nextcloud/calendar/commit/24bd8dccdfc92b97c9749e75a000be94987e4a94))
...
* blank date on manual input ([d09d85a](https://github.com/nextcloud/calendar/commit/d09d85ac4e5b44abdbd3c35c6e7d7ded16bb117e))
* calendar initiial state ([250f869](https://github.com/nextcloud/calendar/commit/250f869708ab7e6d9b88ae7fd7078b92fffd56f9))
* calendar name input ([03dc5e4](https://github.com/nextcloud/calendar/commit/03dc5e4e8e1dc877d0e3e319a1d23b49d1c279ca))
...
* **CalendarGrid:** a small edge case with short events ([0fdd615](https://github.com/nextcloud/calendar/commit/0fdd61566449b77d91105a065c8365aad00db3f2))
* **CalendarGrid:** add aria-current to current date ([033186d](https://github.com/nextcloud/calendar/commit/033186de1792b84775d016a1866290255cfeb03b))
* **CalendarGrid:** make short events render title on one line ([56ac2be](https://github.com/nextcloud/calendar/commit/56ac2be78a025401023eda54bd28127b73f68265))
* **calendarObjectInstance:** reminders not deleting ([1680ed9](https://github.com/nextcloud/calendar/commit/1680ed90a45da2a9ec8b889d98f822046094e308))
...
* **capability:** Add a capability if calendar webui is there ([305dd7c](https://github.com/nextcloud/calendar/commit/305dd7cf47e05065b7622b6d60d4f55c53e8bae9))
* **chore:** fix missing unscheduled tasks list ([c483bba](https://github.com/nextcloud/calendar/commit/c483bba10b0c8dcf2e5f4fe121d15f8f992aca83))
...
* **ContactController:** default option for user enumeration in sharing ([aa4380a](https://github.com/nextcloud/calendar/commit/aa4380af18e9d1110c40ba84485006c485006b94))
* **css:** keep unscheduled tasks toggle inside the scroll container ([b128bb9](https://github.com/nextcloud/calendar/commit/b128bb91711ff27586a61a777fd77fc83eeb875a))
* **css:** Use semantic font weight for event titles ([0454f9e](https://github.com/nextcloud/calendar/commit/0454f9ea96d1c76b5a9c404902be72cdca355117))
* date selector resetting time ([caf5cf8](https://github.com/nextcloud/calendar/commit/caf5cf87b2a075a061294d09a657b3047cc89b5c))
* default calendar alarm application ([b9c8b55](https://github.com/nextcloud/calendar/commit/b9c8b5503e63f93c9be4fcb13a279f5a5ce5fcaf))
* default null alarm ([13402e2](https://github.com/nextcloud/calendar/commit/13402e209e66c2931e74c2c130b6e545b5a98d36))
...
* **deps:** Fix npm audit ([ba5c1c8](https://github.com/nextcloud/calendar/commit/ba5c1c84b00d773ccb280033b86257ab37788431))
* **deps:** Fix npm audit ([1212ba8](https://github.com/nextcloud/calendar/commit/1212ba85d249a15eeef52142dd7df9d7c55a7bc4))
* **deps:** Fix npm audit ([ee9c8a5](https://github.com/nextcloud/calendar/commit/ee9c8a51ed9ccd2d3750fdf222da603b7efba800))
* **deps:** Fix npm audit ([5908012](https://github.com/nextcloud/calendar/commit/59080128711e185dbefe2b4b2bee6611018be969))
* **deps:** Fix npm audit ([a47a92c](https://github.com/nextcloud/calendar/commit/a47a92cae4af05597708ab3cafe6858d8f25e2c0))
* **deps:** Fix npm audit ([ff2d479](https://github.com/nextcloud/calendar/commit/ff2d4798322ac0994a1e1a03489003436b6585c4))
* **deps:** Fix npm audit ([00d4004](https://github.com/nextcloud/calendar/commit/00d4004b93776f0a7f93523a97a3d04a83a67edc))
* **deps:** Fix npm audit ([28bb1de](https://github.com/nextcloud/calendar/commit/28bb1deab9ad0774770dfc5e68fc9d398802bb12))
...
* **deps:** update dependency @nextcloud/auth to ^2.6.0 (main) ([#8160](https://github.com/nextcloud/calendar/issues/8160)) ([78bfc3b](https://github.com/nextcloud/calendar/commit/78bfc3bc97ccf47b1d4605b45caf9afa933d1e7c))
* **deps:** update dependency @nextcloud/axios to ^2.6.0 (main) ([#8180](https://github.com/nextcloud/calendar/issues/8180)) ([25ddffb](https://github.com/nextcloud/calendar/commit/25ddffb7326370054561018bfa85b6b53801e587))
* **deps:** update dependency @nextcloud/cdav-library to ^2.4.0 (main) ([#8265](https://github.com/nextcloud/calendar/issues/8265)) ([3daf0e7](https://github.com/nextcloud/calendar/commit/3daf0e7c2201ae02a1bce2ef1cbff9a7d59a1d55))
* **deps:** update dependency @nextcloud/cdav-library to ^2.5.0 (main) ([#8322](https://github.com/nextcloud/calendar/issues/8322)) ([7e6ae3c](https://github.com/nextcloud/calendar/commit/7e6ae3ce04627fa5117db62ba31b0152e6d8f437))
* **deps:** update dependency @nextcloud/cdav-library to ^2.6.0 ([13843bb](https://github.com/nextcloud/calendar/commit/13843bb86e3ddb815829641827e84255f73a70ac))
* **deps:** update dependency @nextcloud/cdav-library to ^2.6.2 ([#8485](https://github.com/nextcloud/calendar/issues/8485)) ([6628d7f](https://github.com/nextcloud/calendar/commit/6628d7fb73415236443c2ff8038182df9c49f42b))
...
* **deps:** update dependency @nextcloud/dialogs to ^7.3.0 (main) ([#7972](https://github.com/nextcloud/calendar/issues/7972)) ([950cebf](https://github.com/nextcloud/calendar/commit/950cebf8c151e3837a60cb54006586f756414d1b))
* **deps:** update dependency @nextcloud/dialogs to ^7.4.0 ([57f125d](https://github.com/nextcloud/calendar/commit/57f125d2e8f56696ee074ddc6aa6738b66e58ccb))
...
* **deps:** update dependency @nextcloud/notify_push to ^1.4.0 (main) ([#8227](https://github.com/nextcloud/calendar/issues/8227)) ([b91be7a](https://github.com/nextcloud/calendar/commit/b91be7add2d0de562c25cc9fe76492fbf7eab4e2))
...
* **deps:** update dependency @nextcloud/vue to ^8.35.3 ([05166c7](https://github.com/nextcloud/calendar/commit/05166c77c7522b3c29e42a2fe65d0ae0bcaacbd0))
* **deps:** update dependency @nextcloud/vue to ^8.36.0 ([366e4a5](https://github.com/nextcloud/calendar/commit/366e4a5ef9ecc1e57b39668020f91892af1c5f2a))
* **deps:** update dependency @nextcloud/vue to ^9.6.0 ([36c5d29](https://github.com/nextcloud/calendar/commit/36c5d290e91c28cc47fbb6b7d8979bfa624ff1f1))
* **deps:** update dependency @nextcloud/vue to ^9.7.0 ([5afddf4](https://github.com/nextcloud/calendar/commit/5afddf40f9c29c3ded11a3c809a229e141818824))
* **deps:** update dependency @nextcloud/vue to ^9.8.0 ([575a33f](https://github.com/nextcloud/calendar/commit/575a33f2fbc79bea3700fbf7ee87e0930ce2b84a))
* **deps:** update dependency @nextcloud/vue to ^9.8.2 ([812d537](https://github.com/nextcloud/calendar/commit/812d537e0773a860b3d07ab133d028241ee13332))
...
* **deps:** update dependency bamarni/composer-bin-plugin to ^1.9.0 (main) ([#7956](https://github.com/nextcloud/calendar/issues/7956)) ([e819e7a](https://github.com/nextcloud/calendar/commit/e819e7a5b5c6bbc5969d00745aa5a281a65afb47))
* **deps:** update dependency bamarni/composer-bin-plugin to ^1.9.1 (main) ([#7966](https://github.com/nextcloud/calendar/issues/7966)) ([55d4ac6](https://github.com/nextcloud/calendar/commit/55d4ac6d3f3d2bb9db703aaf6abdf735856924b9))
...
* **deps:** update dependency core-js to ^3.48.0 (main) ([#7910](https://github.com/nextcloud/calendar/issues/7910)) ([381e7c5](https://github.com/nextcloud/calendar/commit/381e7c5d727816cb01d0af05ae9865cbb27e3714))
* **deps:** update dependency core-js to ^3.49.0 (main) ([#8117](https://github.com/nextcloud/calendar/issues/8117)) ([62aa062](https://github.com/nextcloud/calendar/commit/62aa062605cefc7d011bc24b4dd9783fcd18c99b))
...
* **deps:** update dependency linkifyjs to ^4.3.3 ([#8362](https://github.com/nextcloud/calendar/issues/8362)) ([7848894](https://github.com/nextcloud/calendar/commit/7848894589af2481ec59b268244a0cf76009109f))
...
* **deps:** update dependency p-limit to ^7.3.0 (main) ([#7959](https://github.com/nextcloud/calendar/issues/7959)) ([56d6a43](https://github.com/nextcloud/calendar/commit/56d6a4384aa29dede144eb578190c56d43ed676f))
* **deps:** update dependency vue-router to ^5.0.3 (main) ([#7960](https://github.com/nextcloud/calendar/issues/7960)) ([ddc6064](https://github.com/nextcloud/calendar/commit/ddc606453cd52d3cc6e31e0f63bea03f6c921031))
* **deps:** update dependency vue-router to ^5.0.4 (main) ([#8091](https://github.com/nextcloud/calendar/issues/8091)) ([8ee2b56](https://github.com/nextcloud/calendar/commit/8ee2b56ab99b295c4d699bc1114699628a62ae38))
* **deps:** update dependency vue-router to ^5.0.6 (main) ([#8226](https://github.com/nextcloud/calendar/issues/8226)) ([3eb37a8](https://github.com/nextcloud/calendar/commit/3eb37a8b3294e8b972ed4f5a9320ca1a82e8ade9))
* **deps:** update dependency vue-router to ^5.0.7 ([#8363](https://github.com/nextcloud/calendar/issues/8363)) ([ec56079](https://github.com/nextcloud/calendar/commit/ec560798a551b71501f4b10452010e037688bd7c))
* **deps:** update dependency webdav to ^5.10.0 (main) ([#8266](https://github.com/nextcloud/calendar/issues/8266)) ([6ea4940](https://github.com/nextcloud/calendar/commit/6ea4940c341abfa048d4ec27fe7ed1ab056c6d44))
* **deps:** update dependency webdav to ^5.9.0 (main) ([#7965](https://github.com/nextcloud/calendar/issues/7965)) ([5d8c788](https://github.com/nextcloud/calendar/commit/5d8c788d4872e6d35ff213c9c0a952eed1a3447a))
...
* **deps:** update vue monorepo to ^3.5.31 (main) ([#8116](https://github.com/nextcloud/calendar/issues/8116)) ([a904d58](https://github.com/nextcloud/calendar/commit/a904d5852245626d61cc8aab8a1fedddf7df733b))
* **deps:** update vue monorepo to ^3.5.35 ([#8472](https://github.com/nextcloud/calendar/issues/8472)) ([586b2d6](https://github.com/nextcloud/calendar/commit/586b2d6bce99299ffd5fc3d2fb643ec951990e03))
...
* disable reactivity on calendar import ([f75efc5](https://github.com/nextcloud/calendar/commit/f75efc57dfddfd7460730f50d1c238e6911285b3))
* display custom public calendars as subscribed when they are subscribed ([07d20a2](https://github.com/nextcloud/calendar/commit/07d20a2ecb12ee8dd4d753febbec20a30c84fc4d)), closes [#8134](https://github.com/nextcloud/calendar/issues/8134)
...
* do not update share item on mount ([0b71fbf](https://github.com/nextcloud/calendar/commit/0b71fbf40487a6d6ef5edab8010c4cddb14268f8))
* edit simple buttons running away ([4acd3d4](https://github.com/nextcloud/calendar/commit/4acd3d43ed0c43deabca7761c930629e436ab32e))
...
* **EditFull:** some styling issues after vue3 migration ([7170743](https://github.com/nextcloud/calendar/commit/7170743279d3b227f70a30d950103ad6a7ddb142))
...
* **editor:** better resource wording and availability shortcut ([6043d3c](https://github.com/nextcloud/calendar/commit/6043d3c3e3a990434f8a685ccc985a1d1f919a84))
* **editor:** close attendee action menu after Remove ([ea8415c](https://github.com/nextcloud/calendar/commit/ea8415c89944b81de86d851a7efab9ebd3623adf))
...
* **Editors:** auto focus title inputs ([460d88e](https://github.com/nextcloud/calendar/commit/460d88e1bd670bcfe7cea785c92c46875c8fb802))
...
* **editor:** store categories again by disabling deselectFromDropdown ([c838fa1](https://github.com/nextcloud/calendar/commit/c838fa127a36c29620ebf9fc1218e0b69bce718e))
...
* **EmailController:** Ensure provided token matches any shared calendar ([998620b](https://github.com/nextcloud/calendar/commit/998620b5e767bcf6003e00f5254c38e731f2605b))
...
* empty trash bin action ([ed6e1af](https://github.com/nextcloud/calendar/commit/ed6e1af7c14cb5a1ea5807cb36623aff06d0ab00))
...
* event overlapping and reminder alignment ([3d39611](https://github.com/nextcloud/calendar/commit/3d39611b71ee95289f6b73f832571684ca27bda8))
* **eventClick:** properly encode calendarId and taskId in URL generation ([9a5738a](https://github.com/nextcloud/calendar/commit/9a5738a3f5e30c1d50cdc46fd9e69688cdfd23a2))
* **eventDidMount:** increase past event opacity ([b855814](https://github.com/nextcloud/calendar/commit/b855814783472a187e8514f5b173667335760216))
...
* **events:** do not discard text input of dates and times in event edit dialog ([4efc441](https://github.com/nextcloud/calendar/commit/4efc441ebd20d813531e201f00459a8634bfe157))
* **federation:** respect federation settings ([85ce9b5](https://github.com/nextcloud/calendar/commit/85ce9b56837ecdeb53c7e28c2997fa08bfe0110c))
* Fix active day highlight in month view for longer languages like Japanese ([597fa57](https://github.com/nextcloud/calendar/commit/597fa5728e8caa8e5a566c8772890b2f230750c3))
...
* free event height ([a09888d](https://github.com/nextcloud/calendar/commit/a09888d5125e965ee96837484aa6a9959f7ff70c))
...
* have both circle color and avatar in calendar selection ([feb621f](https://github.com/nextcloud/calendar/commit/feb621f33d2e8cfc2e362f2b3313dfbdad4c76a9))
...
* identify if contact is a system user ([a058bd4](https://github.com/nextcloud/calendar/commit/a058bd46223aaa42f274b6af6d36f6900c7d9942))
* improve attendee search ([9851b16](https://github.com/nextcloud/calendar/commit/9851b167fe005a40cf229836cce5eed1b1b7223f))
...
* improve simple editor positioning logic ([284c06f](https://github.com/nextcloud/calendar/commit/284c06fc413e7c66ccc950d0023a697816549c9b))
...
* input validation ([40dbf62](https://github.com/nextcloud/calendar/commit/40dbf62095649cab5b33bfaaaab60916bbfcf33c))
* invitee list avatar ([cd89071](https://github.com/nextcloud/calendar/commit/cd89071f8fd9d9f819bb93949be0105496c7d5e9))
...
* **InviteesListItem:** attendee name wrapping ([74a51e9](https://github.com/nextcloud/calendar/commit/74a51e9face312db571f3c77626bdc8ed9704e18))
* **InviteesListSearch:** ellipsis ([7ab9abe](https://github.com/nextcloud/calendar/commit/7ab9abe1b60cb47fc235ba7d4715cceb319ad1cc))
* **InviteesListSearch:** make matching work with both name and email ([6a97222](https://github.com/nextcloud/calendar/commit/6a972224577ded9096dbc172176518368e2e709b))
...
* **l10n:** Update translations from Transifex ([8898ce0](https://github.com/nextcloud/calendar/commit/8898ce0082e2fa66eaef48ff08af44a9bba7a24b))
* **l10n:** Update translations from Transifex ([3810bba](https://github.com/nextcloud/calendar/commit/3810bba097962cf8c719a101356861ad1c633577))
* **l10n:** Update translations from Transifex ([a2b6464](https://github.com/nextcloud/calendar/commit/a2b64643f85f73119cdc4cda90ce9e5cbf5ae58d))
* **l10n:** Update translations from Transifex ([4cb80d9](https://github.com/nextcloud/calendar/commit/4cb80d94cc168ce282351706d5f930190fa0b61e))
* **l10n:** Update translations from Transifex ([435a189](https://github.com/nextcloud/calendar/commit/435a189cc4fdd33b72a5378a81a3ae9a4fcdbc5f))
* **l10n:** Update translations from Transifex ([f9c43cd](https://github.com/nextcloud/calendar/commit/f9c43cda2079d32c409030ace921535b8272afdd))
* **l10n:** Update translations from Transifex ([28bf9da](https://github.com/nextcloud/calendar/commit/28bf9da3487518d8a6324358a37ef0b3ab50cf44))
* **l10n:** Update translations from Transifex ([8bc067c](https://github.com/nextcloud/calendar/commit/8bc067c093eb4245b86f8057241c40c7641e84de))
* **l10n:** Update translations from Transifex ([f78bcd6](https://github.com/nextcloud/calendar/commit/f78bcd631c90220cafeff42bbb804d788c1cb71a))
* **l10n:** Update translations from Transifex ([22bbb2f](https://github.com/nextcloud/calendar/commit/22bbb2f625cda65c6aa81837c513f09596a4958a))
* **l10n:** Update translations from Transifex ([be3b0a9](https://github.com/nextcloud/calendar/commit/be3b0a926a65ec00b7119764964b599ebf4b4a20))
* **l10n:** Update translations from Transifex ([c95ff9c](https://github.com/nextcloud/calendar/commit/c95ff9c21b1f8d28a99f306c04e5b53fee3c01a3))
* **l10n:** Update translations from Transifex ([a6b6d38](https://github.com/nextcloud/calendar/commit/a6b6d38bae5016aefcbf5585c84447b5f35989ce))
* **l10n:** Update translations from Transifex ([e5c7811](https://github.com/nextcloud/calendar/commit/e5c781103cda6c806903a7536dc4ee67e003f0ab))
* **l10n:** Update translations from Transifex ([74ef569](https://github.com/nextcloud/calendar/commit/74ef569365b7194d83f80ee8b148dc9736951ca7))
* **l10n:** Update translations from Transifex ([02ce77e](https://github.com/nextcloud/calendar/commit/02ce77e709e8f33237b8dd1e1da31fa94c6e3b85))
* **l10n:** Update translations from Transifex ([ef04c47](https://github.com/nextcloud/calendar/commit/ef04c4778409913de7e601d3a6ca0918e5f4fb9a))
* **l10n:** Update translations from Transifex ([45d2d8a](https://github.com/nextcloud/calendar/commit/45d2d8aae55a45c47bdaa0ac235d6bbcd02bebfb))
* **l10n:** Update translations from Transifex ([a24c18e](https://github.com/nextcloud/calendar/commit/a24c18eb3f44b7f9590bc7019596a33db1aa7a3b))
* **l10n:** Update translations from Transifex ([7300980](https://github.com/nextcloud/calendar/commit/730098048b68381ca80f3cb7200c75bd939db597))
* **l10n:** Update translations from Transifex ([336fc0a](https://github.com/nextcloud/calendar/commit/336fc0a67ddb3656c6f47f750a1e98541f9accf8))
* **l10n:** Update translations from Transifex ([6854e34](https://github.com/nextcloud/calendar/commit/6854e3467dbbdf24cf137ced6542c493a5cc8596))
* **l10n:** Update translations from Transifex ([945d5ec](https://github.com/nextcloud/calendar/commit/945d5ecd2d15179e0f0ed9026747c94878a6975b))
* **l10n:** Update translations from Transifex ([272931b](https://github.com/nextcloud/calendar/commit/272931b8fe6f3f0ce5234dd0cc3f27136e5a4c6a))
* **l10n:** Update translations from Transifex ([0d11786](https://github.com/nextcloud/calendar/commit/0d11786d158a955e8f95cb2b39d34d3d00783a9b))
* **l10n:** Update translations from Transifex ([ed9dfeb](https://github.com/nextcloud/calendar/commit/ed9dfeb31155dbbdf88c6be162891e307233d518))
* **l10n:** Update translations from Transifex ([07804e0](https://github.com/nextcloud/calendar/commit/07804e040e36dbcb6476cd4275b14e7878a11015))
* **l10n:** Update translations from Transifex ([e0d6765](https://github.com/nextcloud/calendar/commit/e0d67658af6eba53583637ec364c5d6da01e50fa))
* **l10n:** Update translations from Transifex ([cc77da2](https://github.com/nextcloud/calendar/commit/cc77da2972c811e34b9ed666cc0cde12f63fd0f1))
* **l10n:** Update translations from Transifex ([89b8380](https://github.com/nextcloud/calendar/commit/89b8380e41700cb0ecec4b00dd03d6512d8d9677))
* **l10n:** Update translations from Transifex ([857cd56](https://github.com/nextcloud/calendar/commit/857cd56f8a9766f56c4b5e3c747fd7cf46fc3f15))
* **l10n:** Update translations from Transifex ([e3adde2](https://github.com/nextcloud/calendar/commit/e3adde2315fd8b40776ec3597f373ea92efaf576))
* **l10n:** Update translations from Transifex ([50aa34b](https://github.com/nextcloud/calendar/commit/50aa34bd2c76469d2d0fef4bdf4e44923d7fb5a5))
* **l10n:** Update translations from Transifex ([398bc9e](https://github.com/nextcloud/calendar/commit/398bc9e4d27ad57c915ae266b2c11ee11ed1f08d))
* **l10n:** Update translations from Transifex ([46f7f9f](https://github.com/nextcloud/calendar/commit/46f7f9f59ba9354285b17a4c6924a9246738f4dd))
* **l10n:** Update translations from Transifex ([55016ef](https://github.com/nextcloud/calendar/commit/55016ef6b5ee8f9074741f8a22d91d0f9aa637ba))
* **l10n:** Update translations from Transifex ([0dc4f83](https://github.com/nextcloud/calendar/commit/0dc4f83882373f60ca60c71b55afe2a02f5d086b))
* **l10n:** Update translations from Transifex ([976bf4a](https://github.com/nextcloud/calendar/commit/976bf4ab213d867a16bf1c90f198cf051952f083))
* **l10n:** Update translations from Transifex ([43c1ff3](https://github.com/nextcloud/calendar/commit/43c1ff354782cf080d29e38eae740a2adfa3371c))
* **l10n:** Update translations from Transifex ([4d8770b](https://github.com/nextcloud/calendar/commit/4d8770b12e28cef8173702a6c5a50a0ec5f99110))
* **l10n:** Update translations from Transifex ([56fea49](https://github.com/nextcloud/calendar/commit/56fea493e195272592c750eeeb4329aa0a8c8855))
* **l10n:** Update translations from Transifex ([6963258](https://github.com/nextcloud/calendar/commit/6963258e31f04f86d2be2f4f1c96d2b8b630c17d))
* **l10n:** Update translations from Transifex ([c9bd7ed](https://github.com/nextcloud/calendar/commit/c9bd7ed59e5d286f1301140517e442468ef84d2a))
* **l10n:** Update translations from Transifex ([3d86691](https://github.com/nextcloud/calendar/commit/3d866911d49b7f60b55a5bebe574d9325303e5a1))
* **l10n:** Update translations from Transifex ([d9c9754](https://github.com/nextcloud/calendar/commit/d9c975419708fe3e16da655f2ee53341f38d0382))
* **l10n:** Update translations from Transifex ([f741ce1](https://github.com/nextcloud/calendar/commit/f741ce13f997aaa44d0a52a73bfa290aa7720359))
* **l10n:** Update translations from Transifex ([b0a7e98](https://github.com/nextcloud/calendar/commit/b0a7e98c20611a124910bea809f573a42becf00a))
* **l10n:** Update translations from Transifex ([628657c](https://github.com/nextcloud/calendar/commit/628657c909c0dacc7c50c08721f47a533f180f90))
* **l10n:** Update translations from Transifex ([d3bd1c2](https://github.com/nextcloud/calendar/commit/d3bd1c20f2de2827a445e446769814aa57bfdfe4))
* **l10n:** Update translations from Transifex ([59ad5e9](https://github.com/nextcloud/calendar/commit/59ad5e983c20dc89fe087b699efb7ede0037f3db))
* **l10n:** Update translations from Transifex ([7fc8a29](https://github.com/nextcloud/calendar/commit/7fc8a29f42b9687b709f8abbdae506d0b328521d))
* **l10n:** Update translations from Transifex ([e05a172](https://github.com/nextcloud/calendar/commit/e05a172dd34dd1cdbfb83ffef6979dd87f879567))
* **l10n:** Update translations from Transifex ([ec83ae4](https://github.com/nextcloud/calendar/commit/ec83ae4812e9e8621ec57e588ceb3b987eb6352e))
* **l10n:** Update translations from Transifex ([a2d970b](https://github.com/nextcloud/calendar/commit/a2d970be40dc76f7d5a02fef24b667c4f06b470c))
* **l10n:** Update translations from Transifex ([b237095](https://github.com/nextcloud/calendar/commit/b237095a595677fdd5abc33506b8b06c0032b98e))
* **l10n:** Update translations from Transifex ([98a731e](https://github.com/nextcloud/calendar/commit/98a731ed62d2f21b1776b895738a6f4c793608c8))
* **l10n:** Update translations from Transifex ([a1c8c05](https://github.com/nextcloud/calendar/commit/a1c8c0598cca31441846cdfca80ef82d9121e3e6))
* **l10n:** Update translations from Transifex ([c433c2c](https://github.com/nextcloud/calendar/commit/c433c2c39906e90873f2bd250cd4fe50d608d7d8))
* **l10n:** Update translations from Transifex ([496ca94](https://github.com/nextcloud/calendar/commit/496ca9424007e562129628eb9513e9674abf9d32))
* **l10n:** Update translations from Transifex ([d975c0c](https://github.com/nextcloud/calendar/commit/d975c0c26c5d31ab2c5c310e3976fa12aefa56ab))
* **l10n:** Update translations from Transifex ([6b0beca](https://github.com/nextcloud/calendar/commit/6b0beca4c1b76870d2fe51991c631fa362b6e794))
* **l10n:** Update translations from Transifex ([1882404](https://github.com/nextcloud/calendar/commit/1882404afd4c650c600d7556b81bda0f146efa38))
* **l10n:** Update translations from Transifex ([eeb6e46](https://github.com/nextcloud/calendar/commit/eeb6e46f1168acb1d2a7e0f317cff0752680231e))
* **l10n:** Update translations from Transifex ([c7c459a](https://github.com/nextcloud/calendar/commit/c7c459ab4a88ab38d510f76f2b5b357713a49ea9))
* **l10n:** Update translations from Transifex ([0a8dbe5](https://github.com/nextcloud/calendar/commit/0a8dbe5fa6b5884c16cf854ff9255a3c2b83905d))
* **l10n:** Update translations from Transifex ([42142cd](https://github.com/nextcloud/calendar/commit/42142cd3b92fa312220a7b60b81c5ee21829b54c))
* **l10n:** Update translations from Transifex ([e60ee0e](https://github.com/nextcloud/calendar/commit/e60ee0e1d22c0e8af00b98c5af8e8506876c36ee))
* **l10n:** Update translations from Transifex ([ae9c5ce](https://github.com/nextcloud/calendar/commit/ae9c5cede90972304836edc24fbaacc7c05b41ee))
* **l10n:** Update translations from Transifex ([eee2f68](https://github.com/nextcloud/calendar/commit/eee2f6830620f7abd36ff167dd297788f26e31b8))
* **l10n:** Update translations from Transifex ([24dd896](https://github.com/nextcloud/calendar/commit/24dd896c8074fef6757e4d0e6548535d7d50b9d3))
* **l10n:** Update translations from Transifex ([e149f8a](https://github.com/nextcloud/calendar/commit/e149f8a1804623e104f8e18654688533a7026b15))
* **l10n:** Update translations from Transifex ([d07510d](https://github.com/nextcloud/calendar/commit/d07510d71697fc304d54913d0d2c370f30799601))
* **l10n:** Update translations from Transifex ([b639888](https://github.com/nextcloud/calendar/commit/b63988870c5e572d4a28248b26444df420783e74))
* **l10n:** Update translations from Transifex ([53fcfb2](https://github.com/nextcloud/calendar/commit/53fcfb2953e0951d6ca588da851804b977246009))
* **l10n:** Update translations from Transifex ([eb3251d](https://github.com/nextcloud/calendar/commit/eb3251d9520441be824fda369a53afd591e01ee4))
* **l10n:** Update translations from Transifex ([06cc3e1](https://github.com/nextcloud/calendar/commit/06cc3e1ce364c8a8fc90d8aad1ca039d8d0e6c94))
* **l10n:** Update translations from Transifex ([2422d09](https://github.com/nextcloud/calendar/commit/2422d09fde93cb2a4283880212932408562f1c1c))
* **l10n:** Update translations from Transifex ([d87fbab](https://github.com/nextcloud/calendar/commit/d87fbabacb82a67907e45e191f5865b605a0f139))
* **l10n:** Update translations from Transifex ([021bea5](https://github.com/nextcloud/calendar/commit/021bea5ce4fb5c8546886d55d4d180f11894a1da))
* **l10n:** Update translations from Transifex ([4e1cbd6](https://github.com/nextcloud/calendar/commit/4e1cbd6a4f10dd8d16c06622cc61dab8cc1eff9e))
* **l10n:** Update translations from Transifex ([e7f7c52](https://github.com/nextcloud/calendar/commit/e7f7c52daca2149c613dd0560d8d9545a8bdcdf4))
* **l10n:** Update translations from Transifex ([792e52f](https://github.com/nextcloud/calendar/commit/792e52fbd639b03309cc8e1f0c51cee7c2c01ba5))
* **l10n:** Update translations from Transifex ([f0fd771](https://github.com/nextcloud/calendar/commit/f0fd771feb7ba596d2bbc9c9b8002b887525a127))
* **l10n:** Update translations from Transifex ([93fac85](https://github.com/nextcloud/calendar/commit/93fac857dd2470bd480da95826c0ebb548f33a51))
* **l10n:** Update translations from Transifex ([27ec94b](https://github.com/nextcloud/calendar/commit/27ec94b957f072729f1efcd443768726fdb7ca6a))
* **l10n:** Update translations from Transifex ([9a8c41a](https://github.com/nextcloud/calendar/commit/9a8c41a494d5d3484a3bb7fc9b5d00fa4752055d))
* **l10n:** Update translations from Transifex ([f9387df](https://github.com/nextcloud/calendar/commit/f9387df54314d7f46eaf5ebb903530af522a5b13))
* **l10n:** Update translations from Transifex ([0a0dc23](https://github.com/nextcloud/calendar/commit/0a0dc2382fbc6eb0ac871b7273adee15316c3ae4))
* **l10n:** Update translations from Transifex ([8758809](https://github.com/nextcloud/calendar/commit/8758809b17eaf9cc8359b1d88e2c6f1d1635ea37))
* **l10n:** Update translations from Transifex ([dd15541](https://github.com/nextcloud/calendar/commit/dd15541d2377a905070a39d921570d15c9b03f8a))
* **l10n:** Update translations from Transifex ([953258c](https://github.com/nextcloud/calendar/commit/953258c9843d9df86e7c2c59db9cb5e5a7001601))
* **l10n:** Update translations from Transifex ([c098c51](https://github.com/nextcloud/calendar/commit/c098c518ee8994532768fe5379c7a7a0a7a414a5))
* **l10n:** Update translations from Transifex ([a255dbf](https://github.com/nextcloud/calendar/commit/a255dbff86afeb7aa5e3347e849d57b13636cbda))
* **l10n:** Update translations from Transifex ([75a9673](https://github.com/nextcloud/calendar/commit/75a9673be86ad4b84fdc8ad5b325bcf980e2013e))
* **l10n:** Update translations from Transifex ([1d97806](https://github.com/nextcloud/calendar/commit/1d97806076d9bedabbcad3340905360565d018f5))
* **l10n:** Update translations from Transifex ([5c10c2c](https://github.com/nextcloud/calendar/commit/5c10c2cbba458ebbd76b822a174dcfe141d5d84f))
* **l10n:** Update translations from Transifex ([ed525fd](https://github.com/nextcloud/calendar/commit/ed525fdb7b616c3fcaa1f1ce582c1fa9e0b9a851))
* **l10n:** Update translations from Transifex ([ee14dad](https://github.com/nextcloud/calendar/commit/ee14dadb998722d12557cddffc1bfe6b1dfe1c0f))
* **l10n:** Update translations from Transifex ([8210ee3](https://github.com/nextcloud/calendar/commit/8210ee3795289262916e29a1c5745dbe0551271c))
* **l10n:** Update translations from Transifex ([1d1fd30](https://github.com/nextcloud/calendar/commit/1d1fd303edf8da8bcd8dc0356776232283fb6132))
* **l10n:** Update translations from Transifex ([d9d156b](https://github.com/nextcloud/calendar/commit/d9d156b177dfee744fdcf600ae9c308318afd03e))
* **l10n:** Update translations from Transifex ([440cabb](https://github.com/nextcloud/calendar/commit/440cabb20e1ae8447ea383785e581ecb496be87f))
* **l10n:** Update translations from Transifex ([5bc7491](https://github.com/nextcloud/calendar/commit/5bc7491f949e072a210b2d20db261c5a69097159))
* **l10n:** Update translations from Transifex ([ddb967e](https://github.com/nextcloud/calendar/commit/ddb967e3aa12254796d24e26fd44a07dc0ca9535))
* **l10n:** Update translations from Transifex ([b648648](https://github.com/nextcloud/calendar/commit/b64864845ed86ea6d85c6af6b7e525671589a1f6))
* **l10n:** Update translations from Transifex ([fefd726](https://github.com/nextcloud/calendar/commit/fefd726abf962f1437e3a51e347e1ffd2d91362e))
* **l10n:** Update translations from Transifex ([2e11c1c](https://github.com/nextcloud/calendar/commit/2e11c1cce25dd6f9a4c651e2e7287870f24afa44))
* **l10n:** Update translations from Transifex ([04e8e49](https://github.com/nextcloud/calendar/commit/04e8e493108bfce34d3800b74be19ba2dea22480))
* **l10n:** Update translations from Transifex ([de56310](https://github.com/nextcloud/calendar/commit/de5631032fce559836ea1d942228b00ef6c45768))
* **l10n:** Update translations from Transifex ([cd4fe0f](https://github.com/nextcloud/calendar/commit/cd4fe0f0248deaad931b8d8a214b03f40a1ef485))
* **l10n:** Update translations from Transifex ([308c846](https://github.com/nextcloud/calendar/commit/308c846a471490412f8a4d0301558ac015a320e7))
* **l10n:** Update translations from Transifex ([051414c](https://github.com/nextcloud/calendar/commit/051414c978bc62c679d76fde801c99a37b2091b2))
* **l10n:** Update translations from Transifex ([9bc15ef](https://github.com/nextcloud/calendar/commit/9bc15efbea220eb8424a65d85f6de0df3a59af59))
...
* make delegator event organizer ([c271406](https://github.com/nextcloud/calendar/commit/c271406c156924be5f975d5ce09e9bfb3bf431cd))
...
* meeting proposal public view position ([0b6b246](https://github.com/nextcloud/calendar/commit/0b6b246ed08a5e9fb8dd900bf1e9f0f0bf7480a9))
...
* Meeting proposal time zone offset ([1ff6057](https://github.com/nextcloud/calendar/commit/1ff60579d85eeb6270a39cf4238bd2b63f018f87))
...
* missed entry point during vue 3 migration ([674f876](https://github.com/nextcloud/calendar/commit/674f876d4c0c9857adc86f5d4b383c10a7108785))
* **models:** markRaw calendar-js objects in Pinia state ([45a6863](https://github.com/nextcloud/calendar/commit/45a6863e704d657dfb2ef0315eadbff415066e8a))
* modified dates logic in ProposalDateCollection ([e5a1e27](https://github.com/nextcloud/calendar/commit/e5a1e2700e392a643a0d3a18f90940ad21aeaab2))
...
* move 'Respond' button to top of message template ([f57c708](https://github.com/nextcloud/calendar/commit/f57c70826262c0d160e35bca214507da6348fde6))
* NcSelect inner text overflowing in EditFull ([#8056](https://github.com/nextcloud/calendar/issues/8056)) ([4c9fe07](https://github.com/nextcloud/calendar/commit/4c9fe0728f6dfe853729bba5b98230a23b8671ef))
* new event transparancy ([1eb5c1f](https://github.com/nextcloud/calendar/commit/1eb5c1f4ffcb35040277778ccd7c8494d9bf6d3d))
* node test ([d06ae0f](https://github.com/nextcloud/calendar/commit/d06ae0f785aa1a0bece1272f3de0ea0216e3e15e))
* **OCP:** Adjust public API method name ([7d9638f](https://github.com/nextcloud/calendar/commit/7d9638f06aeb675287301f45274100320487a0b7))
* opacity of past events and past/next month dates ([9fe1c36](https://github.com/nextcloud/calendar/commit/9fe1c367015b50f087774623e3fd851ea0bcad2b))
...
* proposal email time localization ([b00b626](https://github.com/nextcloud/calendar/commit/b00b62603be15b57bfe2c832e7bfc40ec355b97c))
* proposal links ([7da31f1](https://github.com/nextcloud/calendar/commit/7da31f1f8727bf63185eb02bf4868c37f616ae3c))
* **proposal:** notify invited participants when a proposal is converted to an event ([5b6ff4b](https://github.com/nextcloud/calendar/commit/5b6ff4bc8caca5df40ef6d45a9126c68dcfc0124))
* **ProposalService:** proposal creation ([86de53e](https://github.com/nextcloud/calendar/commit/86de53e203853be02a63f292c97c815bebb636f4))
...
* put default calendar selector back ([0956818](https://github.com/nextcloud/calendar/commit/09568188916955ea6853dec1d9e38d8d63eedabf))
...
* reorganise appointment config UI ([465bdd0](https://github.com/nextcloud/calendar/commit/465bdd0c6dd46c98e4dfeae931dd565e67bef6d7))
...
* **repeat:** Change button label in 'Repeat event' dialog from generic 'Add' to specific 'Set repetition' ([eee5d05](https://github.com/nextcloud/calendar/commit/eee5d05a599a1fe10477c92fe322ac8f29b68545))
* **Repeat:** date picker positioning ([449c675](https://github.com/nextcloud/calendar/commit/449c67555e483fec5544c7a5470a064bb509d96f))
* **repeat:** Fix layout of 'Repeat event' dialog ([be336cc](https://github.com/nextcloud/calendar/commit/be336cc4d6e969c04e214480241342e7ab352030))
* **repeat:** Undo removal of border-radius in 'Repeat event' dialog so week/month/year view looks closer to styleguide ([a27d234](https://github.com/nextcloud/calendar/commit/a27d234ce48fc61a9edc47b0901fc7340d4d0f04))
...
* **room-availability:** color caption popover not showing ([fa233c9](https://github.com/nextcloud/calendar/commit/fa233c9dd9a63ccbc62c8113109ef92b7d0b6c4b))
* **room-availability:** remove remnants of the interaction plugin ([49e6f95](https://github.com/nextcloud/calendar/commit/49e6f95e474aac02397004d3c424f1f4337c0bb3))
* **router:** Set parameters correctly when redirecting with Vue 3 ([8f9f27b](https://github.com/nextcloud/calendar/commit/8f9f27b3c6ce893b8ca169859969774685464a94))
...
* Scroll month view to current day so it’s visible, fix [#146](https://github.com/nextcloud/calendar/issues/146), fix [#8016](https://github.com/nextcloud/calendar/issues/8016) ([bbb9f72](https://github.com/nextcloud/calendar/commit/bbb9f724d72ee2e3f2db52e56d261843c8f3e995))
...
* Separate 'Delete this and all future' as last most destructive action of the menu with a separator ([8a4a6c6](https://github.com/nextcloud/calendar/commit/8a4a6c6801f53c48c01e14cc63e3013a7a1c0b6c))
...
* **settings:** fix birthday calendar toggle ([c0c4de4](https://github.com/nextcloud/calendar/commit/c0c4de4ac379c48af2bb16dfa9af4c4a94a0af2e))
...
* show proper dialogs for delete and convert ([f070736](https://github.com/nextcloud/calendar/commit/f0707366e84c57ff6404d421a932afeb11219438))
...
* simple editor refresh ([a83cbc1](https://github.com/nextcloud/calendar/commit/a83cbc1e64ec038ebf8b8e32d292e89f293cbee4))
...
* Specific icon for 'Update this and all future' to be more distinguishable ([ca6f442](https://github.com/nextcloud/calendar/commit/ca6f442fa3159cab2add510d37570463e7eaf06f))
* **store:** preserve calendar-object identity on unchanged refetch ([211044b](https://github.com/nextcloud/calendar/commit/211044b04957479b3c8e2cb63498760e82c79244))
...
* **talk-integration:** enable for users when no restrictions set ([bf3cbed](https://github.com/nextcloud/calendar/commit/bf3cbed3e0a4016d56b56f08745e117c4982aff1))
* **talk-integration:** make sure talk is enabled for user ([04687b7](https://github.com/nextcloud/calendar/commit/04687b7c891539ab715762968923959e3b635fc5))
...
* **trashbin:** restrict retore and delete on the frontend ([8d20663](https://github.com/nextcloud/calendar/commit/8d20663972fe498709df19890064827b230dc884))
* **ui:** Restore the section showing events that take place on full days ([b13e429](https://github.com/nextcloud/calendar/commit/b13e429310456c39107208dd6fccc5bb420885ff))
...
* update styling of public calendar modal ([fea408a](https://github.com/nextcloud/calendar/commit/fea408a998b2d7a3b41a573532ee7c97159c7311))
...
* user name search ([fe7a910](https://github.com/nextcloud/calendar/commit/fe7a91086572289e63e15e4bcdae62db3e322480))
* **utils/attendee:** mailto case ([5c7196e](https://github.com/nextcloud/calendar/commit/5c7196ee8eae51f561da59622f70cac05e7f42a9))
* vote input ([6e2403f](https://github.com/nextcloud/calendar/commit/6e2403ffae93b651117df800ce657b02095c4fb7))
* vue router 5 matching behaviour ([ef866dc](https://github.com/nextcloud/calendar/commit/ef866dcc478051bb1ca26a45a319ec35b4d56809))
...
* widget icon generation ([511aa6c](https://github.com/nextcloud/calendar/commit/511aa6cde69eaebcf4e6f98d7f4bbee3ce0d7490))
...
* add agents.md ([cb6129d](https://github.com/nextcloud/calendar/commit/cb6129d0ce844706c09bc74ba10060f29fb525f5))
* add calendar delegation feature ([3fa4240](https://github.com/nextcloud/calendar/commit/3fa4240a2411143facb244e274c39f10994997fb))
* add client-side event filter in app navigation ([b6822fd](https://github.com/nextcloud/calendar/commit/b6822fdc37197d5e67bb9cf0cb9efeef00a747ce)), closes [#2474](https://github.com/nextcloud/calendar/issues/2474)
...
* add talk button to simple editor ([69f155e](https://github.com/nextcloud/calendar/commit/69f155e9d4ef818c5032e0bebc64f1758936b546))
...
* Allow or disallow party crasher ([#8222](https://github.com/nextcloud/calendar/issues/8222)) ([8be4559](https://github.com/nextcloud/calendar/commit/8be45597938e46461d89ea5451df832225ea7e6a))
* allow sharee to copy public link of a shared calendar ([d185aad](https://github.com/nextcloud/calendar/commit/d185aad7b1cbf9f788bc64c47e105fcce35af9a7))
...
* **AttendeeDisplay:** add email icon for mailto link ([e3d0600](https://github.com/nextcloud/calendar/commit/e3d0600202a2d69b91822dd9e73ec5bf97b64790))
* calendar icon not outline ([5f66141](https://github.com/nextcloud/calendar/commit/5f66141f63f83975b577d9c5508db107819ce8cc))
* **CalendarList:** add a new sidebar section for tasks ([39309bd](https://github.com/nextcloud/calendar/commit/39309bd9e16f9649b67d34f84bc4dae693800400))
...
* default full / part day alarm ([9482d92](https://github.com/nextcloud/calendar/commit/9482d92b8fa3c2c7d72858f74aba58a86b244837))
...
* **deps:** Add Nextcloud 34 support ([86a2ff3](https://github.com/nextcloud/calendar/commit/86a2ff3ac068e90d50988a1456f7623be09a9a5c))
* **deps:** Add Nextcloud 35 support ([1d513b0](https://github.com/nextcloud/calendar/commit/1d513b0a85ec8e76555e34b75e9502accb3b2113))
* **EditCalendarModal:** add setting for default reminder per calendar ([3323664](https://github.com/nextcloud/calendar/commit/3323664f54261140fc9bfa9b21dd320c888beb90))
...
* **importing:** show all writable calendars in picker ([216ab65](https://github.com/nextcloud/calendar/commit/216ab6513a8a8a0d7423b9f9e029b535cff82ed0)), closes [#2572](https://github.com/nextcloud/calendar/issues/2572)
...
* **invitees:** add export attendees to CSV button ([f9cce3e](https://github.com/nextcloud/calendar/commit/f9cce3e6e65a5b08961ba222f2762fe591c249a2))
...
* migrate to vue 3 ([f1e0204](https://github.com/nextcloud/calendar/commit/f1e02040fb226a782169a37375ba8b64ab4fbc9a))
...
* new event style in calendar grid ([9a3fcee](https://github.com/nextcloud/calendar/commit/9a3fcee7cfd5e33ee3c597015264b70afdff2858))
...
* read calendar ACL properly ([ea4d703](https://github.com/nextcloud/calendar/commit/ea4d703419d9a7b7fc467071c760d7541af7af14))
* Resize events from start. ([19ffa96](https://github.com/nextcloud/calendar/commit/19ffa96363a525e6a0fd2be6e478b3034607d7ed))
...
* Reusable duration selector ([e5d41fd](https://github.com/nextcloud/calendar/commit/e5d41fd5b09de48bd75769173294956791858979))
...
* **Settings:** event style legend ([1ac1b53](https://github.com/nextcloud/calendar/commit/1ac1b538ce6d646b0fc700ccd02522e9e44f9cf0))
...
* show supported component types in calendar settings ([99e54cf](https://github.com/nextcloud/calendar/commit/99e54cfe8178e482596a36f0d9b611dbc9f22a53)), closes [/github.com/nextcloud/calendar/issues/2572#issuecomment-2200791216](https://github.com//github.com/nextcloud/calendar/issues/2572/issues/issuecomment-2200791216) [#2572](https://github.com/nextcloud/calendar/issues/2572)
...
# [2.4.0-rc2](https://github.com/nextcloud/calendar/compare/v2.2.0...v2.4.0-rc2) (2021-11-15)
