## [6.2.5](https://github.com/nextcloud/calendar/compare/v6.2.4...v6.2.5) (2026-05-11)


### Bug Fixes

* **ContactController:** default option for user enumeration in sharing ([7dbc6a1](https://github.com/nextcloud/calendar/commit/7dbc6a1c01b85712fa1e0328e381ef1530cc0327))
* **l10n:** Update translations from Transifex ([24da732](https://github.com/nextcloud/calendar/commit/24da7321c68559ea463121e644d5df8f0d8428c0))
* **l10n:** Update translations from Transifex ([840e831](https://github.com/nextcloud/calendar/commit/840e8313f398a37d9beac45159ad1b0a5da9e3a3))
* **l10n:** Update translations from Transifex ([eb38ab3](https://github.com/nextcloud/calendar/commit/eb38ab350696eaac79c0783fa7bf89adf0feaeb7))
* **l10n:** Update translations from Transifex ([c30bd67](https://github.com/nextcloud/calendar/commit/c30bd675a8eae9de89ab15cabf1cc1e310f3e7aa))
* **l10n:** Update translations from Transifex ([0b8bc99](https://github.com/nextcloud/calendar/commit/0b8bc99b1a52fff1a811b3ddb2463b4da951f328))
* **l10n:** Update translations from Transifex ([48bf7c6](https://github.com/nextcloud/calendar/commit/48bf7c61980cf4e0867aa91d2966b067616f6443))
* **l10n:** Update translations from Transifex ([4a74e25](https://github.com/nextcloud/calendar/commit/4a74e25f4b525af77d038b9b1a9b3357ce18213f))
...
* all day events order ([d84739e](https://github.com/nextcloud/calendar/commit/d84739e410dd5d64277a27cfc4f122df309008e6))
* attendee role selection and rsvp ([6e9f1fe](https://github.com/nextcloud/calendar/commit/6e9f1fee23566d3c72a06f881874cfded3fc9b7b))
* **CalendarGrid:** a small edge case with short events ([439485b](https://github.com/nextcloud/calendar/commit/439485bdea4ef82380fff29c4abe5c7eebebb1f6))
* **CalendarGrid:** add aria-current to current date ([da40098](https://github.com/nextcloud/calendar/commit/da400980ad3a9dc05efe98a4ed05fb07aa5de065))
* **capability:** Add a capability if calendar webui is there ([76c25da](https://github.com/nextcloud/calendar/commit/76c25da9a73d08085498c775b746fca31a9ff426))
* **l10n:** Update translations from Transifex ([9d8f9a6](https://github.com/nextcloud/calendar/commit/9d8f9a63498cba9b0fb7bb6362bfc3542c26c3a1))
* **l10n:** Update translations from Transifex ([95c85fe](https://github.com/nextcloud/calendar/commit/95c85fe5795e420b9909787d92a8fde5af0e19d4))
* **l10n:** Update translations from Transifex ([8ca93bd](https://github.com/nextcloud/calendar/commit/8ca93bd0b9252deb1413ff524fa7f469f00fcd2c))
* **l10n:** Update translations from Transifex ([a7269d7](https://github.com/nextcloud/calendar/commit/a7269d712c1f6b98e5c7d8e4cf86f8e5f9ab6aa2))
* **l10n:** Update translations from Transifex ([001f82a](https://github.com/nextcloud/calendar/commit/001f82a1df3dcd7f7a4fb4bc55604c27d8a4da2f))
* **l10n:** Update translations from Transifex ([12f8e37](https://github.com/nextcloud/calendar/commit/12f8e3744ee92e7fc7b2d6fd06c0b39632b34539))
* **l10n:** Update translations from Transifex ([0e25e5c](https://github.com/nextcloud/calendar/commit/0e25e5c8b0cf91656c169ec8a8bff27da113a34c))
* **l10n:** Update translations from Transifex ([22d6d2d](https://github.com/nextcloud/calendar/commit/22d6d2d1310cf4a6a1e7de8e2251e57cb99a604b))
* **l10n:** Update translations from Transifex ([38561bd](https://github.com/nextcloud/calendar/commit/38561bd0da5592a3e2a3e4a426bedb0ccbcde022))
* **l10n:** Update translations from Transifex ([2548153](https://github.com/nextcloud/calendar/commit/25481534747d1557d195f508e47c53b6fc05ec43))
* **l10n:** Update translations from Transifex ([6c1a3fe](https://github.com/nextcloud/calendar/commit/6c1a3fef3f1efc6d9f35bc73aa874da50e307996))
* **l10n:** Update translations from Transifex ([97f4d34](https://github.com/nextcloud/calendar/commit/97f4d3455a0448323e0662fb767389cef9cdf152))
* **l10n:** Update translations from Transifex ([a087f68](https://github.com/nextcloud/calendar/commit/a087f685eaaca34a35da1b190a1052b079180e2b))
* **l10n:** Update translations from Transifex ([48f1804](https://github.com/nextcloud/calendar/commit/48f180465dfc2965a675168b05d9aed80e6c114c))
* **l10n:** Update translations from Transifex ([e7b8f37](https://github.com/nextcloud/calendar/commit/e7b8f3738c4da6a8b4fb096a2a8ec12e44cc019d))
* **l10n:** Update translations from Transifex ([b0b92f2](https://github.com/nextcloud/calendar/commit/b0b92f2e1aaea2926f4f1fcbc61330779c724266))
* **l10n:** Update translations from Transifex ([bf40bde](https://github.com/nextcloud/calendar/commit/bf40bdea9a30e84af811d9d931b4cdc9ccd5b1b2))
* **l10n:** Update translations from Transifex ([98f4102](https://github.com/nextcloud/calendar/commit/98f4102cfa617204677f691bd36f36bd75c7ea60))
* put default calendar selector back ([9caeb9c](https://github.com/nextcloud/calendar/commit/9caeb9cc4b9e849225e28caf801c5cdf6b407df5))



# [6.2.0-rc.1](https://github.com/nextcloud/calendar/compare/v6.2.0-beta.1...v6.2.0-rc.1) (2026-02-02)
