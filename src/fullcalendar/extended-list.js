...
/*!
FullCalendar Extended List View Plugin v4.4.0
*/

// TODO: revisit. remove typescript compiled code. extend Fullcalendar List completely.
    ...
    var ListEventRenderer = /** @class */ (function (_super) {
        ...
        ListEventRenderer.prototype.renderSegHtml = function (seg) {
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                ...
                '</a>' +
				      '<br/>' +
        '<span class="fc-event-dot-location" style="display: ' +
		(eventDef.extendedProps.location ? 'block' : 'none') + ';"' +
        (bgColor ?
          ' style="background-color:' + bgColor + '"' :
          '') +
        '></span>' +
        '<a title="'+ (eventDef.extendedProps.locationTitle ? eventDef.extendedProps.locationTitle.toString() : '') +'" ' + (url ? ' href="' + core.htmlEscape(url) + '"' : '') + '>' +
          core.htmlEscape(eventDef.extendedProps.location || '') +
        '</a>' +
      '<br/>' +
        '<span class="fc-event-dot-description" style="display: ' +
		(eventDef.extendedProps.description ? 'block' : 'none') + ';"' +
        (bgColor ?
          ' style="background-color:' + bgColor + '"' :
          '') +
        '></span>' +
        '<a title="'+ (eventDef.extendedProps.descriptionTitle ? eventDef.extendedProps.descriptionTitle.toString() : '') +'" ' + (url ? ' href="' + core.htmlEscape(url) + '"' : '') + '>' +
          core.htmlEscape(eventDef.extendedProps.description ? eventDef.extendedProps.description : '') +
        '</a>' +
